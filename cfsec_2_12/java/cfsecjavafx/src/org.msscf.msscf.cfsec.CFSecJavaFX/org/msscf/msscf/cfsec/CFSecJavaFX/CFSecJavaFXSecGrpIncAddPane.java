// Description: Java 11 JavaFX Add Pane implementation for SecGrpInc.
...
/**
 *	CFSecJavaFXSecGrpIncAddPane JavaFX Add Pane implementation
 *	for SecGrpInc.
 */
public class CFSecJavaFXSecGrpIncAddPane
extends CFSplitPane
implements ICFSecJavaFXSecGrpIncPaneCommon
{
	...
	public CFSecJavaFXSecGrpIncAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecGrpIncObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecGrpIncPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}

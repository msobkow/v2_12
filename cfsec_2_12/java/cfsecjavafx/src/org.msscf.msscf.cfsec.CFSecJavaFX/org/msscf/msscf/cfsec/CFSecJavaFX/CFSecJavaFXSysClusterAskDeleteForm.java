// Description: Java 11 JavaFX Ask Delete Pane implementation for SysCluster.
...
/**
 *	CFSecJavaFXSysClusterAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for SysCluster.
 */
public class CFSecJavaFXSysClusterAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXSysClusterPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Cluster";
	...
	public CFSecJavaFXSysClusterAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSysClusterObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Cluster?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecSysClusterObj obj = getJavaFXFocusAsSysCluster();
					ICFSecSysClusterEditObj editObj = (ICFSecSysClusterEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getSysClusterFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsSysCluster( ICFSecSysClusterObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXSysClusterPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFSecJavaFXSysClusterPaneCommon)attrPane).setPaneMode( value );
		}
	}

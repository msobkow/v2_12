// Description: Java 11 JavaFX Add Form implementation for Cluster.
...
/**
 *	CFSecJavaFXClusterAddForm JavaFX Add Form implementation
 *	for Cluster.
 */
public class CFSecJavaFXClusterAddForm
	...
	ICFForm
{
	...
	public CFSecJavaFXClusterAddForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecClusterObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getClusterFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXClusterPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getClusterFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXClusterPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXClusterPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}

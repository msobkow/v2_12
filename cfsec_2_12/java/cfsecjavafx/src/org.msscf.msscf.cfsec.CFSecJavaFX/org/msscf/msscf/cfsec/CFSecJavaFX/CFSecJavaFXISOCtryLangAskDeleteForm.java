// Description: Java 11 JavaFX Ask Delete Pane implementation for ISOCtryLang.
...
/**
 *	CFSecJavaFXISOCtryLangAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for ISOCtryLang.
 */
public class CFSecJavaFXISOCtryLangAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXISOCtryLangPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete ISOCtryLang";
	...
	public CFSecJavaFXISOCtryLangAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecISOCtryLangObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this ISOCtryLang?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecISOCtryLangObj obj = getJavaFXFocusAsISOCtryLang();
					ICFSecISOCtryLangEditObj editObj = (ICFSecISOCtryLangEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getISOCtryLangFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsISOCtryLang( ICFSecISOCtryLangObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXISOCtryLangPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFSecJavaFXISOCtryLangPaneCommon)attrPane).setPaneMode( value );
		}
	}

// Description: Java 11 JavaFX Ask Delete Pane implementation for SecGrpInc.
...
/**
 *	CFSecJavaFXSecGrpIncAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for SecGrpInc.
 */
public class CFSecJavaFXSecGrpIncAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXSecGrpIncPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Security Group Include";
	...
	public CFSecJavaFXSecGrpIncAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecGrpIncObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Security Group Include?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecSecGrpIncObj obj = getJavaFXFocusAsSecGrpInc();
					ICFSecSecGrpIncEditObj editObj = (ICFSecSecGrpIncEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getSecGrpIncFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsSecGrpInc( ICFSecSecGrpIncObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXSecGrpIncPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFSecJavaFXSecGrpIncPaneCommon)attrPane).setPaneMode( value );
		}
	}

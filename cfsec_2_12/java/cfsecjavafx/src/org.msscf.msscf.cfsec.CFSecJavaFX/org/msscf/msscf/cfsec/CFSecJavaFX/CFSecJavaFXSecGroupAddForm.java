// Description: Java 11 JavaFX Add Form implementation for SecGroup.
...
/**
 *	CFSecJavaFXSecGroupAddForm JavaFX Add Form implementation
 *	for SecGroup.
 */
public class CFSecJavaFXSecGroupAddForm
extends CFBorderPane
implements ICFSecJavaFXSecGroupPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Security Group";
	...
	public CFSecJavaFXSecGroupAddForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecGroupObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getSecGroupFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecGroupPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getSecGroupFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecGroupPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecGroupPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}

// Description: Java 11 JavaFX View/Edit Pane implementation for SecGrpInc.
...
/**
 *	CFSecJavaFXSecGrpIncViewEditPane JavaFX View/Edit Pane implementation
 *	for SecGrpInc.
 */
public class CFSecJavaFXSecGrpIncViewEditPane
extends CFSplitPane
implements ICFSecJavaFXSecGrpIncPaneCommon
{
	...
	public CFSecJavaFXSecGrpIncViewEditPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecGrpIncObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecGrpIncPaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}

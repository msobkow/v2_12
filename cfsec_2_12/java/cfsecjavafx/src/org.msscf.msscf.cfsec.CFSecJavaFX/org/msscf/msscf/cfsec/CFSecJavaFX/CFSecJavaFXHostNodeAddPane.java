// Description: Java 11 JavaFX Add Pane implementation for HostNode.
...
/**
 *	CFSecJavaFXHostNodeAddPane JavaFX Add Pane implementation
 *	for HostNode.
 */
public class CFSecJavaFXHostNodeAddPane
extends CFSplitPane
implements ICFSecJavaFXHostNodePaneCommon
{
	...
	public CFSecJavaFXHostNodeAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecHostNodeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXHostNodePaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}

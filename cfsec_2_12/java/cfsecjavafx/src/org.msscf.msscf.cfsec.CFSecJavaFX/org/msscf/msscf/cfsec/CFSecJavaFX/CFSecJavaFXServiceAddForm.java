// Description: Java 11 JavaFX Add Form implementation for Service.
...
/**
 *	CFSecJavaFXServiceAddForm JavaFX Add Form implementation
 *	for Service.
 */
public class CFSecJavaFXServiceAddForm
extends CFBorderPane
implements ICFSecJavaFXServicePaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Service";
	...
	public CFSecJavaFXServiceAddForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecServiceObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getServiceFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXServicePaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getServiceFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXServicePaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXServicePaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}

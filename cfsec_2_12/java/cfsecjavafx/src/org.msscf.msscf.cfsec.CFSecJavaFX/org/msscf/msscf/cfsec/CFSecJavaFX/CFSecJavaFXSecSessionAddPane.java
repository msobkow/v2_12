// Description: Java 11 JavaFX Add Pane implementation for SecSession.
...
/**
 *	CFSecJavaFXSecSessionAddPane JavaFX Add Pane implementation
 *	for SecSession.
 */
public class CFSecJavaFXSecSessionAddPane
extends CFSplitPane
implements ICFSecJavaFXSecSessionPaneCommon
{
	...
	public CFSecJavaFXSecSessionAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecSessionObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecSessionPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}

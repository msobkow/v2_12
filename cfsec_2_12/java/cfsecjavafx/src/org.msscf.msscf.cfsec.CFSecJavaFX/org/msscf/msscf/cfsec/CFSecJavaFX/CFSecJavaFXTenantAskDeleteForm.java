// Description: Java 11 JavaFX Ask Delete Pane implementation for Tenant.
...
/**
 *	CFSecJavaFXTenantAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for Tenant.
 */
public class CFSecJavaFXTenantAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXTenantPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Tenant";
	...
	public CFSecJavaFXTenantAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecTenantObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Tenant?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecTenantObj obj = getJavaFXFocusAsTenant();
					ICFSecTenantEditObj editObj = (ICFSecTenantEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsTenant( ICFSecTenantObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXTenantPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}

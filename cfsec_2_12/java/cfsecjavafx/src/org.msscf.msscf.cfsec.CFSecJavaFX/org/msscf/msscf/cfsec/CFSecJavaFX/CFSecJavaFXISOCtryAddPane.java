// Description: Java 11 JavaFX Add Pane implementation for ISOCtry.
...
/**
 *	CFSecJavaFXISOCtryAddPane JavaFX Add Pane implementation
 *	for ISOCtry.
 */
public class CFSecJavaFXISOCtryAddPane
extends CFSplitPane
implements ICFSecJavaFXISOCtryPaneCommon
{
	...
	public CFSecJavaFXISOCtryAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecISOCtryObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXISOCtryPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}

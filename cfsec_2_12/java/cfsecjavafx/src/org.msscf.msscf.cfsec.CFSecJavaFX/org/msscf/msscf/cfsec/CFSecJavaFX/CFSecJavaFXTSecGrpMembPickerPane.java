// Description: Java 11 JavaFX Picker of Obj Pane implementation for TSecGrpMemb.
...
/**
 *	CFSecJavaFXTSecGrpMembPickerPane JavaFX Pick Obj Pane implementation
 *	for TSecGrpMemb.
 */
public class CFSecJavaFXTSecGrpMembPickerPane
...
implements ICFSecJavaFXTSecGrpMembPaneList
{
	...
	protected ICFSecJavaFXTSecGrpMembChosen invokeWhenChosen = null;
	protected ICFSecTSecGroupObj javafxContainer = null;
	protected CFButton buttonCancel = null;
	protected CFButton buttonChooseNone = null;
	protected CFButton buttonChooseSelected = null;
	protected ScrollPane scrollMenu = null;
	public CFSecJavaFXTSecGrpMembPickerPane( ICFFormManager formManager,
		...
		buttonChooseNone.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					...
					invokeWhenChosen.choseTSecGrpMemb( null );
					cfFormManager.closeCurrentForm();
				}
				catch( Throwable t ) {
					CFConsole.formException( S_FormName, ((CFButton)e.getSource()).getText(), t );
		...
		buttonChooseSelected.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					...
					invokeWhenChosen.choseTSecGrpMemb( selectedInstance );
					cfFormManager.closeCurrentForm();
				}
				catch( Throwable t ) {
					CFConsole.formException( S_FormName, ((CFButton)e.getSource()).getText(), t );

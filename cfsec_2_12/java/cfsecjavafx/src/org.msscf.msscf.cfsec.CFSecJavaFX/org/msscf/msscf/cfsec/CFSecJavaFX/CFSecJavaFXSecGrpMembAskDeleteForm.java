// Description: Java 11 JavaFX Ask Delete Pane implementation for SecGrpMemb.
...
/**
 *	CFSecJavaFXSecGrpMembAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for SecGrpMemb.
 */
public class CFSecJavaFXSecGrpMembAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXSecGrpMembPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Security Group Member";
	...
	public CFSecJavaFXSecGrpMembAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecGrpMembObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Security Group Member?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecSecGrpMembObj obj = getJavaFXFocusAsSecGrpMemb();
					ICFSecSecGrpMembEditObj editObj = (ICFSecSecGrpMembEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsSecGrpMemb( ICFSecSecGrpMembObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXSecGrpMembPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}

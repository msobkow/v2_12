// Description: Java 11 JavaFX Ask Delete Pane implementation for HostNode.
...
/**
 *	CFSecJavaFXHostNodeAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for HostNode.
 */
public class CFSecJavaFXHostNodeAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXHostNodePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Host Node";
	...
	public CFSecJavaFXHostNodeAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecHostNodeObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Host Node?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecHostNodeObj obj = getJavaFXFocusAsHostNode();
					ICFSecHostNodeEditObj editObj = (ICFSecHostNodeEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsHostNode( ICFSecHostNodeObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXHostNodePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}

// Description: Java 11 JavaFX Ask Delete Pane implementation for SecGroup.
...
/**
 *	CFSecJavaFXSecGroupAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for SecGroup.
 */
public class CFSecJavaFXSecGroupAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXSecGroupPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Security Group";
	...
	public CFSecJavaFXSecGroupAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecGroupObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Security Group?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecSecGroupObj obj = getJavaFXFocusAsSecGroup();
					ICFSecSecGroupEditObj editObj = (ICFSecSecGroupEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getSecGroupFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsSecGroup( ICFSecSecGroupObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXSecGroupPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFSecJavaFXSecGroupPaneCommon)attrPane).setPaneMode( value );
		}
	}

// Description: Java 11 JavaFX View/Edit Pane implementation for SecGroupForm.
...
/**
 *	CFSecJavaFXSecGroupFormViewEditPane JavaFX View/Edit Pane implementation
 *	for SecGroupForm.
 */
public class CFSecJavaFXSecGroupFormViewEditPane
extends CFSplitPane
implements ICFSecJavaFXSecGroupFormPaneCommon
{
	...
	public CFSecJavaFXSecGroupFormViewEditPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecGroupFormObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecGroupFormPaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}

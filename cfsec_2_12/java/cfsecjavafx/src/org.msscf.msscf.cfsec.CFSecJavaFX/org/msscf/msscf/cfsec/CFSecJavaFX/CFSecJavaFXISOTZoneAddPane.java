// Description: Java 11 JavaFX Add Pane implementation for ISOTZone.
...
/**
 *	CFSecJavaFXISOTZoneAddPane JavaFX Add Pane implementation
 *	for ISOTZone.
 */
public class CFSecJavaFXISOTZoneAddPane
extends CFSplitPane
implements ICFSecJavaFXISOTZonePaneCommon
{
	...
	public CFSecJavaFXISOTZoneAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecISOTZoneObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXISOTZonePaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}

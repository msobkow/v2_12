// Description: Java 11 JavaFX View/Edit Form implementation for ServiceType.
...
/**
 *	CFSecJavaFXServiceTypeViewEditForm JavaFX View/Edit Form implementation
 *	for ServiceType.
 */
public class CFSecJavaFXServiceTypeViewEditForm
extends CFBorderPane
implements ICFSecJavaFXServiceTypePaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit Service Type";
	...
	public CFSecJavaFXServiceTypeViewEditForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecServiceTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		javafxViewEditPane = argSchema.getServiceTypeFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXServiceTypePaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsServiceType() != null ) {
							if( null == getJavaFXFocusAsServiceType().getEdit() ) {
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXServiceTypePaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXServiceTypePaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}

// Description: Java 11 JavaFX View/Edit Pane implementation for TSecGroup.
 ...
 *	for TSecGroup.
 */
public class CFSecJavaFXTSecGroupViewEditPane
extends CFSplitPane
implements ICFSecJavaFXTSecGroupPaneCommon
{
	...
	public CFSecJavaFXTSecGroupViewEditPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecTSecGroupObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getTSecGroupFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXTSecGroupPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXTSecGroupPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFSecJavaFXTSecGroupPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}

// Description: Java 11 JavaFX Ask Delete Pane implementation for TSecGrpMemb.
...
/**
 *	CFSecJavaFXTSecGrpMembAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for TSecGrpMemb.
 */
public class CFSecJavaFXTSecGrpMembAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXTSecGrpMembPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Tenant Security Group Member";
	...
	public CFSecJavaFXTSecGrpMembAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecTSecGrpMembObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Tenant Security Group Member?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecTSecGrpMembObj obj = getJavaFXFocusAsTSecGrpMemb();
					ICFSecTSecGrpMembEditObj editObj = (ICFSecTSecGrpMembEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getTSecGrpMembFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsTSecGrpMemb( ICFSecTSecGrpMembObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXTSecGrpMembPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFSecJavaFXTSecGrpMembPaneCommon)attrPane).setPaneMode( value );
		}
	}

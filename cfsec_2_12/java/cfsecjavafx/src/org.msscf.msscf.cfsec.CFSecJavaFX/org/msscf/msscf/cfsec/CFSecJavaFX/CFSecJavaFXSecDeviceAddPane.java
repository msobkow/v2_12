// Description: Java 11 JavaFX Add Pane implementation for SecDevice.
...
/**
 *	CFSecJavaFXSecDeviceAddPane JavaFX Add Pane implementation
 *	for SecDevice.
 */
public class CFSecJavaFXSecDeviceAddPane
extends CFSplitPane
implements ICFSecJavaFXSecDevicePaneCommon
{
	...
	public CFSecJavaFXSecDeviceAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecDeviceObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecDevicePaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}

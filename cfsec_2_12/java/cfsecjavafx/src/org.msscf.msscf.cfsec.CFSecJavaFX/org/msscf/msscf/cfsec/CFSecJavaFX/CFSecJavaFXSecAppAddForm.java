// Description: Java 11 JavaFX Add Form implementation for SecApp.
...
/**
 *	CFSecJavaFXSecAppAddForm JavaFX Add Form implementation
 *	for SecApp.
 */
public class CFSecJavaFXSecAppAddForm
extends CFBorderPane
implements ICFSecJavaFXSecAppPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Security Application";
	...
	public CFSecJavaFXSecAppAddForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecAppObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getSecAppFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecAppPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getSecAppFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecAppPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecAppPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}

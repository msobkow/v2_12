// Description: Java 11 JavaFX Add Form implementation for HostNode.
...
/**
 *	CFSecJavaFXHostNodeAddForm JavaFX Add Form implementation
 *	for HostNode.
 */
public class CFSecJavaFXHostNodeAddForm
extends CFBorderPane
implements ICFSecJavaFXHostNodePaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Host Node";
	...
	public CFSecJavaFXHostNodeAddForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecHostNodeObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getHostNodeFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXHostNodePaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getHostNodeFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXHostNodePaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXHostNodePaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}

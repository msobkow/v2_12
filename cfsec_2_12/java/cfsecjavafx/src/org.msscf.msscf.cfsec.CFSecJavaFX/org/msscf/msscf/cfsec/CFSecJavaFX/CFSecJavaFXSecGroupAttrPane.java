// Description: Java 11 JavaFX Attribute Pane implementation for SecGroup.
...
implements ICFSecJavaFXSecGroupPaneCommon
{
		...
		extends CFInt32Editor
	{
		public SecGroupIdEditor() {
			super();
			setMinValue( CFSecSecGroupBuff.SECGROUPID_MIN_VALUE );
			setFieldName( "Security Group Id" );
		}
	}
	...
	public void populateFields()
	{
		...
		if( popObj == null ) {
			getJavaFXEditorSecGroupId().setInt32Value( null );
		}
		else {
			getJavaFXEditorSecGroupId().setInt32Value( popObj.getRequiredSecGroupId() );
		}

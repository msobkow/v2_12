// Description: Java 11 JavaFX Ask Delete Pane implementation for SecGroupForm.
...
/**
 *	CFSecJavaFXSecGroupFormAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for SecGroupForm.
 */
public class CFSecJavaFXSecGroupFormAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXSecGroupFormPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Security Group Form";
	...
	public CFSecJavaFXSecGroupFormAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecGroupFormObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Security Group Form?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecSecGroupFormObj obj = getJavaFXFocusAsSecGroupForm();
					ICFSecSecGroupFormEditObj editObj = (ICFSecSecGroupFormEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getSecGroupFormFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsSecGroupForm( ICFSecSecGroupFormObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXSecGroupFormPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFSecJavaFXSecGroupFormPaneCommon)attrPane).setPaneMode( value );
		}
	}

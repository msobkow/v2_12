// Description: Java 11 JavaFX View/Edit Pane implementation for TSecGrpInc.
...
/**
 *	CFSecJavaFXTSecGrpIncViewEditPane JavaFX View/Edit Pane implementation
 *	for TSecGrpInc.
 */
public class CFSecJavaFXTSecGrpIncViewEditPane
extends CFSplitPane
implements ICFSecJavaFXTSecGrpIncPaneCommon
{
	...
	public CFSecJavaFXTSecGrpIncViewEditPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecTSecGrpIncObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXTSecGrpIncPaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}

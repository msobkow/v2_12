// Description: Java 11 JavaFX View/Edit Pane implementation for ISOCtryLang.
...
/**
 *	CFSecJavaFXISOCtryLangViewEditPane JavaFX View/Edit Pane implementation
 *	for ISOCtryLang.
 */
public class CFSecJavaFXISOCtryLangViewEditPane
extends CFSplitPane
implements ICFSecJavaFXISOCtryLangPaneCommon
{
	...
	public CFSecJavaFXISOCtryLangViewEditPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecISOCtryLangObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXISOCtryLangPaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}

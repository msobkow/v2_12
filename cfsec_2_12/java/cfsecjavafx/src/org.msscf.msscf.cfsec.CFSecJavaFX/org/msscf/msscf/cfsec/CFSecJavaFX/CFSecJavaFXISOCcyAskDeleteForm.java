// Description: Java 11 JavaFX Ask Delete Pane implementation for ISOCcy.
...
/**
 *	CFSecJavaFXISOCcyAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for ISOCcy.
 */
public class CFSecJavaFXISOCcyAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXISOCcyPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete ISO Ccy";
	...
	public CFSecJavaFXISOCcyAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecISOCcyObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this ISO Ccy?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecISOCcyObj obj = getJavaFXFocusAsISOCcy();
					ICFSecISOCcyEditObj editObj = (ICFSecISOCcyEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsISOCcy( ICFSecISOCcyObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXISOCcyPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}

// Description: Java 11 JavaFX View/Edit Form implementation for TSecGroup.
...
/**
 *	CFSecJavaFXTSecGroupViewEditForm JavaFX View/Edit Form implementation
 *	for TSecGroup.
 */
public class CFSecJavaFXTSecGroupViewEditForm
extends CFBorderPane
implements ICFSecJavaFXTSecGroupPaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit Tenant Security Group";
	...
	public CFSecJavaFXTSecGroupViewEditForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecTSecGroupObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFSecTSecGroupObj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxViewEditPane = argSchema.getTSecGroupFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void forceCancelAndClose() {
		...
		if( focus != null ) {
			ICFSecTSecGroupEditObj editObj = (ICFSecTSecGroupEditObj)focus.getEdit();
			if( editObj != null ) {
				if( editObj.getIsNew() ) {
					editObj.endEdit();
					editObj = null;
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXTSecGroupPaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		ICFSecTSecGroupObj argFocus = (ICFSecTSecGroupObj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFSecTSecGroupObj)argFocus.read( true );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsTSecGroup() != null ) {
							if( null == getJavaFXFocusAsTSecGroup().getEdit() ) {
			...
			buttonClose.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						cfFormManager.closeCurrentForm();
						if( formClosedCallback != null ) {
							focus = getJavaFXFocusAsTSecGroup();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXTSecGroupPaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXTSecGroupPaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}

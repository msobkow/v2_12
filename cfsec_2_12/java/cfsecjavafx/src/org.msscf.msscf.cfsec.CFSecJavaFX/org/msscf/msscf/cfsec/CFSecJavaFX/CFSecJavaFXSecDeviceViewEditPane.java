// Description: Java 11 JavaFX View/Edit Pane implementation for SecDevice.
...
/**
 *	CFSecJavaFXSecDeviceViewEditPane JavaFX View/Edit Pane implementation
 *	for SecDevice.
 */
public class CFSecJavaFXSecDeviceViewEditPane
extends CFSplitPane
implements ICFSecJavaFXSecDevicePaneCommon
{
	...
	public CFSecJavaFXSecDeviceViewEditPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecDeviceObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecDevicePaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}

// Description: Java 11 JavaFX Add Form implementation for ISOTZone.
...
/**
 *	CFSecJavaFXISOTZoneAddForm JavaFX Add Form implementation
 *	for ISOTZone.
 */
public class CFSecJavaFXISOTZoneAddForm
extends CFBorderPane
implements ICFSecJavaFXISOTZonePaneCommon,
	ICFForm
{
	public static String S_FormName = "Add ISO Timezone";
	...
	public CFSecJavaFXISOTZoneAddForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecISOTZoneObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getISOTZoneFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXISOTZonePaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getISOTZoneFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXISOTZonePaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXISOTZonePaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}

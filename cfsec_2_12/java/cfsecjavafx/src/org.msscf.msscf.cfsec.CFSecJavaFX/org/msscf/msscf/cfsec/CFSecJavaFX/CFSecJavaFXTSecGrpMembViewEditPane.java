// Description: Java 11 JavaFX View/Edit Pane implementation for TSecGrpMemb.
...
/**
 *	CFSecJavaFXTSecGrpMembViewEditPane JavaFX View/Edit Pane implementation
 *	for TSecGrpMemb.
 */
public class CFSecJavaFXTSecGrpMembViewEditPane
extends CFSplitPane
implements ICFSecJavaFXTSecGrpMembPaneCommon
{
	...
	public CFSecJavaFXTSecGrpMembViewEditPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecTSecGrpMembObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXTSecGrpMembPaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}

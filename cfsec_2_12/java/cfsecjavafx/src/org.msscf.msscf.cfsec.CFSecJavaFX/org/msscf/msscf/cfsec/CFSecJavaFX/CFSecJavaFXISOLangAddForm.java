// Description: Java 11 JavaFX Add Form implementation for ISOLang.
...
/**
 *	CFSecJavaFXISOLangAddForm JavaFX Add Form implementation
 *	for ISOLang.
 */
public class CFSecJavaFXISOLangAddForm
extends CFBorderPane
implements ICFSecJavaFXISOLangPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add ISO Lang";
	...
	public CFSecJavaFXISOLangAddForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecISOLangObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getISOLangFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXISOLangPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getISOLangFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXISOLangPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXISOLangPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}

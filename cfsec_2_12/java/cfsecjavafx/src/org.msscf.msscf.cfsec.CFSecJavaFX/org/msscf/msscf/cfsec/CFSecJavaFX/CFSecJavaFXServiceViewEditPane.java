// Description: Java 11 JavaFX View/Edit Pane implementation for Service.
...
/**
 *	CFSecJavaFXServiceViewEditPane JavaFX View/Edit Pane implementation
 *	for Service.
 */
public class CFSecJavaFXServiceViewEditPane
extends CFSplitPane
implements ICFSecJavaFXServicePaneCommon
{
	...
	public CFSecJavaFXServiceViewEditPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecServiceObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXServicePaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}

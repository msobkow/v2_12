// Description: Java 11 JavaFX Add Form implementation for Tenant.
...
/**
 *	CFSecJavaFXTenantAddForm JavaFX Add Form implementation
 *	for Tenant.
 */
public class CFSecJavaFXTenantAddForm
extends CFBorderPane
implements ICFSecJavaFXTenantPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Tenant";
	...
	public CFSecJavaFXTenantAddForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecTenantObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getTenantFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXTenantPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getTenantFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXTenantPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXTenantPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}

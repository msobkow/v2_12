// Description: Java 11 JavaFX Add Form implementation for ISOCcy.
...
/**
 *	CFSecJavaFXISOCcyAddForm JavaFX Add Form implementation
 *	for ISOCcy.
 */
public class CFSecJavaFXISOCcyAddForm
extends CFBorderPane
implements ICFSecJavaFXISOCcyPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add ISO Ccy";
	...
	public CFSecJavaFXISOCcyAddForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecISOCcyObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getISOCcyFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXISOCcyPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getISOCcyFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXISOCcyPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXISOCcyPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}

// Description: Java 11 JavaFX View/Edit Form implementation for SecDevice.
...
/**
 *	CFSecJavaFXSecDeviceViewEditForm JavaFX View/Edit Form implementation
 *	for SecDevice.
 */
public class CFSecJavaFXSecDeviceViewEditForm
extends CFBorderPane
implements ICFSecJavaFXSecDevicePaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit Security Device";
	...
	public CFSecJavaFXSecDeviceViewEditForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecDeviceObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFSecSecDeviceObj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxViewEditPane = argSchema.getSecDeviceFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void forceCancelAndClose() {
		...
		if( focus != null ) {
			ICFSecSecDeviceEditObj editObj = (ICFSecSecDeviceEditObj)focus.getEdit();
			if( editObj != null ) {
				if( editObj.getIsNew() ) {
					editObj.endEdit();
					editObj = null;
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecDevicePaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		ICFSecSecDeviceObj argFocus = (ICFSecSecDeviceObj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFSecSecDeviceObj)argFocus.read( true );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsSecDevice() != null ) {
							if( null == getJavaFXFocusAsSecDevice().getEdit() ) {
			...
			buttonClose.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						cfFormManager.closeCurrentForm();
						if( formClosedCallback != null ) {
							focus = getJavaFXFocusAsSecDevice();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecDevicePaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecDevicePaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}

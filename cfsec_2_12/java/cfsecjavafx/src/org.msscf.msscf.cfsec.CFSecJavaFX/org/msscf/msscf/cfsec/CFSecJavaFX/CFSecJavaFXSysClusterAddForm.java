// Description: Java 11 JavaFX Add Form implementation for SysCluster.
...
/**
 *	CFSecJavaFXSysClusterAddForm JavaFX Add Form implementation
 *	for SysCluster.
 */
public class CFSecJavaFXSysClusterAddForm
extends CFBorderPane
implements ICFSecJavaFXSysClusterPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Cluster";
	...
	public CFSecJavaFXSysClusterAddForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSysClusterObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getSysClusterFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSysClusterPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getSysClusterFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSysClusterPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSysClusterPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}

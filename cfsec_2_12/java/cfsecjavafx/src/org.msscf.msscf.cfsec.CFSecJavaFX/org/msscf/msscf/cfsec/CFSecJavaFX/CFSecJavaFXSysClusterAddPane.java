// Description: Java 11 JavaFX Add Pane implementation for SysCluster.
...
/**
 *	CFSecJavaFXSysClusterAddPane JavaFX Add Pane implementation
 *	for SysCluster.
 */
public class CFSecJavaFXSysClusterAddPane
extends CFSplitPane
implements ICFSecJavaFXSysClusterPaneCommon
{
	...
	public CFSecJavaFXSysClusterAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSysClusterObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSysClusterPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}

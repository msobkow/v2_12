// Description: Java 11 JavaFX View/Edit Pane implementation for SysCluster.
...
/**
 *	CFSecJavaFXSysClusterViewEditPane JavaFX View/Edit Pane implementation
 *	for SysCluster.
 */
public class CFSecJavaFXSysClusterViewEditPane
extends CFSplitPane
implements ICFSecJavaFXSysClusterPaneCommon
{
	...
	public CFSecJavaFXSysClusterViewEditPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSysClusterObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSysClusterPaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}

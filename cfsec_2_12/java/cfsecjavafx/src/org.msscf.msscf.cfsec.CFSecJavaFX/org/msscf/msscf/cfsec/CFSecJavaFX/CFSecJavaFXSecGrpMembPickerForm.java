// Description: Java 11 JavaFX Picker Form implementation for SecGrpMemb.
...
/**
 *	CFSecJavaFXSecGrpMembPickerForm JavaFX Picker Form implementation
 *	for SecGrpMemb.
 */
public class CFSecJavaFXSecGrpMembPickerForm
	...
	ICFForm
{
	...
	public CFSecJavaFXSecGrpMembPickerForm( ICFFormManager formManager,
		...
		ICFSecJavaFXSecGrpMembChosen whenChosen )
	{
		...
		javafxPickerPane = argSchema.getSecGrpMembFactory().newPickerPane( cfFormManager, argFocus, argContainer, argPageCallback, whenChosen );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecGrpMembPaneCommon)javafxPickerPane).setJavaFXFocus( (ICFSecSecGrpMembObj)value );
	}
	...
	public Collection<ICFSecSecGrpMembObj> getJavaFXDataCollection() {
		ICFSecJavaFXSecGrpMembPaneList jplPicker = (ICFSecJavaFXSecGrpMembPaneList)javafxPickerPane;
		Collection<ICFSecSecGrpMembObj> cltn = jplPicker.getJavaFXDataCollection();
		return( cltn );
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( javafxPickerPane != null ) {
			ICFSecJavaFXSecGrpMembPaneCommon jpanelCommon = (ICFSecJavaFXSecGrpMembPaneCommon)javafxPickerPane;

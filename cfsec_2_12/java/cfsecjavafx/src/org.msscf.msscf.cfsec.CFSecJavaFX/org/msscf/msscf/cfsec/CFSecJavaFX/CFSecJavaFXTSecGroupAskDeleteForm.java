// Description: Java 11 JavaFX Ask Delete Pane implementation for TSecGroup.
...
/**
 *	CFSecJavaFXTSecGroupAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for TSecGroup.
 */
public class CFSecJavaFXTSecGroupAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXTSecGroupPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Tenant Security Group";
	...
	public CFSecJavaFXTSecGroupAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecTSecGroupObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Tenant Security Group?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecTSecGroupObj obj = getJavaFXFocusAsTSecGroup();
					ICFSecTSecGroupEditObj editObj = (ICFSecTSecGroupEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsTSecGroup( ICFSecTSecGroupObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXTSecGroupPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}

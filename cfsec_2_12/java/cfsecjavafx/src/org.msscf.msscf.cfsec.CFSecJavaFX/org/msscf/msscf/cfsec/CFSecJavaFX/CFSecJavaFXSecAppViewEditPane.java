// Description: Java 11 JavaFX View/Edit Pane implementation for SecApp.
...
/**
 *	CFSecJavaFXSecAppViewEditPane JavaFX View/Edit Pane implementation
 *	for SecApp.
 */
public class CFSecJavaFXSecAppViewEditPane
extends CFSplitPane
implements ICFSecJavaFXSecAppPaneCommon
{
	...
	public CFSecJavaFXSecAppViewEditPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecAppObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getSecAppFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecAppPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecAppPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFSecJavaFXSecAppPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}

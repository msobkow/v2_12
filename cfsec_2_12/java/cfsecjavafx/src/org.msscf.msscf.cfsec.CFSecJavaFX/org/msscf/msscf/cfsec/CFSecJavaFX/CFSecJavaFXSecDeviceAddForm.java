// Description: Java 11 JavaFX Add Form implementation for SecDevice.
...
/**
 *	CFSecJavaFXSecDeviceAddForm JavaFX Add Form implementation
 *	for SecDevice.
 */
public class CFSecJavaFXSecDeviceAddForm
extends CFBorderPane
implements ICFSecJavaFXSecDevicePaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Security Device";
	...
	public CFSecJavaFXSecDeviceAddForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecDeviceObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getSecDeviceFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecDevicePaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getSecDeviceFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecDevicePaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecDevicePaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}

// Description: Java 11 JavaFX View/Edit Pane implementation for SecGrpMemb.
...
/**
 *	CFSecJavaFXSecGrpMembViewEditPane JavaFX View/Edit Pane implementation
 *	for SecGrpMemb.
 */
public class CFSecJavaFXSecGrpMembViewEditPane
extends CFSplitPane
implements ICFSecJavaFXSecGrpMembPaneCommon
{
	...
	public CFSecJavaFXSecGrpMembViewEditPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecGrpMembObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecGrpMembPaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}

// Description: Java 11 JavaFX Add Form implementation for SecForm.
...
/**
 *	CFSecJavaFXSecFormAddForm JavaFX Add Form implementation
 *	for SecForm.
 */
public class CFSecJavaFXSecFormAddForm
extends CFBorderPane
implements ICFSecJavaFXSecFormPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Security Form";
	...
	public CFSecJavaFXSecFormAddForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecFormObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecFormPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getSecFormFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecFormPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecFormPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}

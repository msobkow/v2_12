// Description: Java 11 JavaFX Add Pane implementation for TSecGrpInc.
...
/**
 *	CFSecJavaFXTSecGrpIncAddPane JavaFX Add Pane implementation
 *	for TSecGrpInc.
 */
public class CFSecJavaFXTSecGrpIncAddPane
extends CFSplitPane
implements ICFSecJavaFXTSecGrpIncPaneCommon
{
	...
	public CFSecJavaFXTSecGrpIncAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecTSecGrpIncObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXTSecGrpIncPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}

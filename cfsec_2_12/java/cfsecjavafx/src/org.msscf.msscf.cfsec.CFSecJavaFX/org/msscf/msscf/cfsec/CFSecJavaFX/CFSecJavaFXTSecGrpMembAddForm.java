// Description: Java 11 JavaFX Add Form implementation for TSecGrpMemb.
...
/**
 *	CFSecJavaFXTSecGrpMembAddForm JavaFX Add Form implementation
 *	for TSecGrpMemb.
 */
public class CFSecJavaFXTSecGrpMembAddForm
extends CFBorderPane
implements ICFSecJavaFXTSecGrpMembPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Tenant Security Group Member";
	...
	public CFSecJavaFXTSecGrpMembAddForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecTSecGrpMembObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getTSecGrpMembFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXTSecGrpMembPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getTSecGrpMembFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXTSecGrpMembPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXTSecGrpMembPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}

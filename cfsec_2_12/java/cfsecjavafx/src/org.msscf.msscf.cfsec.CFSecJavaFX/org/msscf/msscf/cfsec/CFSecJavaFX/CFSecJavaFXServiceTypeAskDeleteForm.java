// Description: Java 11 JavaFX Ask Delete Pane implementation for ServiceType.
...
/**
 *	CFSecJavaFXServiceTypeAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for ServiceType.
 */
public class CFSecJavaFXServiceTypeAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXServiceTypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Service Type";
	...
	public CFSecJavaFXServiceTypeAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecServiceTypeObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Service Type?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecServiceTypeObj obj = getJavaFXFocusAsServiceType();
					ICFSecServiceTypeEditObj editObj = (ICFSecServiceTypeEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsServiceType( ICFSecServiceTypeObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXServiceTypePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}

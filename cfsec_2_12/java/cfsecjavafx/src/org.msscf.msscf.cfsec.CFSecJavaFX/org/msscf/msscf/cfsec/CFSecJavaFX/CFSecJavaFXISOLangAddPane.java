// Description: Java 11 JavaFX Add Pane implementation for ISOLang.
...
/**
 *	CFSecJavaFXISOLangAddPane JavaFX Add Pane implementation
 *	for ISOLang.
 */
public class CFSecJavaFXISOLangAddPane
extends CFSplitPane
implements ICFSecJavaFXISOLangPaneCommon
{
	...
	public CFSecJavaFXISOLangAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecISOLangObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXISOLangPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}

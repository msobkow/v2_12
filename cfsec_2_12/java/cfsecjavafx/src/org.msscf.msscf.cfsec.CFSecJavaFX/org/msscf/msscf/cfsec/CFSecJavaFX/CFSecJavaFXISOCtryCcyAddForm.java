// Description: Java 11 JavaFX Add Form implementation for ISOCtryCcy.
...
/**
 *	CFSecJavaFXISOCtryCcyAddForm JavaFX Add Form implementation
 *	for ISOCtryCcy.
 */
public class CFSecJavaFXISOCtryCcyAddForm
extends CFBorderPane
implements ICFSecJavaFXISOCtryCcyPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add ISOCtryCcy";
	...
	public CFSecJavaFXISOCtryCcyAddForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecISOCtryCcyObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getISOCtryCcyFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXISOCtryCcyPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getISOCtryCcyFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXISOCtryCcyPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXISOCtryCcyPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}

// Description: Java 11 JavaFX Ask Delete Pane implementation for TSecGrpInc.
...
/**
 *	CFSecJavaFXTSecGrpIncAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for TSecGrpInc.
 */
public class CFSecJavaFXTSecGrpIncAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXTSecGrpIncPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Tenant Security Group Include";
	...
	public CFSecJavaFXTSecGrpIncAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecTSecGrpIncObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Tenant Security Group Include?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecTSecGrpIncObj obj = getJavaFXFocusAsTSecGrpInc();
					ICFSecTSecGrpIncEditObj editObj = (ICFSecTSecGrpIncEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getTSecGrpIncFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsTSecGrpInc( ICFSecTSecGrpIncObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXTSecGrpIncPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFSecJavaFXTSecGrpIncPaneCommon)attrPane).setPaneMode( value );
		}
	}

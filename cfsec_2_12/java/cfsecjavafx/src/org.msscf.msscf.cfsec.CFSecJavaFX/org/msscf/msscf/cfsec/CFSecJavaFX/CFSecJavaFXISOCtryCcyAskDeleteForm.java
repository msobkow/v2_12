// Description: Java 11 JavaFX Ask Delete Pane implementation for ISOCtryCcy.
...
/**
 *	CFSecJavaFXISOCtryCcyAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for ISOCtryCcy.
 */
public class CFSecJavaFXISOCtryCcyAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXISOCtryCcyPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete ISOCtryCcy";
	...
	public CFSecJavaFXISOCtryCcyAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecISOCtryCcyObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this ISOCtryCcy?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecISOCtryCcyObj obj = getJavaFXFocusAsISOCtryCcy();
					ICFSecISOCtryCcyEditObj editObj = (ICFSecISOCtryCcyEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsISOCtryCcy( ICFSecISOCtryCcyObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXISOCtryCcyPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}

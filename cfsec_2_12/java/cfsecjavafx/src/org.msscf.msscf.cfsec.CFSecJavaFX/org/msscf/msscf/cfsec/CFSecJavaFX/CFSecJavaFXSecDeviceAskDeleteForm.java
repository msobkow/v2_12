// Description: Java 11 JavaFX Ask Delete Pane implementation for SecDevice.
...
/**
 *	CFSecJavaFXSecDeviceAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for SecDevice.
 */
public class CFSecJavaFXSecDeviceAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXSecDevicePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Security Device";
	...
	public CFSecJavaFXSecDeviceAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecDeviceObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Security Device?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecSecDeviceObj obj = getJavaFXFocusAsSecDevice();
					ICFSecSecDeviceEditObj editObj = (ICFSecSecDeviceEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getSecDeviceFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsSecDevice( ICFSecSecDeviceObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXSecDevicePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFSecJavaFXSecDevicePaneCommon)attrPane).setPaneMode( value );
		}
	}

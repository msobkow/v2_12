// Description: Java 11 JavaFX Add Form implementation for SecGroupForm.
...
/**
 *	CFSecJavaFXSecGroupFormAddForm JavaFX Add Form implementation
 *	for SecGroupForm.
 */
public class CFSecJavaFXSecGroupFormAddForm
extends CFBorderPane
implements ICFSecJavaFXSecGroupFormPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Security Group Form";
	...
	public CFSecJavaFXSecGroupFormAddForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecGroupFormObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getSecGroupFormFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecGroupFormPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getSecGroupFormFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecGroupFormPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecGroupFormPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}

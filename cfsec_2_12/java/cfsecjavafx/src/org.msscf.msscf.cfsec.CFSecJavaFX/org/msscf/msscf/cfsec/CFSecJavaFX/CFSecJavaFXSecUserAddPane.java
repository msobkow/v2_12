// Description: Java 11 JavaFX Add Pane implementation for SecUser.
...
/**
 *	CFSecJavaFXSecUserAddPane JavaFX Add Pane implementation
 *	for SecUser.
 */
public class CFSecJavaFXSecUserAddPane
extends CFSplitPane
implements ICFSecJavaFXSecUserPaneCommon
{
	...
	public CFSecJavaFXSecUserAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecUserObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecUserPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}

// Description: Java 11 JavaFX List of Obj Pane implementation for ServiceType.
...
/**
 *	CFSecJavaFXServiceTypeListPane JavaFX List of Obj Pane implementation
 *	for ServiceType.
 */
public class CFSecJavaFXServiceTypeListPane
extends CFBorderPane
implements ICFSecJavaFXServiceTypePaneList
{
	public static String S_FormName = "List Service Type";
	...
	public CFSecJavaFXServiceTypeListPane( ICFFormManager formManager,
		...
		boolean sortByChain )
	{
		...
		if( observableListOfServiceType != null ) {
	...
	public void adjustListButtons() {
		...
		if( buttonAddServiceType != null ) {
			buttonAddServiceType.setDisable( ! allowAdds );
		}

// Description: Java 11 JavaFX Ask Delete Pane implementation for ISOCtry.
...
/**
 *	CFSecJavaFXISOCtryAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for ISOCtry.
 */
public class CFSecJavaFXISOCtryAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXISOCtryPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete ISO Ctry";
	...
	public CFSecJavaFXISOCtryAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecISOCtryObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this ISO Ctry?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecISOCtryObj obj = getJavaFXFocusAsISOCtry();
					ICFSecISOCtryEditObj editObj = (ICFSecISOCtryEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getISOCtryFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsISOCtry( ICFSecISOCtryObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXISOCtryPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFSecJavaFXISOCtryPaneCommon)attrPane).setPaneMode( value );
		}
	}

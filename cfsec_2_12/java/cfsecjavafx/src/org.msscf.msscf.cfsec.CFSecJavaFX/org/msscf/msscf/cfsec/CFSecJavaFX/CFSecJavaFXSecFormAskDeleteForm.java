// Description: Java 11 JavaFX Ask Delete Pane implementation for SecForm.
...
/**
 *	CFSecJavaFXSecFormAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for SecForm.
 */
public class CFSecJavaFXSecFormAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXSecFormPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Security Form";
	...
	public CFSecJavaFXSecFormAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecFormObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Security Form?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecSecFormObj obj = getJavaFXFocusAsSecForm();
					ICFSecSecFormEditObj editObj = (ICFSecSecFormEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsSecForm( ICFSecSecFormObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXSecFormPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}

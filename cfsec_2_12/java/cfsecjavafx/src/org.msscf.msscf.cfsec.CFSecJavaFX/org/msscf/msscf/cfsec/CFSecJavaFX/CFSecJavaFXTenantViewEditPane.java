// Description: Java 11 JavaFX View/Edit Pane implementation for Tenant.
...
/**
 *	CFSecJavaFXTenantViewEditPane JavaFX View/Edit Pane implementation
 *	for Tenant.
 */
public class CFSecJavaFXTenantViewEditPane
extends CFSplitPane
implements ICFSecJavaFXTenantPaneCommon
{
	...
	public CFSecJavaFXTenantViewEditPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecTenantObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getTenantFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXTenantPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXTenantPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFSecJavaFXTenantPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}

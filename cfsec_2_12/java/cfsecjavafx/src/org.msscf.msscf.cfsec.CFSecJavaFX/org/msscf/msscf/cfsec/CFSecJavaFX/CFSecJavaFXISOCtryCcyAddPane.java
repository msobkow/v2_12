// Description: Java 11 JavaFX Add Pane implementation for ISOCtryCcy.
...
/**
 *	CFSecJavaFXISOCtryCcyAddPane JavaFX Add Pane implementation
 *	for ISOCtryCcy.
 */
public class CFSecJavaFXISOCtryCcyAddPane
extends CFSplitPane
implements ICFSecJavaFXISOCtryCcyPaneCommon
{
	...
	public CFSecJavaFXISOCtryCcyAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecISOCtryCcyObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXISOCtryCcyPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}

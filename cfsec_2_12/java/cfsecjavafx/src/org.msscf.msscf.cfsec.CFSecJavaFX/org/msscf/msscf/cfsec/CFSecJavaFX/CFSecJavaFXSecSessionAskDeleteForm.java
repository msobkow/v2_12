// Description: Java 11 JavaFX Ask Delete Pane implementation for SecSession.
...
/**
 *	CFSecJavaFXSecSessionAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for SecSession.
 */
public class CFSecJavaFXSecSessionAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXSecSessionPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Security Session";
	...
	public CFSecJavaFXSecSessionAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecSessionObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Security Session?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecSecSessionObj obj = getJavaFXFocusAsSecSession();
					ICFSecSecSessionEditObj editObj = (ICFSecSecSessionEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getSecSessionFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsSecSession( ICFSecSecSessionObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXSecSessionPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFSecJavaFXSecSessionPaneCommon)attrPane).setPaneMode( value );
		}
	}

// Description: Java 11 JavaFX Add Pane implementation for Cluster.
...
/**
 *	CFSecJavaFXClusterAddPane JavaFX Add Pane implementation
 *	for Cluster.
 */
public class CFSecJavaFXClusterAddPane
extends CFSplitPane
implements ICFSecJavaFXClusterPaneCommon
{
	...
	public CFSecJavaFXClusterAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecClusterObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXClusterPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}

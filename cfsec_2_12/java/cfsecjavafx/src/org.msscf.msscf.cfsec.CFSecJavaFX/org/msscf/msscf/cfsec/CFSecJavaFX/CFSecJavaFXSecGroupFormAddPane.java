// Description: Java 11 JavaFX Add Pane implementation for SecGroupForm.
...
/**
 *	CFSecJavaFXSecGroupFormAddPane JavaFX Add Pane implementation
 *	for SecGroupForm.
 */
public class CFSecJavaFXSecGroupFormAddPane
extends CFSplitPane
implements ICFSecJavaFXSecGroupFormPaneCommon
{
	...
	public CFSecJavaFXSecGroupFormAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecGroupFormObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecGroupFormPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}

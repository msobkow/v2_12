// Description: Java 11 JavaFX Add Pane implementation for SecGroup.
...
/**
 *	CFSecJavaFXSecGroupAddPane JavaFX Add Pane implementation
 *	for SecGroup.
 */
public class CFSecJavaFXSecGroupAddPane
extends CFSplitPane
implements ICFSecJavaFXSecGroupPaneCommon
{
	...
	public CFSecJavaFXSecGroupAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecGroupObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecGroupPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}

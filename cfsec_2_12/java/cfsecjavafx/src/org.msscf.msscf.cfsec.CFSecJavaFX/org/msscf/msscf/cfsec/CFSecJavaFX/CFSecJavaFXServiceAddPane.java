// Description: Java 11 JavaFX Add Pane implementation for Service.
...
/**
 *	CFSecJavaFXServiceAddPane JavaFX Add Pane implementation
 *	for Service.
 */
public class CFSecJavaFXServiceAddPane
extends CFSplitPane
implements ICFSecJavaFXServicePaneCommon
{
	...
	public CFSecJavaFXServiceAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecServiceObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXServicePaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}

// Description: Java 11 JavaFX View/Edit Pane implementation for ISOLang.
...
/**
 *	CFSecJavaFXISOLangViewEditPane JavaFX View/Edit Pane implementation
 *	for ISOLang.
 */
public class CFSecJavaFXISOLangViewEditPane
extends CFSplitPane
implements ICFSecJavaFXISOLangPaneCommon
{
	...
	public CFSecJavaFXISOLangViewEditPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecISOLangObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getISOLangFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXISOLangPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXISOLangPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFSecJavaFXISOLangPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}

// Description: Java 11 JavaFX Ask Delete Pane implementation for ISOLang.
...
/**
 *	CFSecJavaFXISOLangAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for ISOLang.
 */
public class CFSecJavaFXISOLangAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXISOLangPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete ISO Lang";
	...
	public CFSecJavaFXISOLangAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecISOLangObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this ISO Lang?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecISOLangObj obj = getJavaFXFocusAsISOLang();
					ICFSecISOLangEditObj editObj = (ICFSecISOLangEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getISOLangFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsISOLang( ICFSecISOLangObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXISOLangPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFSecJavaFXISOLangPaneCommon)attrPane).setPaneMode( value );
		}
	}

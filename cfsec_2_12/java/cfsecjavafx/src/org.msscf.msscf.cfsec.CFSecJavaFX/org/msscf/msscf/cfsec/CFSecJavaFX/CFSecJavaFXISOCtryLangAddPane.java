// Description: Java 11 JavaFX Add Pane implementation for ISOCtryLang.
...
/**
 *	CFSecJavaFXISOCtryLangAddPane JavaFX Add Pane implementation
 *	for ISOCtryLang.
 */
public class CFSecJavaFXISOCtryLangAddPane
extends CFSplitPane
implements ICFSecJavaFXISOCtryLangPaneCommon
{
	...
	public CFSecJavaFXISOCtryLangAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecISOCtryLangObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXISOCtryLangPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}

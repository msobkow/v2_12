// Description: Java 11 JavaFX Add Form implementation for ISOCtryLang.
...
/**
 *	CFSecJavaFXISOCtryLangAddForm JavaFX Add Form implementation
 *	for ISOCtryLang.
 */
public class CFSecJavaFXISOCtryLangAddForm
extends CFBorderPane
implements ICFSecJavaFXISOCtryLangPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add ISOCtryLang";
	...
	public CFSecJavaFXISOCtryLangAddForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecISOCtryLangObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getISOCtryLangFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXISOCtryLangPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getISOCtryLangFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXISOCtryLangPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXISOCtryLangPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}

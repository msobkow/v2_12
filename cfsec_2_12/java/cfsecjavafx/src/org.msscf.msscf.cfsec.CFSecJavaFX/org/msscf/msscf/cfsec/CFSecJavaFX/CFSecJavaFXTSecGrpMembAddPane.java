// Description: Java 11 JavaFX Add Pane implementation for TSecGrpMemb.
...
/**
 *	CFSecJavaFXTSecGrpMembAddPane JavaFX Add Pane implementation
 *	for TSecGrpMemb.
 */
public class CFSecJavaFXTSecGrpMembAddPane
extends CFSplitPane
implements ICFSecJavaFXTSecGrpMembPaneCommon
{
	...
	public CFSecJavaFXTSecGrpMembAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecTSecGrpMembObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXTSecGrpMembPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}

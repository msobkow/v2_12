// Description: Java 11 JavaFX Add Form implementation for SecUser.
...
/**
 *	CFSecJavaFXSecUserAddForm JavaFX Add Form implementation
 *	for SecUser.
 */
public class CFSecJavaFXSecUserAddForm
extends CFBorderPane
implements ICFSecJavaFXSecUserPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Security User";
	...
	public CFSecJavaFXSecUserAddForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecUserObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getSecUserFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecUserPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getSecUserFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecUserPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecUserPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}

// Description: Java 11 JavaFX View/Edit Form implementation for TSecGrpMemb.
...
/**
 *	CFSecJavaFXTSecGrpMembViewEditForm JavaFX View/Edit Form implementation
 *	for TSecGrpMemb.
 */
public class CFSecJavaFXTSecGrpMembViewEditForm
extends CFBorderPane
implements ICFSecJavaFXTSecGrpMembPaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit Tenant Security Group Member";
	...
	public CFSecJavaFXTSecGrpMembViewEditForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecTSecGrpMembObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFSecTSecGrpMembObj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxViewEditPane = argSchema.getTSecGrpMembFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void forceCancelAndClose() {
		...
		if( focus != null ) {
			ICFSecTSecGrpMembEditObj editObj = (ICFSecTSecGrpMembEditObj)focus.getEdit();
			if( editObj != null ) {
				if( editObj.getIsNew() ) {
					editObj.endEdit();
					editObj = null;
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXTSecGrpMembPaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		ICFSecTSecGrpMembObj argFocus = (ICFSecTSecGrpMembObj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFSecTSecGrpMembObj)argFocus.read( true );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsTSecGrpMemb() != null ) {
							if( null == getJavaFXFocusAsTSecGrpMemb().getEdit() ) {
			...
			buttonClose.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						cfFormManager.closeCurrentForm();
						if( formClosedCallback != null ) {
							focus = getJavaFXFocusAsTSecGrpMemb();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXTSecGrpMembPaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXTSecGrpMembPaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}

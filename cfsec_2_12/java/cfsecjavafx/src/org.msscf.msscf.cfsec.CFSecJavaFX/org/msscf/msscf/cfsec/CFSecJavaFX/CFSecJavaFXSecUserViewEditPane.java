// Description: Java 11 JavaFX View/Edit Pane implementation for SecUser.
...
/**
 *	CFSecJavaFXSecUserViewEditPane JavaFX View/Edit Pane implementation
 *	for SecUser.
 */
public class CFSecJavaFXSecUserViewEditPane
extends CFSplitPane
implements ICFSecJavaFXSecUserPaneCommon
{
	...
	public CFSecJavaFXSecUserViewEditPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecUserObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getSecUserFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecUserPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecUserPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFSecJavaFXSecUserPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}

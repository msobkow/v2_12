// Description: Java 11 JavaFX Ask Delete Pane implementation for Service.
...
/**
 *	CFSecJavaFXServiceAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for Service.
 */
public class CFSecJavaFXServiceAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXServicePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Service";
	...
	public CFSecJavaFXServiceAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecServiceObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Service?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecServiceObj obj = getJavaFXFocusAsService();
					ICFSecServiceEditObj editObj = (ICFSecServiceEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getServiceFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsService( ICFSecServiceObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXServicePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFSecJavaFXServicePaneCommon)attrPane).setPaneMode( value );
		}
	}

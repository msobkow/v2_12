// Description: Java 11 JavaFX View/Edit Pane implementation for SecSession.
...
/**
 *	CFSecJavaFXSecSessionViewEditPane JavaFX View/Edit Pane implementation
 *	for SecSession.
 */
public class CFSecJavaFXSecSessionViewEditPane
extends CFSplitPane
implements ICFSecJavaFXSecSessionPaneCommon
{
	...
	public CFSecJavaFXSecSessionViewEditPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecSessionObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecSessionPaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}

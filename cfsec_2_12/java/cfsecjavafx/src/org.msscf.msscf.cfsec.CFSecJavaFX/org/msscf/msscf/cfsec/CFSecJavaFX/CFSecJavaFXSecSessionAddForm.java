// Description: Java 11 JavaFX Add Form implementation for SecSession.
...
/**
 *	CFSecJavaFXSecSessionAddForm JavaFX Add Form implementation
 *	for SecSession.
 */
public class CFSecJavaFXSecSessionAddForm
extends CFBorderPane
implements ICFSecJavaFXSecSessionPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Security Session";
	...
	public CFSecJavaFXSecSessionAddForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecSessionObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getSecSessionFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecSessionPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getSecSessionFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecSessionPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecSessionPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}

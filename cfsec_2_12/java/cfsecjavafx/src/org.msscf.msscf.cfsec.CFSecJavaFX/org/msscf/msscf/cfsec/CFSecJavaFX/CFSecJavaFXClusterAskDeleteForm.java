// Description: Java 11 JavaFX Ask Delete Pane implementation for Cluster.
...
/**
 *	CFSecJavaFXClusterAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for Cluster.
 */
public class CFSecJavaFXClusterAskDeleteForm
	...
	ICFForm
{
	...
	public CFSecJavaFXClusterAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecClusterObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecClusterObj obj = getJavaFXFocusAsCluster();
					ICFSecClusterEditObj editObj = (ICFSecClusterEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsCluster( ICFSecClusterObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXClusterPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}

// Description: Java 11 JavaFX Ask Delete Pane implementation for ISOTZone.
...
/**
 *	CFSecJavaFXISOTZoneAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for ISOTZone.
 */
public class CFSecJavaFXISOTZoneAskDeleteForm
extends CFBorderPane
implements ICFSecJavaFXISOTZonePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete ISO Timezone";
	...
	public CFSecJavaFXISOTZoneAskDeleteForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecISOTZoneObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this ISO Timezone?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFSecISOTZoneObj obj = getJavaFXFocusAsISOTZone();
					ICFSecISOTZoneEditObj editObj = (ICFSecISOTZoneEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsISOTZone( ICFSecISOTZoneObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFSecJavaFXISOTZonePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}

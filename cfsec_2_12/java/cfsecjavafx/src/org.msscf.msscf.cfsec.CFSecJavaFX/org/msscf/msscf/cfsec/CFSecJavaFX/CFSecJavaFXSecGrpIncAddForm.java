// Description: Java 11 JavaFX Add Form implementation for SecGrpInc.
...
/**
 *	CFSecJavaFXSecGrpIncAddForm JavaFX Add Form implementation
 *	for SecGrpInc.
 */
public class CFSecJavaFXSecGrpIncAddForm
extends CFBorderPane
implements ICFSecJavaFXSecGrpIncPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Security Group Include";
	...
	public CFSecJavaFXSecGrpIncAddForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecGrpIncObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getSecGrpIncFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXSecGrpIncPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getSecGrpIncFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecGrpIncPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXSecGrpIncPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}

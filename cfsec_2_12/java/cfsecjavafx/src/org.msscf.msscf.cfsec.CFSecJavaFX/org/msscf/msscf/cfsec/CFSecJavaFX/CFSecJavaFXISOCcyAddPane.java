// Description: Java 11 JavaFX Add Pane implementation for ISOCcy.
...
/**
 *	CFSecJavaFXISOCcyAddPane JavaFX Add Pane implementation
 *	for ISOCcy.
 */
public class CFSecJavaFXISOCcyAddPane
extends CFSplitPane
implements ICFSecJavaFXISOCcyPaneCommon
{
	...
	public CFSecJavaFXISOCcyAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecISOCcyObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXISOCcyPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}

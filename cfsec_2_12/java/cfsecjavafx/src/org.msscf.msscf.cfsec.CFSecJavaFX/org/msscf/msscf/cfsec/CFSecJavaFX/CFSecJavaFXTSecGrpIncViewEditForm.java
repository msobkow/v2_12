// Description: Java 11 JavaFX View/Edit Form implementation for TSecGrpInc.
...
/**
 *	CFSecJavaFXTSecGrpIncViewEditForm JavaFX View/Edit Form implementation
 *	for TSecGrpInc.
 */
public class CFSecJavaFXTSecGrpIncViewEditForm
extends CFBorderPane
implements ICFSecJavaFXTSecGrpIncPaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit Tenant Security Group Include";
	...
	public CFSecJavaFXTSecGrpIncViewEditForm( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecTSecGrpIncObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		javafxViewEditPane = argSchema.getTSecGrpIncFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFSecJavaFXTSecGrpIncPaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsTSecGrpInc() != null ) {
							if( null == getJavaFXFocusAsTSecGrpInc().getEdit() ) {
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXTSecGrpIncPaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFSecJavaFXTSecGrpIncPaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}

// Description: Java 11 JavaFX Add Pane implementation for SecForm.
...
/**
 *	CFSecJavaFXSecFormAddPane JavaFX Add Pane implementation
 *	for SecForm.
 */
public class CFSecJavaFXSecFormAddPane
extends CFSplitPane
implements ICFSecJavaFXSecFormPaneCommon
{
	...
	public CFSecJavaFXSecFormAddPane( ICFFormManager formManager, ICFSecJavaFXSchema argSchema, ICFSecSecFormObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFSecJavaFXSecFormPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}

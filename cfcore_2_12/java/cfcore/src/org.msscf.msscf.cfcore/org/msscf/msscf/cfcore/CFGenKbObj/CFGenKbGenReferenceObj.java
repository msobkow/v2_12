...
{
	public final static String CLASS_CODE = "REF";
	...
	public void forget( boolean forgetSubObjects ) {
		((ICFGenKbSchemaObj)schema).getGenReferenceTableObj().forgetGenReference( (ICFGenKbGenReferenceObj)this, forgetSubObjects );
	}

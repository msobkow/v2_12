	...
	implements ICFGenKbGelModifierTableObj
{
	...
	public void forgetGelModifier( ICFGenKbGelModifierObj Obj ) {
		forgetGelModifier( Obj, false );
	}

	public void forgetGelModifier( ICFGenKbGelModifierObj Obj, boolean forgetSubObjects ) {
		ICFGenKbGelModifierObj obj = Obj;
		CFGenKbGelInstructionPKey pkey = obj.getPKey();
		if( members.containsKey( pkey ) ) {
			ICFGenKbGelModifierObj keepObj = members.get( pkey );
			...
			if( allGelModifier != null ) {
				allGelModifier.remove( keepObj.getPKey() );
			}
			members.remove( pkey );
			if( forgetSubObjects ) {
			}
	...
	public void forgetGelModifierByPIdx( long TenantId,
		long GelCacheId,
		long GelInstId )
	{
		if( members == null ) {
		...
		if( members.containsKey( key ) ) {
			ICFGenKbGelModifierObj probed = members.get( key );
			if( probed != null ) {
				probed.forget( true );
			}
		}
	...
	public void forgetGelModifierByTenantIdx( long TenantId )
	{
		if( indexByTenantIdx == null ) {
			return;
		}
		...
		if( indexByTenantIdx.containsKey( key ) ) {
			Map<CFGenKbGelInstructionPKey, ICFGenKbGelModifierObj > mapTenantIdx = indexByTenantIdx.get( key );
			if( mapTenantIdx != null ) {
				Iterator<ICFGenKbGelModifierObj> iterDup = mapTenantIdx.values().iterator();
			...
			Iterator<ICFGenKbGelModifierObj> memberIter = members.values().iterator();
		...
		Iterator<ICFGenKbGelModifierObj> iter = toForget.iterator();
		while( iter.hasNext() ) {
			cur = iter.next();
			cur.forget( true );
		}
	...
	public void forgetGelModifierByGelCacheIdx( long TenantId,
		long GelCacheId )
	{
		if( indexByGelCacheIdx == null ) {
			return;
		...
		if( indexByGelCacheIdx.containsKey( key ) ) {
			Map<CFGenKbGelInstructionPKey, ICFGenKbGelModifierObj > mapGelCacheIdx = indexByGelCacheIdx.get( key );
			if( mapGelCacheIdx != null ) {
				Iterator<ICFGenKbGelModifierObj> iterDup = mapGelCacheIdx.values().iterator();
				while( iterDup.hasNext() ) {
					cur = iterDup.next();
					toForget.add( cur );
				}
	...
	public void forgetGelModifierByChainIdx( Long ChainInstTenantId,
		...
		Long ChainInstGelInstId )
	{
		...
		if( indexByChainIdx.containsKey( key ) ) {
			Map<CFGenKbGelInstructionPKey, ICFGenKbGelModifierObj > mapChainIdx = indexByChainIdx.get( key );
			if( mapChainIdx != null ) {
				Iterator<ICFGenKbGelModifierObj> iterDup = mapChainIdx.values().iterator();
				while( iterDup.hasNext() ) {
					cur = iterDup.next();
					toForget.add( cur );
				}
	...
	public void forgetGelModifierByRemainderIdx( Long RemainderTenantId,
		...
		Long RemainderInstId )
	{
		...
		if( indexByRemainderIdx.containsKey( key ) ) {
			Map<CFGenKbGelInstructionPKey, ICFGenKbGelModifierObj > mapRemainderIdx = indexByRemainderIdx.get( key );
			if( mapRemainderIdx != null ) {
				Iterator<ICFGenKbGelModifierObj> iterDup = mapRemainderIdx.values().iterator();
				while( iterDup.hasNext() ) {
					cur = iterDup.next();
					toForget.add( cur );
				}
	...
	public ICFGenKbGelModifierObj createGelModifier( ICFGenKbGelModifierObj Obj ) {
		...
		((ICFGenKbSchema)schema.getBackingStore()).getTableGelModifier().createGelModifier(
			...
			buff );
		obj.copyBuffToPKey();
		if( obj.getPKey().getClassCode().equals( "GMOD" ) ) {
	...
	public ICFGenKbGelModifierObj updateGelModifier( ICFGenKbGelModifierObj Obj ) {
		...
		if( Obj.getClassCode().equals( "GMOD" ) ) {
			obj = (ICFGenKbGelModifierObj)Obj.realise();
		}
		obj.endEdit();
		return( obj );

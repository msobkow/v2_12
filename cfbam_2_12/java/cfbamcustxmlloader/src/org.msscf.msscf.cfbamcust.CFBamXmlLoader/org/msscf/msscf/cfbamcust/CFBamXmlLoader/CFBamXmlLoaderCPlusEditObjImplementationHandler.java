...
/*
 *	CFBamXmlLoaderCPlusEditObjImplementationHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusEditObjImplementationHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusEditObjImplementationHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusEditObjImplementation" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCppEditObjImplementation( text );
		editTable.update();
		editTable = null;
	}
}

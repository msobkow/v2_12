...
/*
 *	CFBamXmlLoaderHPlusXMsgClientTableIncludeHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusXMsgClientTableIncludeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusXMsgClientTableIncludeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusXMsgClientTableInclude" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalHppXMsgClientTableInclude( text );
		editTable.update();
		editTable = null;
	}
}

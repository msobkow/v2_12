...
/*
 *	CFBamXmlLoaderInt32TypeParse XML SAX Element Handler implementation
 *	for Int32Type.
 */
public class CFBamXmlLoaderInt32TypeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderInt32TypeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamInt32TypeEditObj editInt32Type = editBuff;
			ICFBamInt32TypeObj origInt32Type = (ICFBamInt32TypeObj)editInt32Type.create();
			editInt32Type = null;

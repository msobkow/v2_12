...
/*
 *	CFBamXmlLoaderCPlusMSSqlTableImplementationHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusMSSqlTableImplementationHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusMSSqlTableImplementationHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusMSSqlTableImplementation" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCppMSSqlTableImplementation( text );
		editTable.update();
		editTable = null;
	}
}

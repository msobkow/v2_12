...
/*
 *	CFBamXmlLoaderHPlusMSSqlSchemaObjImplHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusMSSqlSchemaObjImplHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusMSSqlSchemaObjImplHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusMSSqlSchemaObjImpl" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalHppMSSqlSchemaObjImpl( text );

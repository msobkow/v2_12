...
/*
 *	CFBamXmlLoaderCSharpXMsgRspnSchemaBodyHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpXMsgRspnSchemaBodyHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpXMsgRspnSchemaBodyHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpXMsgRspnSchemaBody" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCsXMsgRspnSchemaBody( text );

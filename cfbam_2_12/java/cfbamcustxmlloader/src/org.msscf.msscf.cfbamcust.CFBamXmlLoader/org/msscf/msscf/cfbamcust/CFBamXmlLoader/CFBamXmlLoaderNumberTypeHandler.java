...
/*
 *	CFBamXmlLoaderNumberTypeParse XML SAX Element Handler implementation
 *	for NumberType.
 */
public class CFBamXmlLoaderNumberTypeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderNumberTypeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamNumberTypeEditObj editNumberType = editBuff;
			ICFBamNumberTypeObj origNumberType = (ICFBamNumberTypeObj)editNumberType.create();
			editNumberType = null;

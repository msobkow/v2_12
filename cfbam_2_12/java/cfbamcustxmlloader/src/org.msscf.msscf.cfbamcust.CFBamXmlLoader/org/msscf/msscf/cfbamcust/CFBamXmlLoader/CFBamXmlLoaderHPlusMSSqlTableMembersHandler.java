...
/*
 *	CFBamXmlLoaderHPlusMSSqlTableMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusMSSqlTableMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusMSSqlTableMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusMSSqlTableMembers" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalHppMSSqlTableMembers( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderHPlusPgSqlSchemaObjImplHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusPgSqlSchemaObjImplHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusPgSqlSchemaObjImplHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusPgSqlSchemaObjImpl" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalHppPgSqlSchemaObjImpl( text );

...
/*
 *	CFBamXmlLoaderCafeXMsgClientSchemaBodyHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeXMsgClientSchemaBodyHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeXMsgClientSchemaBodyHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeXMsgClientSchemaBody" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalJXMsgClientSchemaBody( text );

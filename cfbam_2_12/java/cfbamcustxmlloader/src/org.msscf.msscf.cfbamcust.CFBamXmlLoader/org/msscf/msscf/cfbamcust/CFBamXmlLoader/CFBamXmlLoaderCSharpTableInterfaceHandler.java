...
/*
 *	CFBamXmlLoaderCSharpTableInterfaceHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpTableInterfaceHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpTableInterfaceHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpTableInterface" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCsTableInterface( text );
		editTable.update();
		editTable = null;
	}
}

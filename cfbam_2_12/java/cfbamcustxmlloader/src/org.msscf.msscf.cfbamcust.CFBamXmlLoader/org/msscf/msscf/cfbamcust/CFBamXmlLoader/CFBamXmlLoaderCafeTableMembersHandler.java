...
/*
 *	CFBamXmlLoaderCafeTableMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeTableMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeTableMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeTableMembers" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalJTableMembers( text );
		editTable.update();
		editTable = null;
	}
}

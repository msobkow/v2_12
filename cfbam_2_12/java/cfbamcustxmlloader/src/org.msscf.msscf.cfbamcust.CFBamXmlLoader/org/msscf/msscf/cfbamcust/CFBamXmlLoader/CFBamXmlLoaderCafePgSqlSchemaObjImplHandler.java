...
/*
 *	CFBamXmlLoaderCafePgSqlSchemaObjImplHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafePgSqlSchemaObjImplHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafePgSqlSchemaObjImplHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafePgSqlSchemaObjImpl" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalJPgSqlSchemaObjImpl( text );

...
/*
 *	CFBamXmlLoaderCafeMSSqlSchemaObjImportHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeMSSqlSchemaObjImportHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeMSSqlSchemaObjImportHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeMSSqlSchemObjImport" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalJMSSqlSchemaObjImport( text );

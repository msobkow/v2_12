...
/*
 *	CFBamXmlLoaderBlobTypeParse XML SAX Element Handler implementation
 *	for BlobType.
 */
public class CFBamXmlLoaderBlobTypeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderBlobTypeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamBlobTypeEditObj editBlobType = editBuff;
			ICFBamBlobTypeObj origBlobType = (ICFBamBlobTypeObj)editBlobType.create();
			editBlobType = null;

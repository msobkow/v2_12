...
/*
 *	CFBamXmlLoaderCPlusXMsgRspnSchemaWireParsersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusXMsgRspnSchemaWireParsersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusXMsgRspnSchemaWireParsersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusXMsgRspnSchemaWireParsers" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCppXMsgRspnSchemaWireParsers( text );

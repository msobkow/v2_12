...
/*
 *	CFBamXmlLoaderInt64TypeParse XML SAX Element Handler implementation
 *	for Int64Type.
 */
public class CFBamXmlLoaderInt64TypeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderInt64TypeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamInt64TypeEditObj editInt64Type = editBuff;
			ICFBamInt64TypeObj origInt64Type = (ICFBamInt64TypeObj)editInt64Type.create();
			editInt64Type = null;

...
/*
 *	CFBamXmlLoaderDoubleColParse XML SAX Element Handler implementation
 *	for DoubleCol.
 */
public class CFBamXmlLoaderDoubleColHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderDoubleColHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamDoubleColEditObj editDoubleCol = editBuff;
			ICFBamDoubleColObj origDoubleCol = (ICFBamDoubleColObj)editDoubleCol.create();
			editDoubleCol = null;

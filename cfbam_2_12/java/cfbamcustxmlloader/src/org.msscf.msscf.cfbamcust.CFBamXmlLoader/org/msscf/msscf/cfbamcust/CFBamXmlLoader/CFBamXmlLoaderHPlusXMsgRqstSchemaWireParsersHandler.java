...
/*
 *	CFBamXmlLoaderHPlusXMsgRqstSchemaWireParsersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusXMsgRqstSchemaWireParsersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusXMsgRqstSchemaWireParsersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusXMsgRqstSchemaWireParsers" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalHppXMsgRqstSchemaWireParsers( text );

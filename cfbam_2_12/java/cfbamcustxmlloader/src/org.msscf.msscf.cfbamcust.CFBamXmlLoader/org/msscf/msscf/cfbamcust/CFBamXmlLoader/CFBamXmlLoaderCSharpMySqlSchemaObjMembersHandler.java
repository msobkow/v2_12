...
/*
 *	CFBamXmlLoaderCSharpMySqlSchemObjMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpMySqlSchemaObjMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpMySqlSchemaObjMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpMySqlSchemObjMembers" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCsMySqlSchemaObjMembers( text );

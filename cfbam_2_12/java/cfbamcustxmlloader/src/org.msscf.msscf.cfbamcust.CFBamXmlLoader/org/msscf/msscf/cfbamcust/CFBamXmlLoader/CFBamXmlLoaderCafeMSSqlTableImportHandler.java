...
/*
 *	CFBamXmlLoaderCafeMSSqlTableImportHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeMSSqlTableImportHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeMSSqlTableImportHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeMSSqlTableImport" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalJMSSqlTableImport( text );
		editTable.update();
		editTable = null;
	}
}

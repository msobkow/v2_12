...
/*
 *	CFBamXmlLoaderCPlusMySqlSchemObjMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusMySqlSchemaObjMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusMySqlSchemaObjMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusMySqlSchemObjMembers" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCppMySqlSchemaObjMembers( text );

...
/*
 *	CFBamXmlLoaderCPlusRamTableIncludeHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusRamTableIncludeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusRamTableIncludeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusRamTableInclude" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCppRamTableInclude( text );
		editTable.update();
		editTable = null;
	}
}

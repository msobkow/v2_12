 ...
 */
public class CFBamXmlLoaderCPlusSchemaObjIncludeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusSchemaObjIncludeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCppSchemaObjInclude( text );

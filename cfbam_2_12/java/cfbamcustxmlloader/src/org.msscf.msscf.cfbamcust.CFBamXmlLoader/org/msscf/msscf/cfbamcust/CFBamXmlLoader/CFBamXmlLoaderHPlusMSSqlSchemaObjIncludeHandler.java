...
/*
 *	CFBamXmlLoaderHPlusMSSqlSchemaObjIncludeHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusMSSqlSchemaObjIncludeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusMSSqlSchemaObjIncludeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusMSSqlSchemObjInclude" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalHppMSSqlSchemaObjInclude( text );

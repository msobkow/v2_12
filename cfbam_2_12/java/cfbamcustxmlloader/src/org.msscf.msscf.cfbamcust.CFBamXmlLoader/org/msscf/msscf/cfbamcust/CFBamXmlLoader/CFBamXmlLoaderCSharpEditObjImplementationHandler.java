...
/*
 *	CFBamXmlLoaderCSharpEditObjImplementationHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpEditObjImplementationHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpEditObjImplementationHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpEditObjImplementation" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCsEditObjImplementation( text );
		editTable.update();
		editTable = null;
	}
}

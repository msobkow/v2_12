...
/*
 *	CFBamXmlLoaderCafeTableInterfaceHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeTableInterfaceHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeTableInterfaceHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeTableInterface" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalJTableInterface( text );
		editTable.update();
		editTable = null;
	}
}

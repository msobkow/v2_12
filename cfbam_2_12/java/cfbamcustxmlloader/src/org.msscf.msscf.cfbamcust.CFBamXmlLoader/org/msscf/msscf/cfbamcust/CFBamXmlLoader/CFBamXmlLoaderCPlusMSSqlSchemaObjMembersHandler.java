...
/*
 *	CFBamXmlLoaderCPlusMSSqlSchemaObjMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusMSSqlSchemaObjMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusMSSqlSchemaObjMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusMSSqlSchemaObjMembers" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCppMSSqlSchemaObjMembers( text );

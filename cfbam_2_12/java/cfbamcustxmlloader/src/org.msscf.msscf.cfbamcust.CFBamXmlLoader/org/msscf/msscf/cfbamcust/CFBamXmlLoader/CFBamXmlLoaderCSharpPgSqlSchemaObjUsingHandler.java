...
/*
 *	CFBamXmlLoaderCSharpPgSqlSchemObjImplHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpPgSqlSchemaObjUsingHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpPgSqlSchemaObjUsingHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpPgSqlSchemObjUsing" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCsPgSqlSchemaObjUsing( text );

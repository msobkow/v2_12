...
/*
 *	CFBamXmlLoaderCafeXMsgTableFormattersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeXMsgTableFormattersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeXMsgTableFormattersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeXMsgTableFormatters" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalJXMsgTableFormatters( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderCafePgSqlTableMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafePgSqlTableMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafePgSqlTableMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafePgSqlTableMembers" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalJPgSqlTableMembers( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderHPlusXMsgRqstSchemaXsdElementListHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusXMsgRqstSchemaXsdElementListHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusXMsgRqstSchemaXsdElementListHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusXMsgRqstSchemaXsdElementList" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalHppXMsgRqstSchemaXsdElementList( text );

...
/*
 *	CFBamXmlLoaderDateTypeParse XML SAX Element Handler implementation
 *	for DateType.
 */
public class CFBamXmlLoaderDateTypeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderDateTypeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamDateTypeEditObj editDateType = editBuff;
			ICFBamDateTypeObj origDateType = (ICFBamDateTypeObj)editDateType.create();
			editDateType = null;

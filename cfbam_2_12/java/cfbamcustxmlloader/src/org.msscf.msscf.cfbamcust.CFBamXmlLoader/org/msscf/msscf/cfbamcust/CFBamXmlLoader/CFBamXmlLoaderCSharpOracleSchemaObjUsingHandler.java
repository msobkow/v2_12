...
/*
 *	CFBamXmlLoaderCSharpOracleSchemaObjUsingHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpOracleSchemaObjUsingHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpOracleSchemaObjUsingHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpOracleSchemObjUsing" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCsOracleSchemaObjUsing( text );

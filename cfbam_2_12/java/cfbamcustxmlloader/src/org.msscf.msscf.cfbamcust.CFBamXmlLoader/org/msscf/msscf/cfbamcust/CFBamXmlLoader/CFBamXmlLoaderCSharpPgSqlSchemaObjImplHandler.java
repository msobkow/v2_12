...
/*
 *	CFBamXmlLoaderCSharpPgSqlSchemaObjImplHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpPgSqlSchemaObjImplHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpPgSqlSchemaObjImplHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpPgSqlSchemaObjImpl" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCsPgSqlSchemaObjImpl( text );

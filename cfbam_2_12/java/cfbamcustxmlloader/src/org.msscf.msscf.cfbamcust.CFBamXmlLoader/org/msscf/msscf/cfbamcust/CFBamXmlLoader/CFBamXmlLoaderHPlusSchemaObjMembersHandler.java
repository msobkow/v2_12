...
/*
 *	CFBamXmlLoaderHPlusSchemaObjMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusSchemaObjMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusSchemaObjMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusSchemaObjMembers" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalHppSchemaObjMembers( text );

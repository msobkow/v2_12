...
/*
 *	CFBamXmlLoaderCafePgSqlTableImplementationHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafePgSqlTableImplementationHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafePgSqlTableImplementationHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafePgSqlTableImplementation" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalJPgSqlTableImplementation( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderInt16TypeParse XML SAX Element Handler implementation
 *	for Int16Type.
 */
public class CFBamXmlLoaderInt16TypeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderInt16TypeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamInt16TypeEditObj editInt16Type = editBuff;
			ICFBamInt16TypeObj origInt16Type = (ICFBamInt16TypeObj)editInt16Type.create();
			editInt16Type = null;

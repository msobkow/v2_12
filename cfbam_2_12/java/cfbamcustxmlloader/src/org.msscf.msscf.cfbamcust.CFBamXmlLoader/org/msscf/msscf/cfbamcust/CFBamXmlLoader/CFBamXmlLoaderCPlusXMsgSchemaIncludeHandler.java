...
/*
 *	CFBamXmlLoaderCPlusXMsgSchemaIncludeHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusXMsgSchemaIncludeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusXMsgSchemaIncludeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusXMsgSchemaInclude" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCppXMsgSchemaInclude( text );

...
/*
 *	CFBamXmlLoaderBoolColParse XML SAX Element Handler implementation
 *	for BoolCol.
 */
public class CFBamXmlLoaderBoolColHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderBoolColHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamBoolColEditObj editBoolCol = editBuff;
			ICFBamBoolColObj origBoolCol = (ICFBamBoolColObj)editBoolCol.create();
			editBoolCol = null;

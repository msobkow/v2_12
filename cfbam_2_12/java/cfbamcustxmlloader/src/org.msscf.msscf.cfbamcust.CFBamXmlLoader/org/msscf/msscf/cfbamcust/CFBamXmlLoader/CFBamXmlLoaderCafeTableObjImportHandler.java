...
/*
 *	CFBamXmlLoaderCafeTableObjImportHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeTableObjImportHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeTableObjImportHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeTableObjImport" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalJTableObjImport( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderHPlusTableMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusTableMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusTableMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusTableMembers" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalHppTableMembers( text );
		editTable.update();
		editTable = null;
	}
}

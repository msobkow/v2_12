...
/*
 *	CFBamXmlLoaderCPlusPgSqlTableImplementationHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusPgSqlTableImplementationHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusPgSqlTableImplementationHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusPgSqlTableImplementation" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCppPgSqlTableImplementation( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderHPlusPgSqlSchemObjImplHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusPgSqlSchemaObjIncludeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusPgSqlSchemaObjIncludeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusPgSqlSchemObjInclude" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalHppPgSqlSchemaObjInclude( text );

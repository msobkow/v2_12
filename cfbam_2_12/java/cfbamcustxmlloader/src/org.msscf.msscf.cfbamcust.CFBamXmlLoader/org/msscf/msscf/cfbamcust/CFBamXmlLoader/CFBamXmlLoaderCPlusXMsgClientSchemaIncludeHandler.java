...
/*
 *	CFBamXmlLoaderCPlusXMsgClientSchemaIncludeHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusXMsgClientSchemaIncludeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusXMsgClientSchemaIncludeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusXMsgClientSchemaInclude" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCppXMsgClientSchemaInclude( text );

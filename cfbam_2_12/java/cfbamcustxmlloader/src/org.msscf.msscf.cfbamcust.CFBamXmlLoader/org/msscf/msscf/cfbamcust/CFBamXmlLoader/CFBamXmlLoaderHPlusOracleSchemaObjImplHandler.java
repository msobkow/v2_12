...
/*
 *	CFBamXmlLoaderHPlusOracleSchemObjImplHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusOracleSchemaObjImplHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusOracleSchemaObjImplHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusOracleSchemObjImpl" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalHppOracleSchemaObjImpl( text );

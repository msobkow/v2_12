...
/*
 *	CFBamXmlLoaderCSharpXMsgClientTableBodyHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpXMsgClientTableBodyHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpXMsgClientTableBodyHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpXMsgClientTableBody" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCsXMsgClientTableBody( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderCafeSchemaObjImplementationHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeSchemaObjImplementationHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeSchemaObjImplementationHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeSchemaObjImplementation" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalJSchemaObjImplementation( text );

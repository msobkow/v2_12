...
/*
 *	CFBamXmlLoaderCPlusXMsgRspnSchemaXsdElementListHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusXMsgRspnSchemaXsdElementListHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusXMsgRspnSchemaXsdElementListHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusXMsgRspnSchemaXsdElementList" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCppXMsgRspnSchemaXsdElementList( text );

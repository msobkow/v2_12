...
/*
 *	CFBamXmlLoaderCPlusXMsgTableFormattersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusXMsgTableFormattersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusXMsgTableFormattersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusXMsgTableFormatters" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCppXMsgTableFormatters( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderCPlusTableObjMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusTableObjMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusTableObjMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusTableObjMembers" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCppTableObjMembers( text );
		editTable.update();
		editTable = null;
	}
}

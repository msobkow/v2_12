...
/*
 *	CFBamXmlLoaderDoubleTypeParse XML SAX Element Handler implementation
 *	for DoubleType.
 */
public class CFBamXmlLoaderDoubleTypeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderDoubleTypeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamDoubleTypeEditObj editDoubleType = editBuff;
			ICFBamDoubleTypeObj origDoubleType = (ICFBamDoubleTypeObj)editDoubleType.create();
			editDoubleType = null;

...
/*
 *	CFBamXmlLoaderCafeMySqlTableImportHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeMySqlTableImportHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeMySqlTableImportHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeMySqlTableImport" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalJMySqlTableImport( text );
		editTable.update();
		editTable = null;
	}
}

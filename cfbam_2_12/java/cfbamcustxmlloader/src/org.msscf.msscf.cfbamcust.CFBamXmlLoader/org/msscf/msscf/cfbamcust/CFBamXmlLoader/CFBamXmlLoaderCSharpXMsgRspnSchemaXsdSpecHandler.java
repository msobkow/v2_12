 ...
 */
public class CFBamXmlLoaderCSharpXMsgRspnSchemaXsdSpecHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpXMsgRspnSchemaXsdSpecHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpXMsgRspnSchemaXsdSpec" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCsXMsgRspnSchemaXsdSpec( text );

...
/*
 *	CFBamXmlLoaderHPlusTableObjIncludeHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusTableObjIncludeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusTableObjIncludeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusTableObjInclude" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalHppTableObjInclude( text );
		editTable.update();
		editTable = null;
	}
}

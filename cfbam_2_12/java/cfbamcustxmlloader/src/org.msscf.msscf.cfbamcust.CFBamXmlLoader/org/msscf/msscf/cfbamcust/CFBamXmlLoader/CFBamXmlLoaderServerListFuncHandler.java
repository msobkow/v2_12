...
/*
 *	CFBamXmlLoaderServerListFuncParse XML SAX Element Handler implementation
 *	for ServerListFunc.
 */
public class CFBamXmlLoaderServerListFuncHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderServerListFuncHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamServerListFuncObj origServerListFunc = (ICFBamServerListFuncObj)editBuff.create();
			editBuff = null;

...
/*
 *	CFBamXmlLoaderHPlusSaxLoaderStartElementHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusSaxLoaderStartElementHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusSaxLoaderStartElementHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusSaxLoaderStartElement" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalHppSaxLoaderStartElement( text );
		editTable.update();
		editTable = null;
	}
}

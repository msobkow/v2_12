...
/*
 *	CFBamXmlLoaderStringColParse XML SAX Element Handler implementation
 *	for StringCol.
 */
public class CFBamXmlLoaderStringColHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderStringColHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamStringColEditObj editStringCol = editBuff;
			ICFBamStringColObj origStringCol = (ICFBamStringColObj)editStringCol.create();
			editStringCol = null;

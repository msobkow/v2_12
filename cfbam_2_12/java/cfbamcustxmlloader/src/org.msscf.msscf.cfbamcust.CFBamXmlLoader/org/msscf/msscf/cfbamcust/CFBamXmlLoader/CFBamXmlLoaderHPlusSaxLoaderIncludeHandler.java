...
/*
 *	CFBamXmlLoaderHPlusSaxLoaderIncludeHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusSaxLoaderIncludeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusSaxLoaderIncludeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusSaxLoaderInclude" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalHppSaxLoaderInclude( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderHPlusTableObjImplementationHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusTableObjImplementationHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusTableObjImplementationHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusTableObjImplementation" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalHppTableObjImplementation( text );
		editTable.update();
		editTable = null;
	}
}

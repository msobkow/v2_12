...
/*
 *	CFBamXmlLoaderCPlusTableMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusTableMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusTableMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusTableMembers" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCppTableMembers( text );
		editTable.update();
		editTable = null;
	}
}

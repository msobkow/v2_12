...
/*
 *	CFBamXmlLoaderCPlusOracleTableIncludeHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusOracleTableIncludeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusOracleTableIncludeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusOracleTableInclude" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCppOracleTableInclude( text );
		editTable.update();
		editTable = null;
	}
}

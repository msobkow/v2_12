...
/*
 *	CFBamXmlLoaderCSharpTableUsingHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpTableUsingHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpTableUsingHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpTableUsing" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCsTableUsing( text );
		editTable.update();
		editTable = null;
	}
}

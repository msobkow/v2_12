...
/*
 *	CFBamXmlLoaderCPlusXMsgRqstSchemaIncludeHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusXMsgRqstSchemaIncludeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusXMsgRqstSchemaIncludeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusXMsgRqstSchemaInclude" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCppXMsgRqstSchemaInclude( text );

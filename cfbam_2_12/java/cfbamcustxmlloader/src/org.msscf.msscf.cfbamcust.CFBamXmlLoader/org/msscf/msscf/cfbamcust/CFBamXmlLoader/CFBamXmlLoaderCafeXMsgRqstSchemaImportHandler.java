...
/*
 *	CFBamXmlLoaderCafeXMsgRqstSchemaImportHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeXMsgRqstSchemaImportHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeXMsgRqstSchemaImportHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeXMsgRqstSchemaImport" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalJXMsgRqstSchemaImport( text );

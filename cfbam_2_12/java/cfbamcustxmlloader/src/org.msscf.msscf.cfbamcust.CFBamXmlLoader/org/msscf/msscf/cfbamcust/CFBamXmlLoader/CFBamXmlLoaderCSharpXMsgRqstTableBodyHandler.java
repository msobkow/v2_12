...
/*
 *	CFBamXmlLoaderCSharpXMsgRqstTableBodyHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpXMsgRqstTableBodyHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpXMsgRqstTableBodyHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpXMsgRqstTableBody" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCsXMsgRqstTableBody( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderCafeSchemaObjMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeSchemaObjMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeSchemaObjMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeSchemaObjMembers" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalJSchemaObjMembers( text );

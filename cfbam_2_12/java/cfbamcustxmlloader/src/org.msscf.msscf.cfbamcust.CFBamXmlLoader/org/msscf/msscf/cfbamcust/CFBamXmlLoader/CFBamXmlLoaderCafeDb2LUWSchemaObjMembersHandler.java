...
/*
 *	CFBamXmlLoaderCafeDb2LUWSchemaObjMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeDb2LUWSchemaObjMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeDb2LUWSchemaObjMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeDb2LUWSchemaObjMembers" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalJDb2LUWSchemaObjMembers( text );

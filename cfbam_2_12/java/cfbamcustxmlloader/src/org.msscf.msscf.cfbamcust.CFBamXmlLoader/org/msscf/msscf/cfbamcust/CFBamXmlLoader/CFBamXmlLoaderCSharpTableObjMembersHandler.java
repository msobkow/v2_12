...
/*
 *	CFBamXmlLoaderCSharpTableObjMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpTableObjMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpTableObjMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpTableObjMembers" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCsTableObjMembers( text );
		editTable.update();
		editTable = null;
	}
}

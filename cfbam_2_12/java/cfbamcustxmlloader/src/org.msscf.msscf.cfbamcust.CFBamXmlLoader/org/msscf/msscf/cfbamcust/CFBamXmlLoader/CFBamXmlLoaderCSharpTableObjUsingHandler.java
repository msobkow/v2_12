...
/*
 *	CFBamXmlLoaderCSharpTableObjUsingHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpTableObjUsingHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpTableObjUsingHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpTableObjUsing" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCsTableObjUsing( text );
		editTable.update();
		editTable = null;
	}
}

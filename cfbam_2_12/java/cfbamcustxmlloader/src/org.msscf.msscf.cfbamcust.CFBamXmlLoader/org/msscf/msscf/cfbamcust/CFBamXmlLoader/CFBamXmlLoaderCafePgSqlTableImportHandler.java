...
/*
 *	CFBamXmlLoaderCafePgSqlTableImportHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafePgSqlTableImportHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafePgSqlTableImportHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafePgSqlTableImport" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalJPgSqlTableImport( text );
		editTable.update();
		editTable = null;
	}
}

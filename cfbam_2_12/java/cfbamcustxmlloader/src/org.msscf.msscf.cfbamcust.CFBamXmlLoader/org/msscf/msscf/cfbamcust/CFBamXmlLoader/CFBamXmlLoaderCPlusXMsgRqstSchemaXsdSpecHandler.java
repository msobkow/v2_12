...
/*
 *	CFBamXmlLoaderCPlusXMsgRqstSchemaXsdSpecHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusXMsgRqstSchemaXsdSpecHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusXMsgRqstSchemaXsdSpecHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusXMsgRqstSchemaXsdSpec" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCppXMsgRqstSchemaXsdSpec( text );

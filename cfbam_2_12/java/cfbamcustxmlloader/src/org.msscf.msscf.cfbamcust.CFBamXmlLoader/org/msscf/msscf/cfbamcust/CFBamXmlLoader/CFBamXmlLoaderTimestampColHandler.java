...
/*
 *	CFBamXmlLoaderTimestampColParse XML SAX Element Handler implementation
 *	for TimestampCol.
 */
public class CFBamXmlLoaderTimestampColHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderTimestampColHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamTimestampColEditObj editTimestampCol = editBuff;
			ICFBamTimestampColObj origTimestampCol = (ICFBamTimestampColObj)editTimestampCol.create();

...
/*
 *	CFBamXmlLoaderCafePgSqlSchemObjImplHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafePgSqlSchemaObjImportHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafePgSqlSchemaObjImportHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafePgSqlSchemObjImport" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalJPgSqlSchemaObjImport( text );

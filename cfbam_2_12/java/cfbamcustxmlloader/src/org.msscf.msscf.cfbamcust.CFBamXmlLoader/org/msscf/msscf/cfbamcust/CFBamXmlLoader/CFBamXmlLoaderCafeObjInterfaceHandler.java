...
/*
 *	CFBamXmlLoaderCafeObjInterfaceHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeObjInterfaceHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeObjInterfaceHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeObjInterface" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalJObjInterface( text );
		editTable.update();
		editTable = null;
	}
}

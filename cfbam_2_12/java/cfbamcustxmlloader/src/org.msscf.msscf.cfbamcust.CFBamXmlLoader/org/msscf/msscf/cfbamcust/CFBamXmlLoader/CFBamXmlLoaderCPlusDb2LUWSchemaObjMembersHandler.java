...
/*
 *	CFBamXmlLoaderCPlusDb2LUWSchemaObjMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusDb2LUWSchemaObjMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusDb2LUWSchemaObjMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusDb2LUWSchemaObjMembers" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCppDb2LUWSchemaObjMembers( text );

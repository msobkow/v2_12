...
/*
 *	CFBamXmlLoaderTextColParse XML SAX Element Handler implementation
 *	for TextCol.
 */
public class CFBamXmlLoaderTextColHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderTextColHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamTextColEditObj editTextCol = editBuff;
			ICFBamTextColObj origTextCol = (ICFBamTextColObj)editTextCol.create();
			editTextCol = null;

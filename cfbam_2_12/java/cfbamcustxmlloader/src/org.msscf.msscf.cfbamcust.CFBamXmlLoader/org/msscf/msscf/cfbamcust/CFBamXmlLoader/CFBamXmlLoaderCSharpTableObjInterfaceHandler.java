...
/*
 *	CFBamXmlLoaderCSharpTableObjInterfaceHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpTableObjInterfaceHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpTableObjInterfaceHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpTableObjInterface" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCsTableObjInterface( text );
		editTable.update();
		editTable = null;
	}
}

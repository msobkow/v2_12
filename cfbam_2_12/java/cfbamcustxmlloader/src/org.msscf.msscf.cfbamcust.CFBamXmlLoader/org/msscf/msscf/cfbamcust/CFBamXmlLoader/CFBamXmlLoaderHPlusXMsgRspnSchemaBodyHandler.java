...
/*
 *	CFBamXmlLoaderHPlusXMsgRspnSchemaBodyHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusXMsgRspnSchemaBodyHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusXMsgRspnSchemaBodyHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusXMsgRspnSchemaBody" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalHppXMsgRspnSchemaBody( text );

...
/*
 *	CFBamXmlLoaderCSharpXMsgRspnSchemaXsdElementListHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpXMsgRspnSchemaXsdElementListHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpXMsgRspnSchemaXsdElementListHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpXMsgRspnSchemaXsdElementList" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCsXMsgRspnSchemaXsdElementList( text );

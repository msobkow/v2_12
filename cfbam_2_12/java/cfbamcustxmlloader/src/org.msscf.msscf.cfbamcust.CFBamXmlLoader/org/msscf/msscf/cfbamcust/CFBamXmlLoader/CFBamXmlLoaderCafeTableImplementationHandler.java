...
/*
 *	CFBamXmlLoaderCafeTableImplementationHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeTableImplementationHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeTableImplementationHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeTableImplementation" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalJTableImplementation( text );
		editTable.update();
		editTable = null;
	}
}

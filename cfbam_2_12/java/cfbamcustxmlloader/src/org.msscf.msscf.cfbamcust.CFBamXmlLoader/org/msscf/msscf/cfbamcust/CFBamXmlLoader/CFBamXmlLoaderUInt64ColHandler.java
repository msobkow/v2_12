...
/*
 *	CFBamXmlLoaderUInt64ColParse XML SAX Element Handler implementation
 *	for UInt64Col.
 */
public class CFBamXmlLoaderUInt64ColHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderUInt64ColHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamUInt64ColEditObj editUInt64Col = editBuff;
			ICFBamUInt64ColObj origUInt64Col = (ICFBamUInt64ColObj)editUInt64Col.create();
			editUInt64Col = null;

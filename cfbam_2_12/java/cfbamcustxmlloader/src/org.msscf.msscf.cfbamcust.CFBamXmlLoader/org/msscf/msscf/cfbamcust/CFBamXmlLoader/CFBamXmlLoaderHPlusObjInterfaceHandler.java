...
/*
 *	CFBamXmlLoaderHPlusObjInterfaceHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusObjInterfaceHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusObjInterfaceHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusObjInterface" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalHppObjInterface( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderHPlusRamTableMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusRamTableMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusRamTableMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusRamTableMembers" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalHppRamTableMembers( text );
		editTable.update();
		editTable = null;
	}
}

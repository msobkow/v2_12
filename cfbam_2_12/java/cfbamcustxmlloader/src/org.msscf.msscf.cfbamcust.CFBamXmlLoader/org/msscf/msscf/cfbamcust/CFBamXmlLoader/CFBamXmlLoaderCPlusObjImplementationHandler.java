...
/*
 *	CFBamXmlLoaderCPlusObjImplementationHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusObjImplementationHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusObjImplementationHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusObjImplementation" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCppObjImplementation( text );
		editTable.update();
		editTable = null;
	}
}

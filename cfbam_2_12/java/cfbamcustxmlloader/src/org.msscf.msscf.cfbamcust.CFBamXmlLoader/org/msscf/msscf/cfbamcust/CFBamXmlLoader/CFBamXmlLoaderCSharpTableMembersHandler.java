...
/*
 *	CFBamXmlLoaderCSharpTableMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpTableMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpTableMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpTableMembers" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCsTableMembers( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderCSharpObjMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpObjMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpObjMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpObjMembers" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCsObjMembers( text );
		editTable.update();
		editTable = null;
	}
}

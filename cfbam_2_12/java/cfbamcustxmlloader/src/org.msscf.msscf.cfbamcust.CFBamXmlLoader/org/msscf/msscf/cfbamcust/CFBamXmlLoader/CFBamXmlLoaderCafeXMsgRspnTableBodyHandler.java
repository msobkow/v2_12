...
/*
 *	CFBamXmlLoaderCafeXMsgRspnTableBodyHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeXMsgRspnTableBodyHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeXMsgRspnTableBodyHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeXMsgRspnTableBody" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalJXMsgRspnTableBody( text );
		editTable.update();
		editTable = null;
	}
}

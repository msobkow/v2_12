...
/*
 *	CFBamXmlLoaderCPlusMSSqlSchemaObjImplHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusMSSqlSchemaObjImplHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusMSSqlSchemaObjImplHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusMSSqlSchemaObjImpl" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCppMSSqlSchemaObjImpl( text );

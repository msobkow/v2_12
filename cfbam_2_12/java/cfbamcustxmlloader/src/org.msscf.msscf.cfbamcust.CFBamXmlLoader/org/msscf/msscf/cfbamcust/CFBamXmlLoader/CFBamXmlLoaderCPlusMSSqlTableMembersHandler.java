...
/*
 *	CFBamXmlLoaderCPlusMSSqlTableMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusMSSqlTableMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusMSSqlTableMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusMSSqlTableMembers" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCppMSSqlTableMembers( text );
		editTable.update();
		editTable = null;
	}
}

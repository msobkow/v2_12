...
/*
 *	CFBamXmlLoaderCafeRamSchemaObjImplHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeRamSchemaObjImplHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeRamSchemaObjImplHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeRamSchemaObjImpl" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalJRamSchemaObjImpl( text );

...
/*
 *	CFBamXmlLoaderFloatColParse XML SAX Element Handler implementation
 *	for FloatCol.
 */
public class CFBamXmlLoaderFloatColHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderFloatColHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamFloatColEditObj editFloatCol = editBuff;
			ICFBamFloatColObj origFloatCol = (ICFBamFloatColObj)editFloatCol.create();
			editFloatCol = null;

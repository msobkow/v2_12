...
/*
 *	CFBamXmlLoaderCSharpOracleSchemObjMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpOracleSchemaObjMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpOracleSchemaObjMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpOracleSchemObjMembers" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCsOracleSchemaObjMembers( text );

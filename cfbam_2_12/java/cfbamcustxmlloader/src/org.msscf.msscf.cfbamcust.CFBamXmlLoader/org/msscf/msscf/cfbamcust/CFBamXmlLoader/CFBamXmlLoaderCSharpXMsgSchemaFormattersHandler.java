...
/*
 *	CFBamXmlLoaderCSharpXMsgSchemaFormattersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpXMsgSchemaFormattersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpXMsgSchemaFormattersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpXMsgSchemaFormatters" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCsXMsgSchemaFormatters( text );

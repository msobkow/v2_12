...
/*
 *	CFBamXmlLoaderTimeTypeParse XML SAX Element Handler implementation
 *	for TimeType.
 */
public class CFBamXmlLoaderTimeTypeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderTimeTypeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamTimeTypeEditObj editTimeType = editBuff;
			ICFBamTimeTypeObj origTimeType = (ICFBamTimeTypeObj)editTimeType.create();
			editTimeType = null;

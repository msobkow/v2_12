...
/*
 *	CFBamXmlLoaderCSharpRamSchemaObjImplHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpRamSchemaObjImplHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpRamSchemaObjImplHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpRamSchemaObjImpl" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCsRamSchemaObjImpl( text );

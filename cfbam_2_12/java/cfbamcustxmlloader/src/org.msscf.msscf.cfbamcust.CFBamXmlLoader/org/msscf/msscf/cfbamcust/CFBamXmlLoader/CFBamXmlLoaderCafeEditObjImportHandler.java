...
/*
 *	CFBamXmlLoaderCafeEditObjImportHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeEditObjImportHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeEditObjImportHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeEditObjImport" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalJEditObjImport( text );
		editTable.update();
		editTable = null;
	}
}

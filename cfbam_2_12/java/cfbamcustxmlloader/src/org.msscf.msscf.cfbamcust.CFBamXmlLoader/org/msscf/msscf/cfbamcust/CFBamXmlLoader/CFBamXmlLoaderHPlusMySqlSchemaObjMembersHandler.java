...
/*
 *	CFBamXmlLoaderHPlusMySqlSchemObjMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusMySqlSchemaObjMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusMySqlSchemaObjMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusMySqlSchemObjMembers" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalHppMySqlSchemaObjMembers( text );

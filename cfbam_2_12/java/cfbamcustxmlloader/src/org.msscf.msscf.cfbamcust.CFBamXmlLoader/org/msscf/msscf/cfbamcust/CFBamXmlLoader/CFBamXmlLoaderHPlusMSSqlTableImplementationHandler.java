...
/*
 *	CFBamXmlLoaderHPlusMSSqlTableImplementationHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusMSSqlTableImplementationHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusMSSqlTableImplementationHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusMSSqlTableImplementation" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalHppMSSqlTableImplementation( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderCPlusEditObjMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusEditObjMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusEditObjMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusEditObjMembers" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCppEditObjMembers( text );
		editTable.update();
		editTable = null;
	}
}

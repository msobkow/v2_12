 ...
 *	for TableCol.
 */
public class CFBamXmlLoaderTableColHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderTableColHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamTableColEditObj editTableCol = editBuff;
			ICFBamTableColObj origTableCol = (ICFBamTableColObj)editTableCol.create();
			editTableCol = null;

...
/*
 *	CFBamXmlLoaderCafePgSqlSchemaObjMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafePgSqlSchemaObjMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafePgSqlSchemaObjMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafePgSqlSchemaObjMembers" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalJPgSqlSchemaObjMembers( text );

...
/*
 *	CFBamXmlLoaderCSharpEditObjUsingHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpEditObjUsingHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpEditObjUsingHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpEditObjUsing" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCsEditObjUsing( text );
		editTable.update();
		editTable = null;
	}
}

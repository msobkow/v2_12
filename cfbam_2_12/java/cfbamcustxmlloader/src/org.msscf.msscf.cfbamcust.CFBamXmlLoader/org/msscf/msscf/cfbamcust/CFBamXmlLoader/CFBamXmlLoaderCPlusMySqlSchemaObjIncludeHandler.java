...
/*
 *	CFBamXmlLoaderCPlusMySqlSchemaObjIncludeHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusMySqlSchemaObjIncludeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusMySqlSchemaObjIncludeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusMySqlSchemObjInclude" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCppMySqlSchemaObjInclude( text );

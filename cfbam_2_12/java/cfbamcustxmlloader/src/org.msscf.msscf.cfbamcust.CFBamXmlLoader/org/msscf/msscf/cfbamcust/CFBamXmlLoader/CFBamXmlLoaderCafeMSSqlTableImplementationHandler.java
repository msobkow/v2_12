...
/*
 *	CFBamXmlLoaderCafeMSSqlTableImplementationHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeMSSqlTableImplementationHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeMSSqlTableImplementationHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeMSSqlTableImplementation" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalJMSSqlTableImplementation( text );
		editTable.update();
		editTable = null;
	}
}

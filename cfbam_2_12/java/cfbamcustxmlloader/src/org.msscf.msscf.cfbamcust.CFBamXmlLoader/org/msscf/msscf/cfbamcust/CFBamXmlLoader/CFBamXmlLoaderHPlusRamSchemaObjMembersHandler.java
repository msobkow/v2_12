...
/*
 *	CFBamXmlLoaderHPlusRamSchemaObjMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusRamSchemaObjMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusRamSchemaObjMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusRamSchemaObjMembers" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalHppRamSchemaObjMembers( text );

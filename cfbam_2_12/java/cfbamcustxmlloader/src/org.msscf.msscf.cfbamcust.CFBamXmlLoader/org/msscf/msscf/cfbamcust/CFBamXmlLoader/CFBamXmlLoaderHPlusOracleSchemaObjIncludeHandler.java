...
/*
 *	CFBamXmlLoaderHPlusOracleSchemaObjIncludeHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusOracleSchemaObjIncludeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusOracleSchemaObjIncludeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusOracleSchemObjInclude" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalHppOracleSchemaObjInclude( text );

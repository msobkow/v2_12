...
/*
 *	CFBamXmlLoaderHPlusMSSqlSchemaObjMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusMSSqlSchemaObjMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusMSSqlSchemaObjMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusMSSqlSchemaObjMembers" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalHppMSSqlSchemaObjMembers( text );

...
/*
 *	CFBamXmlLoaderStringTypeParse XML SAX Element Handler implementation
 *	for StringType.
 */
public class CFBamXmlLoaderStringTypeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderStringTypeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamStringTypeEditObj editStringType = editBuff;
			ICFBamStringTypeObj origStringType = (ICFBamStringTypeObj)editStringType.create();
			editStringType = null;

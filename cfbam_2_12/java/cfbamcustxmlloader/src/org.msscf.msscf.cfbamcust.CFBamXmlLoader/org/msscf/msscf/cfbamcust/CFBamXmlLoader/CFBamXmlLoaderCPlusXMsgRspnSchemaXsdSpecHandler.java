 ...
 */
public class CFBamXmlLoaderCPlusXMsgRspnSchemaXsdSpecHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusXMsgRspnSchemaXsdSpecHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusXMsgRspnSchemaXsdSpec" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCppXMsgRspnSchemaXsdSpec( text );

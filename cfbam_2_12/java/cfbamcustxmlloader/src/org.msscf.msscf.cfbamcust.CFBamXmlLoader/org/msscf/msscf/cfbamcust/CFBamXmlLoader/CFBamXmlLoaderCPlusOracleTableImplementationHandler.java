...
/*
 *	CFBamXmlLoaderCPlusOracleTableImplementationHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusOracleTableImplementationHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusOracleTableImplementationHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusOracleTableImplementation" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCppOracleTableImplementation( text );
		editTable.update();
		editTable = null;
	}
}

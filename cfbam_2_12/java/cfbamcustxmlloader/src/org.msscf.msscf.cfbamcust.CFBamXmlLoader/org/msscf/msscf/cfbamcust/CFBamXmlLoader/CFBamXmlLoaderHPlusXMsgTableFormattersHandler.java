...
/*
 *	CFBamXmlLoaderHPlusXMsgTableFormattersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusXMsgTableFormattersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusXMsgTableFormattersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusXMsgTableFormatters" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalHppXMsgTableFormatters( text );
		editTable.update();
		editTable = null;
	}
}

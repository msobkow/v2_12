...
/*
 *	CFBamXmlLoaderCPlusRamTableImplementationHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusRamTableImplementationHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusRamTableImplementationHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusRamTableImplementation" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCppRamTableImplementation( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderUInt16TypeParse XML SAX Element Handler implementation
 *	for UInt16Type.
 */
public class CFBamXmlLoaderUInt16TypeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderUInt16TypeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamUInt16TypeEditObj editUInt16Type = editBuff;
			ICFBamUInt16TypeObj origUInt16Type = (ICFBamUInt16TypeObj)editUInt16Type.create();
			editUInt16Type = null;

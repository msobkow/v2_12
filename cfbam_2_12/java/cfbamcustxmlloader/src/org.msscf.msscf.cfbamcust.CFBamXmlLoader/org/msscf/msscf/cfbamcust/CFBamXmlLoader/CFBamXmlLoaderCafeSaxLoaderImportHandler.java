...
/*
 *	CFBamXmlLoaderCafeSaxLoaderImportHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeSaxLoaderImportHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeSaxLoaderImportHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeSaxLoaderImport" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalJSaxLoaderImport( text );
		editTable.update();
		editTable = null;
	}
}

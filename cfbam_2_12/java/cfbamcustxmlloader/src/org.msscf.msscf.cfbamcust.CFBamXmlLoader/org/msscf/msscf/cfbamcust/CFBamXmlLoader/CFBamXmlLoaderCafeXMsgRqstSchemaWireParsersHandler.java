...
/*
 *	CFBamXmlLoaderCafeXMsgRqstSchemaWireParsersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeXMsgRqstSchemaWireParsersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeXMsgRqstSchemaWireParsersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeXMsgRqstSchemaWireParsers" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalJXMsgRqstSchemaWireParsers( text );

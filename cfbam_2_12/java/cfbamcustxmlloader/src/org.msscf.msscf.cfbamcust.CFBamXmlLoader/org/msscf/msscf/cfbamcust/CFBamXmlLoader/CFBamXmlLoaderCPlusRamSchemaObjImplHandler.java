...
/*
 *	CFBamXmlLoaderCPlusRamSchemaObjImplHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusRamSchemaObjImplHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusRamSchemaObjImplHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusRamSchemaObjImpl" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCppRamSchemaObjImpl( text );

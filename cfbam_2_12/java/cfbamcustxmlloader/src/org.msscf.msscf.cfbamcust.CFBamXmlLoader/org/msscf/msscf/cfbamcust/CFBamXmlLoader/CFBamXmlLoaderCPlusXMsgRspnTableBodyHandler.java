...
/*
 *	CFBamXmlLoaderCPlusXMsgRspnTableBodyHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusXMsgRspnTableBodyHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusXMsgRspnTableBodyHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusXMsgRspnTableBody" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCppXMsgRspnTableBody( text );
		editTable.update();
		editTable = null;
	}
}

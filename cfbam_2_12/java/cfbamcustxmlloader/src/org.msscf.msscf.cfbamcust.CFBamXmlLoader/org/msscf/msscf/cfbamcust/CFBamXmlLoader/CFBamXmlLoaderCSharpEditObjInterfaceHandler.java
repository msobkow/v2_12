...
/*
 *	CFBamXmlLoaderCSharpEditObjInterfaceHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpEditObjInterfaceHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpEditObjInterfaceHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpEditObjInterface" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCsEditObjInterface( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderCSharpOracleSchemObjImplHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpOracleSchemaObjImplHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpOracleSchemaObjImplHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpOracleSchemObjImpl" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCsOracleSchemaObjImpl( text );

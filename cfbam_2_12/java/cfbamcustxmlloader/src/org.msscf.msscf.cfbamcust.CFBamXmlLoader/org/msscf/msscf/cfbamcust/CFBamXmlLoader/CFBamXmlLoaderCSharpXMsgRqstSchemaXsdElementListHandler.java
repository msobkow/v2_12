...
/*
 *	CFBamXmlLoaderCSharpXMsgRqstSchemaXsdElementListHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpXMsgRqstSchemaXsdElementListHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpXMsgRqstSchemaXsdElementListHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpXMsgRqstSchemaXsdElementList" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCsXMsgRqstSchemaXsdElementList( text );

...
/*
 *	CFBamXmlLoaderCPlusMySqlSchemaObjImplHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusMySqlSchemaObjImplHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusMySqlSchemaObjImplHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusMySqlSchemaObjImpl" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCppMySqlSchemaObjImpl( text );

...
/*
 *	CFBamXmlLoaderCafeOracleSchemObjMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeOracleSchemaObjMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeOracleSchemaObjMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeOracleSchemObjMembers" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalJOracleSchemaObjMembers( text );

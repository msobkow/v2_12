...
/*
 *	CFBamXmlLoaderUuidColParse XML SAX Element Handler implementation
 *	for UuidCol.
 */
public class CFBamXmlLoaderUuidColHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderUuidColHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamUuidColEditObj editUuidCol = editBuff;
			ICFBamUuidColObj origUuidCol = (ICFBamUuidColObj)editUuidCol.create();
			editUuidCol = null;

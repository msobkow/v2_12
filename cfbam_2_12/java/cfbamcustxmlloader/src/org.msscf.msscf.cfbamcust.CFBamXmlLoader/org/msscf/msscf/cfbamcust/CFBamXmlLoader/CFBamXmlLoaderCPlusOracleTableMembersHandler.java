...
/*
 *	CFBamXmlLoaderCPlusOracleTableMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusOracleTableMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusOracleTableMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusOracleTableMembers" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCppOracleTableMembers( text );
		editTable.update();
		editTable = null;
	}
}

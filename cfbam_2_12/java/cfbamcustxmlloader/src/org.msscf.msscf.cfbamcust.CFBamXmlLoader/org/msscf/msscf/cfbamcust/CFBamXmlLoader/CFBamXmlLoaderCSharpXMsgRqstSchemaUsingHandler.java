...
/*
 *	CFBamXmlLoaderCSharpXMsgRqstSchemaUsingHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpXMsgRqstSchemaUsingHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpXMsgRqstSchemaUsingHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpXMsgRqstSchemaUsing" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCsXMsgRqstSchemaUsing( text );

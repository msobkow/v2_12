...
/*
 *	CFBamXmlLoaderCafeTableObjInterfaceHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeTableObjInterfaceHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeTableObjInterfaceHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeTableObjInterface" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalJTableObjInterface( text );
		editTable.update();
		editTable = null;
	}
}

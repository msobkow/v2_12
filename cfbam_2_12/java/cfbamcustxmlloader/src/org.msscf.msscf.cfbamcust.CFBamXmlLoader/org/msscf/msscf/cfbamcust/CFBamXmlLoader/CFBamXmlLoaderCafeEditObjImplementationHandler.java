...
/*
 *	CFBamXmlLoaderCafeEditObjImplementationHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeEditObjImplementationHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeEditObjImplementationHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeEditObjImplementation" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalJEditObjImplementation( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderCSharpSaxLoaderEndElementHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpSaxLoaderEndElementHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpSaxLoaderEndElementHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpSaxLoaderEndElement" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCsSaxLoaderEndElement( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderCPlusXMsgRspnSchemaBodyHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusXMsgRspnSchemaBodyHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusXMsgRspnSchemaBodyHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusXMsgRspnSchemaBody" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCppXMsgRspnSchemaBody( text );

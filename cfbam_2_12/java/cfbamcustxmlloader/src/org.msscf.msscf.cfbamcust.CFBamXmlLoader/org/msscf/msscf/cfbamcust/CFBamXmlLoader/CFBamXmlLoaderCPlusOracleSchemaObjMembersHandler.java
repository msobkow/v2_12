...
/*
 *	CFBamXmlLoaderCPlusOracleSchemObjMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusOracleSchemaObjMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusOracleSchemaObjMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusOracleSchemObjMembers" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCppOracleSchemaObjMembers( text );

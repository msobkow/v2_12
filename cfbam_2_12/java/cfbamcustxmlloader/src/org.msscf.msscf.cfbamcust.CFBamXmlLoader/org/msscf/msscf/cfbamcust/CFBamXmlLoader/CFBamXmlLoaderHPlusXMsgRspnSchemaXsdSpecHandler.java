 ...
 */
public class CFBamXmlLoaderHPlusXMsgRspnSchemaXsdSpecHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusXMsgRspnSchemaXsdSpecHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusXMsgRspnSchemaXsdSpec" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalHppXMsgRspnSchemaXsdSpec( text );

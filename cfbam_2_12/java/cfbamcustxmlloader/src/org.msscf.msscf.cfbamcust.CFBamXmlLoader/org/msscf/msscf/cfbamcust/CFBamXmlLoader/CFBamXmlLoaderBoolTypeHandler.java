...
/*
 *	CFBamXmlLoaderBoolTypeParse XML SAX Element Handler implementation
 *	for BoolType.
 */
public class CFBamXmlLoaderBoolTypeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderBoolTypeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamBoolTypeEditObj editBoolType = editBuff;
			ICFBamBoolTypeObj origBoolType;

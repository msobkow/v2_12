...
/*
 *	CFBamXmlLoaderEnumTypeParse XML SAX Element Handler implementation
 *	for EnumType.
 */
public class CFBamXmlLoaderEnumTypeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderEnumTypeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamEnumTypeEditObj editEnumType = editBuff;
			ICFBamEnumTypeObj origEnumType = (ICFBamEnumTypeObj)editEnumType.create();
			editEnumType = null;

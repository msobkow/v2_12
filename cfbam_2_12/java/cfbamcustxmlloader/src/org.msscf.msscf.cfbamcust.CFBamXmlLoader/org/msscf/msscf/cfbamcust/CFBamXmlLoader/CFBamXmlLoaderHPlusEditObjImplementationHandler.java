...
/*
 *	CFBamXmlLoaderHPlusEditObjImplementationHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusEditObjImplementationHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusEditObjImplementationHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusEditObjImplementation" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalHppEditObjImplementation( text );
		editTable.update();
		editTable = null;
	}
}

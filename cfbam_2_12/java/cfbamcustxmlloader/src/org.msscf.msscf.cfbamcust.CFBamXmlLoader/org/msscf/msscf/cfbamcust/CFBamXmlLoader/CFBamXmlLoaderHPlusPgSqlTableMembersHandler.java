...
/*
 *	CFBamXmlLoaderHPlusPgSqlTableMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusPgSqlTableMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusPgSqlTableMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusPgSqlTableMembers" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalHppPgSqlTableMembers( text );
		editTable.update();
		editTable = null;
	}
}

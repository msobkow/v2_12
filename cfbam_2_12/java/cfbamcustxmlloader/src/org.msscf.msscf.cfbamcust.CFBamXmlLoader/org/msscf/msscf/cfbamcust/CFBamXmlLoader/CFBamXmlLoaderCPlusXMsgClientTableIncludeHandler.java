...
/*
 *	CFBamXmlLoaderCPlusXMsgClientTableIncludeHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusXMsgClientTableIncludeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusXMsgClientTableIncludeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusXMsgClientTableInclude" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCppXMsgClientTableInclude( text );
		editTable.update();
		editTable = null;
	}
}

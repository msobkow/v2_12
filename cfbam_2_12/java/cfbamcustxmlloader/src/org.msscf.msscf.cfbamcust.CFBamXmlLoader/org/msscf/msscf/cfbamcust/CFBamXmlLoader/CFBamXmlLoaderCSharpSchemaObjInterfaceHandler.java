...
/*
 *	CFBamXmlLoaderCSharpSchemaObjInterfaceHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpSchemaObjInterfaceHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpSchemaObjInterfaceHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpSchemaObjInterface" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCsSchemaObjInterface( text );

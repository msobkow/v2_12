 ...
 */
public class CFBamXmlLoaderCSharpSchemaObjUsingHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpSchemaObjUsingHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCsSchemaObjUsing( text );

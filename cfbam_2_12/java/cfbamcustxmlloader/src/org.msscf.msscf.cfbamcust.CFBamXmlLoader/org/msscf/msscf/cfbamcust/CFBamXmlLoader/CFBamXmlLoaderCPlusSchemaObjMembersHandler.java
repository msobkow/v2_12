...
/*
 *	CFBamXmlLoaderCPlusSchemaObjMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusSchemaObjMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusSchemaObjMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusSchemaObjMembers" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCppSchemaObjMembers( text );

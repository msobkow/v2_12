...
/*
 *	CFBamXmlLoaderCPlusTableObjImplementationHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusTableObjImplementationHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusTableObjImplementationHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusTableObjImplementation" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCppTableObjImplementation( text );
		editTable.update();
		editTable = null;
	}
}

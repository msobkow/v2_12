...
/*
 *	CFBamXmlLoaderCPlusXMsgRspnSchemaIncludeHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusXMsgRspnSchemaIncludeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusXMsgRspnSchemaIncludeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusXMsgRspnSchemaInclude" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCppXMsgRspnSchemaInclude( text );

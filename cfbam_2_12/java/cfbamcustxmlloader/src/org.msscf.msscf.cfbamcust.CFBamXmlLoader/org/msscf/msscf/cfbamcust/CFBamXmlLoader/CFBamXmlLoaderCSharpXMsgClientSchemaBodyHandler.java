...
/*
 *	CFBamXmlLoaderCSharpXMsgClientSchemaBodyHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpXMsgClientSchemaBodyHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpXMsgClientSchemaBodyHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpXMsgClientSchemaBody" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCsXMsgClientSchemaBody( text );

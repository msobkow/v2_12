...
/*
 *	CFBamXmlLoaderCSharpMySqlSchemaObjImplHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpMySqlSchemaObjImplHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpMySqlSchemaObjImplHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpMySqlSchemaObjImpl" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCsMySqlSchemaObjImpl( text );

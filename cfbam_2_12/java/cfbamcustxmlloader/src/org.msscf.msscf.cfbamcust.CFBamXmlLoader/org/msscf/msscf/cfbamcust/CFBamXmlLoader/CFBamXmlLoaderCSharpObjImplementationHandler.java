...
/*
 *	CFBamXmlLoaderCSharpObjImplementationHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpObjImplementationHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpObjImplementationHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpObjImplementation" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCsObjImplementation( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderCafeXMsgRqstTableImportHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeXMsgRqstTableImportHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeXMsgRqstTableImportHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeXMsgRqstTableImport" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalJXMsgRqstTableImport( text );
		editTable.update();
		editTable = null;
	}
}

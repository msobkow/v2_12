...
/*
 *	CFBamXmlLoaderCSharpMySqlSchemaObjUsingHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpMySqlSchemaObjUsingHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpMySqlSchemaObjUsingHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpMySqlSchemObjUsing" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCsMySqlSchemaObjUsing( text );

...
/*
 *	CFBamXmlLoaderCafeObjImportHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeObjImportHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeObjImportHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeObjImport" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalJObjImport( text );
		editTable.update();
		editTable = null;
	}
}

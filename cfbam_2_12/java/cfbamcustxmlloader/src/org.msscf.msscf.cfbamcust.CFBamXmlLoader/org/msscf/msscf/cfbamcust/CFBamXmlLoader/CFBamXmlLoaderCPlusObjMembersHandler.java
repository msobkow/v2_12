...
/*
 *	CFBamXmlLoaderCPlusObjMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusObjMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusObjMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusObjMembers" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCppObjMembers( text );
		editTable.update();
		editTable = null;
	}
}

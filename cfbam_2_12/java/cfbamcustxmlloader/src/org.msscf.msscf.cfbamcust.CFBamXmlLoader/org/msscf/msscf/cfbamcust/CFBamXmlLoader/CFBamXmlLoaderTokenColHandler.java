...
/*
 *	CFBamXmlLoaderTokenColParse XML SAX Element Handler implementation
 *	for TokenCol.
 */
public class CFBamXmlLoaderTokenColHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderTokenColHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamTokenColEditObj editTokenCol = editBuff;
			ICFBamTokenColObj origTokenCol = (ICFBamTokenColObj)editTokenCol.create();
			editTokenCol = null;

...
/*
 *	CFBamXmlLoaderHPlusMySqlSchemaObjImplHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusMySqlSchemaObjImplHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusMySqlSchemaObjImplHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusMySqlSchemaObjImpl" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalHppMySqlSchemaObjImpl( text );

...
/*
 *	CFBamXmlLoaderCPlusSchemaObjImplementationHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusSchemaObjImplementationHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusSchemaObjImplementationHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusSchemaObjImplementation" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCppSchemaObjImplementation( text );

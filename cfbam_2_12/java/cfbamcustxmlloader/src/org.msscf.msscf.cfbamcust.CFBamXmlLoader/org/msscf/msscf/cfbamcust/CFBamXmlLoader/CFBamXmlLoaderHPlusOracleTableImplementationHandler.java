...
/*
 *	CFBamXmlLoaderHPlusOracleTableImplementationHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusOracleTableImplementationHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusOracleTableImplementationHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusOracleTableImplementation" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalHppOracleTableImplementation( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderHPlusTableObjInterfaceHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusTableObjInterfaceHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusTableObjInterfaceHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusTableObjInterface" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalHppTableObjInterface( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderCafeOracleTableImportHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeOracleTableImportHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeOracleTableImportHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeOracleTableImport" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalJOracleTableImport( text );
		editTable.update();
		editTable = null;
	}
}

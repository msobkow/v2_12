...
/*
 *	CFBamXmlLoaderHPlusObjIncludeHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusObjIncludeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusObjIncludeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusObjInclude" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalHppObjInclude( text );
		editTable.update();
		editTable = null;
	}
}

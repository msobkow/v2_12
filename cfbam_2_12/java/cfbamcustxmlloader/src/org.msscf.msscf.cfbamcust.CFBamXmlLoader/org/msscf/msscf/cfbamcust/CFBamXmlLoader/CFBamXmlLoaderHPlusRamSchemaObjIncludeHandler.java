...
/*
 *	CFBamXmlLoaderHPlusRamSchemObjImplHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusRamSchemaObjIncludeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusRamSchemaObjIncludeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusRamSchemObjInclude" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalHppRamSchemaObjInclude( text );

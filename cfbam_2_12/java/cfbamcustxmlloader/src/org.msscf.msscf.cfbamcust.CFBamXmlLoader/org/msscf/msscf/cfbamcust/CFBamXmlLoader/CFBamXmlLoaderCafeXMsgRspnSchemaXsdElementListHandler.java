...
/*
 *	CFBamXmlLoaderCafeXMsgRspnSchemaXsdElementListHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeXMsgRspnSchemaXsdElementListHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeXMsgRspnSchemaXsdElementListHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeXMsgRspnSchemaXsdElementList" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalJXMsgRspnSchemaXsdElementList( text );

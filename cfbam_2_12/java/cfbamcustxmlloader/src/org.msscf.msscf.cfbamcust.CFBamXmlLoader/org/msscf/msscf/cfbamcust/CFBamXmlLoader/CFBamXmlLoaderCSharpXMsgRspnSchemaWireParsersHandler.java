...
/*
 *	CFBamXmlLoaderCSharpXMsgRspnSchemaWireParsersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpXMsgRspnSchemaWireParsersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpXMsgRspnSchemaWireParsersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpXMsgRspnSchemaWireParsers" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCsXMsgRspnSchemaWireParsers( text );

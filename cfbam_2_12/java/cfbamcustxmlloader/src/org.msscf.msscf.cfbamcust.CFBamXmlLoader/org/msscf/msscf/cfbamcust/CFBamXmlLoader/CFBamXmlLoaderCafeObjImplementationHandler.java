...
/*
 *	CFBamXmlLoaderCafeObjImplementationHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeObjImplementationHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeObjImplementationHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeObjImplementation" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalJObjImplementation( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderHPlusTableImplementationHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusTableImplementationHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusTableImplementationHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusTableImplementation" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalHppTableImplementation( text );
		editTable.update();
		editTable = null;
	}
}

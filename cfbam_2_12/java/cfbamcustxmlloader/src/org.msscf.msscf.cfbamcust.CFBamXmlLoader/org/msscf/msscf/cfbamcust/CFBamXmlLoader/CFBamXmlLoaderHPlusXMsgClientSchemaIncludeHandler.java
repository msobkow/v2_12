...
/*
 *	CFBamXmlLoaderHPlusXMsgClientSchemaIncludeHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusXMsgClientSchemaIncludeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusXMsgClientSchemaIncludeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusXMsgClientSchemaInclude" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalHppXMsgClientSchemaInclude( text );

...
/*
 *	CFBamXmlLoaderCafeOracleSchemObjImplHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeOracleSchemaObjImplHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeOracleSchemaObjImplHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeOracleSchemObjImpl" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalJOracleSchemaObjImpl( text );

...
/*
 *	CFBamXmlLoaderCafeXMsgRspnSchemaBodyHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeXMsgRspnSchemaBodyHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeXMsgRspnSchemaBodyHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeXMsgRspnSchemaBody" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalJXMsgRspnSchemaBody( text );

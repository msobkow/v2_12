...
/*
 *	CFBamXmlLoaderHPlusXMsgRqstTableBodyHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusXMsgRqstTableBodyHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusXMsgRqstTableBodyHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusXMsgRqstTableBody" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalHppXMsgRqstTableBody( text );
		editTable.update();
		editTable = null;
	}
}

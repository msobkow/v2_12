...
/*
 *	CFBamXmlLoaderHPlusObjImplementationHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusObjImplementationHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusObjImplementationHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusObjImplementation" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalHppObjImplementation( text );
		editTable.update();
		editTable = null;
	}
}

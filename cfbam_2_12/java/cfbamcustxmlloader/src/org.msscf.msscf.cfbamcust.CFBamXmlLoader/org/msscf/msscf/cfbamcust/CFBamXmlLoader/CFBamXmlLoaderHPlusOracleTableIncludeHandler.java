...
/*
 *	CFBamXmlLoaderHPlusOracleTableIncludeHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusOracleTableIncludeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusOracleTableIncludeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusOracleTableInclude" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalHppOracleTableInclude( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderHPlusRamTableImplementationHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusRamTableImplementationHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusRamTableImplementationHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusRamTableImplementation" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalHppRamTableImplementation( text );
		editTable.update();
		editTable = null;
	}
}

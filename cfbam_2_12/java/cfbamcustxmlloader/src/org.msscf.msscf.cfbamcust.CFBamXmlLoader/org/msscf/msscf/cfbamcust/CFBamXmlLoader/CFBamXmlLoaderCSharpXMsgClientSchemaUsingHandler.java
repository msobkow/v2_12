...
/*
 *	CFBamXmlLoaderCSharpXMsgClientSchemaUsingHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpXMsgClientSchemaUsingHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpXMsgClientSchemaUsingHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpXMsgClientSchemaUsing" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCsXMsgClientSchemaUsing( text );

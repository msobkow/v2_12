...
/*
 *	CFBamXmlLoaderHPlusXMsgRqstSchemaIncludeHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusXMsgRqstSchemaIncludeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusXMsgRqstSchemaIncludeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusXMsgRqstSchemaInclude" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalHppXMsgRqstSchemaInclude( text );

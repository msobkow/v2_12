...
/*
 *	CFBamXmlLoaderTZDateColParse XML SAX Element Handler implementation
 *	for TZDateCol.
 */
public class CFBamXmlLoaderTZDateColHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderTZDateColHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamTZDateColEditObj editTZDateCol = editBuff;
			ICFBamTZDateColObj origTZDateCol = (ICFBamTZDateColObj)editTZDateCol.create();
			editTZDateCol = null;

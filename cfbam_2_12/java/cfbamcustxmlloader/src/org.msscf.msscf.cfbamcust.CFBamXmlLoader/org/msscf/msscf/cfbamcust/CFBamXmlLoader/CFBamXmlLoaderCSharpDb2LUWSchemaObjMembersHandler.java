...
/*
 *	CFBamXmlLoaderCSharpDb2LUWSchemaObjMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpDb2LUWSchemaObjMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpDb2LUWSchemaObjMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpDb2LUWSchemaObjMembers" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCsDb2LUWSchemaObjMembers( text );

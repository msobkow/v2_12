...
/*
 *	CFBamXmlLoaderHPlusXMsgRspnTableBodyHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusXMsgRspnTableBodyHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusXMsgRspnTableBodyHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusXMsgRspnTableBody" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalHppXMsgRspnTableBody( text );
		editTable.update();
		editTable = null;
	}
}

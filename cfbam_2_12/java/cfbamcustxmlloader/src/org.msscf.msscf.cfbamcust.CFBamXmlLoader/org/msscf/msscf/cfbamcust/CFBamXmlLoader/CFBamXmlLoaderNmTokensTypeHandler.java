...
/*
 *	CFBamXmlLoaderNmTokensTypeParse XML SAX Element Handler implementation
 *	for NmTokensType.
 */
public class CFBamXmlLoaderNmTokensTypeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderNmTokensTypeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamNmTokensTypeEditObj editNmTokensType = editBuff;
			ICFBamNmTokensTypeObj origNmTokensType = (ICFBamNmTokensTypeObj)editNmTokensType.create();

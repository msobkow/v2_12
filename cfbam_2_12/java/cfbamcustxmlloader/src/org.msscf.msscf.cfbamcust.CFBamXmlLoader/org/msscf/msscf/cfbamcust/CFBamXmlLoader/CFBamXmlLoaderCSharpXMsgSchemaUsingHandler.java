...
/*
 *	CFBamXmlLoaderCSharpXMsgSchemaUsingHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpXMsgSchemaUsingHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpXMsgSchemaUsingHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpXMsgSchemaUsing" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCsXMsgSchemaUsing( text );

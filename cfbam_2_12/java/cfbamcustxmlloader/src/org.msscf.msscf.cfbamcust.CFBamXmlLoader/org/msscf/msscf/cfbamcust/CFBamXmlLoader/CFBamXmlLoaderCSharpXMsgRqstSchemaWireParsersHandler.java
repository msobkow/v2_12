...
/*
 *	CFBamXmlLoaderCSharpXMsgRqstSchemaWireParsersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpXMsgRqstSchemaWireParsersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpXMsgRqstSchemaWireParsersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpXMsgRqstSchemaWireParsers" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCsXMsgRqstSchemaWireParsers( text );

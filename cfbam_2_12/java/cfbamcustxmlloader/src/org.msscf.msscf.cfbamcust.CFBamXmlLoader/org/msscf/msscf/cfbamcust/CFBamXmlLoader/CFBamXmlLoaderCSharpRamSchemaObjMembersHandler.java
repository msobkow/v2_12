...
/*
 *	CFBamXmlLoaderCSharpRamSchemaObjMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpRamSchemaObjMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpRamSchemaObjMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpRamSchemaObjMembers" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCsRamSchemaObjMembers( text );

...
/*
 *	CFBamXmlLoaderCPlusTableObjInterfaceHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusTableObjInterfaceHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusTableObjInterfaceHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusTableObjInterface" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCppTableObjInterface( text );
		editTable.update();
		editTable = null;
	}
}

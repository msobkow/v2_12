...
/*
 *	CFBamXmlLoaderCafeXMsgSchemaFormattersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeXMsgSchemaFormattersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeXMsgSchemaFormattersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeXMsgSchemaFormatters" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalJXMsgSchemaFormatters( text );

 ...
 */
public class CFBamXmlLoaderHPlusSchemaObjIncludeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusSchemaObjIncludeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalHppSchemaObjInclude( text );

...
/*
 *	CFBamXmlLoaderTZDateTypeParse XML SAX Element Handler implementation
 *	for TZDateType.
 */
public class CFBamXmlLoaderTZDateTypeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderTZDateTypeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamTZDateTypeEditObj editTZDateType = editBuff;
			ICFBamTZDateTypeObj origTZDateType = (ICFBamTZDateTypeObj)editTZDateType.create();
			editTZDateType = null;

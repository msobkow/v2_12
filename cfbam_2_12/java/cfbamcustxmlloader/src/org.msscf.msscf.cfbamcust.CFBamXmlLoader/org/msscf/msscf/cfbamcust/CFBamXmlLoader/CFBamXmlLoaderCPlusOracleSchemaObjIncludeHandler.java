...
/*
 *	CFBamXmlLoaderCPlusOracleSchemaObjIncludeHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusOracleSchemaObjIncludeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusOracleSchemaObjIncludeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusOracleSchemObjInclude" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCppOracleSchemaObjInclude( text );

...
/*
 *	CFBamXmlLoaderCafeOracleSchemaObjImportHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeOracleSchemaObjImportHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeOracleSchemaObjImportHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeOracleSchemObjImport" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalJOracleSchemaObjImport( text );

...
/*
 *	CFBamXmlLoaderCafeTableObjImplementationHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeTableObjImplementationHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeTableObjImplementationHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeTableObjImplementation" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalJTableObjImplementation( text );
		editTable.update();
		editTable = null;
	}
}

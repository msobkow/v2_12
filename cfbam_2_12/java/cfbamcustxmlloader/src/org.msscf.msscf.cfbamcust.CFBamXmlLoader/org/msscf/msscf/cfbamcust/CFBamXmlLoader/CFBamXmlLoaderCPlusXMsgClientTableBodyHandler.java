...
/*
 *	CFBamXmlLoaderCPlusXMsgClientTableBodyHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusXMsgClientTableBodyHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusXMsgClientTableBodyHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusXMsgClientTableBody" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCppXMsgClientTableBody( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderCafeXMsgClientTableBodyHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeXMsgClientTableBodyHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeXMsgClientTableBodyHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeXMsgClientTableBody" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalJXMsgClientTableBody( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderCafeMySqlSchemObjMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeMySqlSchemaObjMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeMySqlSchemaObjMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeMySqlSchemObjMembers" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalJMySqlSchemaObjMembers( text );

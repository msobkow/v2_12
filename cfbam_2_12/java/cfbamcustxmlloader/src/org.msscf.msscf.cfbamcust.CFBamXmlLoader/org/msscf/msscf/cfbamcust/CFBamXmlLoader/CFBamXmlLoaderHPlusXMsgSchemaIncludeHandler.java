...
/*
 *	CFBamXmlLoaderHPlusXMsgSchemaIncludeHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusXMsgSchemaIncludeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusXMsgSchemaIncludeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusXMsgSchemaInclude" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalHppXMsgSchemaInclude( text );

...
/*
 *	CFBamXmlLoaderCafeXMsgClientTableImportHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeXMsgClientTableImportHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeXMsgClientTableImportHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeXMsgClientTableImport" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalJXMsgClientTableImport( text );
		editTable.update();
		editTable = null;
	}
}

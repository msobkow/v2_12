...
/*
 *	CFBamXmlLoaderCPlusXMsgRqstSchemaXsdElementListHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusXMsgRqstSchemaXsdElementListHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusXMsgRqstSchemaXsdElementListHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusXMsgRqstSchemaXsdElementList" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCppXMsgRqstSchemaXsdElementList( text );

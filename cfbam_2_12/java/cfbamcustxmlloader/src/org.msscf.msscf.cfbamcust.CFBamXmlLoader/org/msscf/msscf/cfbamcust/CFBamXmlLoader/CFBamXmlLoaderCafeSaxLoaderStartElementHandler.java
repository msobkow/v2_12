...
/*
 *	CFBamXmlLoaderCafeSaxLoaderStartElementHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeSaxLoaderStartElementHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeSaxLoaderStartElementHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeSaxLoaderStartElement" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalJSaxLoaderStartElement( text );
		editTable.update();
		editTable = null;
	}
}

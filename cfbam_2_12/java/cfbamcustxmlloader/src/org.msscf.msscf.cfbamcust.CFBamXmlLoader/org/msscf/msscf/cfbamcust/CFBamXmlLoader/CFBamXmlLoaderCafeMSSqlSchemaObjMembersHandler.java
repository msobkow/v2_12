...
/*
 *	CFBamXmlLoaderCafeMSSqlSchemaObjMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeMSSqlSchemaObjMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeMSSqlSchemaObjMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeMSSqlSchemaObjMembers" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalJMSSqlSchemaObjMembers( text );

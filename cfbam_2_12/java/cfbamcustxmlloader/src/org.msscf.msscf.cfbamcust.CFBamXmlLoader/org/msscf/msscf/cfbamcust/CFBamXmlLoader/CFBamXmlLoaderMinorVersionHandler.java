...
/*
 *	CFBamXmlLoaderMinorVersionParse XML SAX Element Handler implementation
 *	for MinorVersion.
 */
public class CFBamXmlLoaderMinorVersionHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderMinorVersionHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			if( scopeObj == null ) {
				...
				editBuff.setRequiredContainerParentMajVer( refMajorVersion );
			...
			ICFBamMinorVersionObj origMinorVersion = (ICFBamMinorVersionObj)schemaObj.getMinorVersionTableObj().readMinorVersionByNameIdx( refMajorVersion.getRequiredTenantId(),

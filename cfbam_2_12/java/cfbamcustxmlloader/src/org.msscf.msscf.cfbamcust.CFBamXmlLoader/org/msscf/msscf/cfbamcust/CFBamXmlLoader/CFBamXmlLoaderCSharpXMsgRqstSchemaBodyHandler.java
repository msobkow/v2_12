...
/*
 *	CFBamXmlLoaderCSharpXMsgRqstSchemaBodyHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpXMsgRqstSchemaBodyHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpXMsgRqstSchemaBodyHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpXMsgRqstSchemaBody" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCsXMsgRqstSchemaBody( text );

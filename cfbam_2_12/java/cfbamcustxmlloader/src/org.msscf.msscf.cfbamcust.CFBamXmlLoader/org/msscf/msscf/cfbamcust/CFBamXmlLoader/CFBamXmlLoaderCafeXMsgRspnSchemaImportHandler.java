...
/*
 *	CFBamXmlLoaderCafeXMsgRspnSchemaImportHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeXMsgRspnSchemaImportHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeXMsgRspnSchemaImportHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeXMsgRspnSchemaImport" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalJXMsgRspnSchemaImport( text );

...
/*
 *	CFBamXmlLoaderHPlusMySqlSchemaObjIncludeHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusMySqlSchemaObjIncludeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusMySqlSchemaObjIncludeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusMySqlSchemObjInclude" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalHppMySqlSchemaObjInclude( text );

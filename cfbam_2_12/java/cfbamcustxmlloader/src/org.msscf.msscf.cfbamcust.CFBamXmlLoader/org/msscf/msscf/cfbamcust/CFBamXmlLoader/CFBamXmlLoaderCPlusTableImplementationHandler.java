...
/*
 *	CFBamXmlLoaderCPlusTableImplementationHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusTableImplementationHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusTableImplementationHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusTableImplementation" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCppTableImplementation( text );
		editTable.update();
		editTable = null;
	}
}

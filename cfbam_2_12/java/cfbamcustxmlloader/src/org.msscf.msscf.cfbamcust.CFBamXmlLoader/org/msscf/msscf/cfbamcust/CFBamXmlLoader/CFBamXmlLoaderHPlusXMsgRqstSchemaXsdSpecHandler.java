...
/*
 *	CFBamXmlLoaderHPlusXMsgRqstSchemaXsdSpecHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusXMsgRqstSchemaXsdSpecHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusXMsgRqstSchemaXsdSpecHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusXMsgRqstSchemaXsdSpec" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalHppXMsgRqstSchemaXsdSpec( text );

...
/*
 *	CFBamXmlLoaderCSharpMethodBodyHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpMethodBodyHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpMethodBodyHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpMethodBody" );
	...
	throws SAXException
	{
		...
		editServerMethod.setRequiredCsMethodBody( text );

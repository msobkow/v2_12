...
/*
 *	CFBamXmlLoaderHPlusEditObjIncludeHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusEditObjIncludeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusEditObjIncludeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusEditObjInclude" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalHppEditObjInclude( text );
		editTable.update();
		editTable = null;
	}
}

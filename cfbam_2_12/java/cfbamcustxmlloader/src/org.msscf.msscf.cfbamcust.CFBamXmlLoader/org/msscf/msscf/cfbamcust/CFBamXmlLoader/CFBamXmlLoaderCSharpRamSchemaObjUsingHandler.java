...
/*
 *	CFBamXmlLoaderCSharpRamSchemObjImplHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpRamSchemaObjUsingHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpRamSchemaObjUsingHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpRamSchemObjUsing" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCsRamSchemaObjUsing( text );

...
/*
 *	CFBamXmlLoaderTextTypeParse XML SAX Element Handler implementation
 *	for TextType.
 */
public class CFBamXmlLoaderTextTypeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderTextTypeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamTextTypeEditObj editTextType = editBuff;
			ICFBamTextTypeObj origTextType = (ICFBamTextTypeObj)editTextType.create();
			editTextType = null;

...
/*
 *	CFBamXmlLoaderHPlusDb2LUWSchemaObjMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusDb2LUWSchemaObjMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusDb2LUWSchemaObjMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusDb2LUWSchemaObjMembers" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalHppDb2LUWSchemaObjMembers( text );

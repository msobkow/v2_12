...
/*
 *	CFBamXmlLoaderCSharpSaxLoaderStartElementHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpSaxLoaderStartElementHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpSaxLoaderStartElementHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpSaxLoaderStartElement" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCsSaxLoaderStartElement( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderCafeRamTableImportHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeRamTableImportHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeRamTableImportHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeRamTableImport" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalJRamTableImport( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderCPlusEditObjIncludeHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusEditObjIncludeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusEditObjIncludeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusEditObjInclude" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCppEditObjInclude( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderHPlusXMsgClientTableBodyHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusXMsgClientTableBodyHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusXMsgClientTableBodyHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusXMsgClientTableBody" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalHppXMsgClientTableBody( text );
		editTable.update();
		editTable = null;
	}
}

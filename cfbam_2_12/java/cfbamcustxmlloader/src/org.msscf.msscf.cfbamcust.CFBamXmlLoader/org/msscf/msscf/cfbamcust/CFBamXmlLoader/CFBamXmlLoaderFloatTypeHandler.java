...
/*
 *	CFBamXmlLoaderFloatTypeParse XML SAX Element Handler implementation
 *	for FloatType.
 */
public class CFBamXmlLoaderFloatTypeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderFloatTypeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamFloatTypeEditObj editFloatType = editBuff;
			ICFBamFloatTypeObj origFloatType = (ICFBamFloatTypeObj)editFloatType.create();
			editFloatType = null;

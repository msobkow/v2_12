...
/*
 *	CFBamXmlLoaderTimeColParse XML SAX Element Handler implementation
 *	for TimeCol.
 */
public class CFBamXmlLoaderTimeColHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderTimeColHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamTimeColEditObj editTimeCol = editBuff;
			ICFBamTimeColObj origTimeCol = (ICFBamTimeColObj)editTimeCol.create();
			editTimeCol = null;

...
/*
 *	CFBamXmlLoaderCPlusRamSchemObjImplHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusRamSchemaObjIncludeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusRamSchemaObjIncludeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusRamSchemObjInclude" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCppRamSchemaObjInclude( text );

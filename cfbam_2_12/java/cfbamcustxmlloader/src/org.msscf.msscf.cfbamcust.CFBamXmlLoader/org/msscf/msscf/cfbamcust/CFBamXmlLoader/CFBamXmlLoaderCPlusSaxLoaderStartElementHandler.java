...
/*
 *	CFBamXmlLoaderCPlusSaxLoaderStartElementHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusSaxLoaderStartElementHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusSaxLoaderStartElementHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusSaxLoaderStartElement" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCppSaxLoaderStartElement( text );
		editTable.update();
		editTable = null;
	}
}

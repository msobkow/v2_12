...
/*
 *	CFBamXmlLoaderCSharpXMsgRqstSchemaXsdSpecHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpXMsgRqstSchemaXsdSpecHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpXMsgRqstSchemaXsdSpecHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpXMsgRqstSchemaXsdSpec" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCsXMsgRqstSchemaXsdSpec( text );

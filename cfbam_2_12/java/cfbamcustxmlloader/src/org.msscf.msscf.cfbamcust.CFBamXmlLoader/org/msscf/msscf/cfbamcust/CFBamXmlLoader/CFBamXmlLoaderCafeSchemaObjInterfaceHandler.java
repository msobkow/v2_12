...
/*
 *	CFBamXmlLoaderCafeSchemaObjInterfaceHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeSchemaObjInterfaceHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeSchemaObjInterfaceHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeSchemaObjInterface" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalJSchemaObjInterface( text );

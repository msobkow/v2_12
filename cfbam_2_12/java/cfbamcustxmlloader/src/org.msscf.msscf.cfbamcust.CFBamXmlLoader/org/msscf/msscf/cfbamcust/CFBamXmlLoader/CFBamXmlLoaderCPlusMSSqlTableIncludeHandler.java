...
/*
 *	CFBamXmlLoaderCPlusMSSqlTableIncludeHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusMSSqlTableIncludeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusMSSqlTableIncludeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusMSSqlTableInclude" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCppMSSqlTableInclude( text );
		editTable.update();
		editTable = null;
	}
}

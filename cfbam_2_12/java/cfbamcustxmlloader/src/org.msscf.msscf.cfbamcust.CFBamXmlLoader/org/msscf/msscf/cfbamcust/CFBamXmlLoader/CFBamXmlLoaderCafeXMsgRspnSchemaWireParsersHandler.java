...
/*
 *	CFBamXmlLoaderCafeXMsgRspnSchemaWireParsersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeXMsgRspnSchemaWireParsersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeXMsgRspnSchemaWireParsersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeXMsgRspnSchemaWireParsers" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalJXMsgRspnSchemaWireParsers( text );

...
/*
 *	CFBamXmlLoaderCSharpMSSqlSchemaObjUsingHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpMSSqlSchemaObjUsingHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpMSSqlSchemaObjUsingHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpMSSqlSchemObjUsing" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCsMSSqlSchemaObjUsing( text );

...
/*
 *	CFBamXmlLoaderHPlusObjMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusObjMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusObjMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusObjMembers" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalHppObjMembers( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderHPlusEditObjMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusEditObjMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusEditObjMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusEditObjMembers" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalHppEditObjMembers( text );
		editTable.update();
		editTable = null;
	}
}

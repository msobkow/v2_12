...
/*
 *	CFBamXmlLoaderCafeXMsgRspnTableImportHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeXMsgRspnTableImportHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeXMsgRspnTableImportHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeXMsgRspnTableImport" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalJXMsgRspnTableImport( text );
		editTable.update();
		editTable = null;
	}
}

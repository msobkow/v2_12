...
/*
 *	CFBamXmlLoaderCSharpSaxLoaderUsingHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpSaxLoaderUsingHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpSaxLoaderUsingHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpSaxLoaderUsing" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCsSaxLoaderUsing( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderCafeObjMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeObjMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeObjMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeObjMembers" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalJObjMembers( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderCPlusXMsgRqstTableBodyHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusXMsgRqstTableBodyHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusXMsgRqstTableBodyHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusXMsgRqstTableBody" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCppXMsgRqstTableBody( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderCPlusXMsgClientSchemaBodyHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusXMsgClientSchemaBodyHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusXMsgClientSchemaBodyHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusXMsgClientSchemaBody" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCppXMsgClientSchemaBody( text );

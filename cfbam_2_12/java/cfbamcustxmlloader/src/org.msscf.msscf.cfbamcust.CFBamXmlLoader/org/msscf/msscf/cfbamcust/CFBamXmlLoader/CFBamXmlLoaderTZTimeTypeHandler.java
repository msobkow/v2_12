...
/*
 *	CFBamXmlLoaderTZTimeTypeParse XML SAX Element Handler implementation
 *	for TZTimeType.
 */
public class CFBamXmlLoaderTZTimeTypeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderTZTimeTypeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamTZTimeTypeEditObj editTZTimeType = editBuff;
			ICFBamTZTimeTypeObj origTZTimeType = (ICFBamTZTimeTypeObj)editTZTimeType.create();
			editTZTimeType = null;

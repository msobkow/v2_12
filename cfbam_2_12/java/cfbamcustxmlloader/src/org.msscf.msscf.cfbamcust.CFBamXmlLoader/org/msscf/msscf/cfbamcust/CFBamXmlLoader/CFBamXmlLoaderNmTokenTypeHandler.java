...
/*
 *	CFBamXmlLoaderNmTokenTypeParse XML SAX Element Handler implementation
 *	for NmTokenType.
 */
public class CFBamXmlLoaderNmTokenTypeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderNmTokenTypeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamNmTokenTypeEditObj editNmTokenType = editBuff;
			ICFBamNmTokenTypeObj origNmTokenType = (ICFBamNmTokenTypeObj)editNmTokenType.create();

...
/*
 *	CFBamXmlLoaderHPlusXMsgRqstSchemaBodyHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusXMsgRqstSchemaBodyHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusXMsgRqstSchemaBodyHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusXMsgRqstSchemaBody" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalHppXMsgRqstSchemaBody( text );

...
/*
 *	CFBamXmlLoaderCafeRamSchemaObjMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeRamSchemaObjMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeRamSchemaObjMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeRamSchemaObjMembers" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalJRamSchemaObjMembers( text );

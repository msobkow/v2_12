...
/*
 *	CFBamXmlLoaderHPlusOracleTableMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusOracleTableMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusOracleTableMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusOracleTableMembers" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalHppOracleTableMembers( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderCafeTableObjMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeTableObjMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeTableObjMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeTableObjMembers" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalJTableObjMembers( text );
		editTable.update();
		editTable = null;
	}
}

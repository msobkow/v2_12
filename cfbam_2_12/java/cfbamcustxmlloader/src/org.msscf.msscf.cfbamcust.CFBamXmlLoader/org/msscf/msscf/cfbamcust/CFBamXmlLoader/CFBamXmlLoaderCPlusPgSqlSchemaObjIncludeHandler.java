...
/*
 *	CFBamXmlLoaderCPlusPgSqlSchemObjImplHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusPgSqlSchemaObjIncludeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusPgSqlSchemaObjIncludeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusPgSqlSchemObjInclude" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCppPgSqlSchemaObjInclude( text );

...
/*
 *	CFBamXmlLoaderNmTokenColParse XML SAX Element Handler implementation
 *	for NmTokenCol.
 */
public class CFBamXmlLoaderNmTokenColHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderNmTokenColHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamNmTokenColEditObj editNmTokenCol = editBuff;
			ICFBamNmTokenColObj origNmTokenCol = (ICFBamNmTokenColObj)editNmTokenCol.create();
			editNmTokenCol = null;

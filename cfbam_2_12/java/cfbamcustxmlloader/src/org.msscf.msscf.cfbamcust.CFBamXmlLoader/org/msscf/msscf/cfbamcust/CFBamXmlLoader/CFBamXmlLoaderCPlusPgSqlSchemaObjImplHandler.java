...
/*
 *	CFBamXmlLoaderCPlusPgSqlSchemaObjImplHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusPgSqlSchemaObjImplHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusPgSqlSchemaObjImplHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusPgSqlSchemaObjImpl" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCppPgSqlSchemaObjImpl( text );

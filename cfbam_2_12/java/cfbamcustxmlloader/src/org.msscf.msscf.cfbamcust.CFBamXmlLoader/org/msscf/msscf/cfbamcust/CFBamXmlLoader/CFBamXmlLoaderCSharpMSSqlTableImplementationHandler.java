...
/*
 *	CFBamXmlLoaderCSharpMSSqlTableImplementationHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpMSSqlTableImplementationHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpMSSqlTableImplementationHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpMSSqlTableImplementation" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCsMSSqlTableImplementation( text );
		editTable.update();
		editTable = null;
	}
}

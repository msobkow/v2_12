...
/*
 *	CFBamXmlLoaderCPlusObjInterfaceHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusObjInterfaceHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusObjInterfaceHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusObjInterface" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCppObjInterface( text );
		editTable.update();
		editTable = null;
	}
}

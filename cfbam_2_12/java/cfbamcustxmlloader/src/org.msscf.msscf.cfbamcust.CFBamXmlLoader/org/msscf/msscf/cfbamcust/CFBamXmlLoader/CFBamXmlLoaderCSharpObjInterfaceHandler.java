...
/*
 *	CFBamXmlLoaderCSharpObjInterfaceHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpObjInterfaceHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpObjInterfaceHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpObjInterface" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCsObjInterface( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderCPlusSaxLoaderEndElementHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusSaxLoaderEndElementHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusSaxLoaderEndElementHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusSaxLoaderEndElement" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCppSaxLoaderEndElement( text );
		editTable.update();
		editTable = null;
	}
}

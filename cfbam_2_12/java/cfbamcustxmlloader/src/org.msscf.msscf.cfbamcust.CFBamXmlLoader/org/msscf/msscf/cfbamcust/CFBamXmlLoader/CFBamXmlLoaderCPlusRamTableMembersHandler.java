...
/*
 *	CFBamXmlLoaderCPlusRamTableMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusRamTableMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusRamTableMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusRamTableMembers" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCppRamTableMembers( text );
		editTable.update();
		editTable = null;
	}
}

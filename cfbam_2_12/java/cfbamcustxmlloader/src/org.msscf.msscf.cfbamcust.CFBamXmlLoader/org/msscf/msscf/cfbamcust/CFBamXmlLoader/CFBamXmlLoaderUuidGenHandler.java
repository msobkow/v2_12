...
/*
 *	CFBamXmlLoaderUuidGenParse XML SAX Element Handler implementation
 *	for UuidGen.
 */
public class CFBamXmlLoaderUuidGenHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderUuidGenHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamUuidGenEditObj editUuidGen = editBuff;
			ICFBamUuidGenObj origUuidGen = (ICFBamUuidGenObj)editUuidGen.create();
			editUuidGen = null;

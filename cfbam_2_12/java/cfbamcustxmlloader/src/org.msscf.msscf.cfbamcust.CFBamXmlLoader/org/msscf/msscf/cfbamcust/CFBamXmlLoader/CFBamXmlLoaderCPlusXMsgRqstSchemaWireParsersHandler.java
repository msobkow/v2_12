...
/*
 *	CFBamXmlLoaderCPlusXMsgRqstSchemaWireParsersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusXMsgRqstSchemaWireParsersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusXMsgRqstSchemaWireParsersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusXMsgRqstSchemaWireParsers" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCppXMsgRqstSchemaWireParsers( text );

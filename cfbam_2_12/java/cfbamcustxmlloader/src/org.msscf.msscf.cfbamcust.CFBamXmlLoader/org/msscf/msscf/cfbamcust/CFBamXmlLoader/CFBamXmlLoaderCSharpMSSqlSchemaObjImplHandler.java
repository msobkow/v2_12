...
/*
 *	CFBamXmlLoaderCSharpMSSqlSchemaObjImplHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpMSSqlSchemaObjImplHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpMSSqlSchemaObjImplHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpMSSqlSchemaObjImpl" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCsMSSqlSchemaObjImpl( text );

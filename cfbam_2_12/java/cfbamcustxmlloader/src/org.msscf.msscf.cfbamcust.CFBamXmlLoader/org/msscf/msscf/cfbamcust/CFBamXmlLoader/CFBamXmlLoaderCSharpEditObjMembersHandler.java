...
/*
 *	CFBamXmlLoaderCSharpEditObjMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpEditObjMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpEditObjMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpEditObjMembers" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCsEditObjMembers( text );
		editTable.update();
		editTable = null;
	}
}

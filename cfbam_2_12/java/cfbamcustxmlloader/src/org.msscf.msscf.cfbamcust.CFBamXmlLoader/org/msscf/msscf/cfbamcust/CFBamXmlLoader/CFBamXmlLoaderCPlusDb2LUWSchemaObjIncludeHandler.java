...
/*
 *	CFBamXmlLoaderCPlusDb2LUWSchemObjIncludeHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusDb2LUWSchemaObjIncludeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusDb2LUWSchemaObjIncludeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusDb2LUWSchemObjInclude" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCppDb2LUWSchemaObjInclude( text );

...
/*
 *	CFBamXmlLoaderCPlusRamSchemaObjMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusRamSchemaObjMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusRamSchemaObjMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusRamSchemaObjMembers" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCppRamSchemaObjMembers( text );

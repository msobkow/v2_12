...
/*
 *	CFBamXmlLoaderCafeMySqlSchemaObjImportHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeMySqlSchemaObjImportHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeMySqlSchemaObjImportHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeMySqlSchemObjImport" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalJMySqlSchemaObjImport( text );

...
/*
 *	CFBamXmlLoaderHPlusOracleSchemObjMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusOracleSchemaObjMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusOracleSchemaObjMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusOracleSchemObjMembers" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalHppOracleSchemaObjMembers( text );

...
/*
 *	CFBamXmlLoaderCSharpXMsgTableFormattersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpXMsgTableFormattersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpXMsgTableFormattersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpXMsgTableFormatters" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCsXMsgTableFormatters( text );
		editTable.update();
		editTable = null;
	}
}

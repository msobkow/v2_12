...
/*
 *	CFBamXmlLoaderCSharpMSSqlSchemaObjMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpMSSqlSchemaObjMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpMSSqlSchemaObjMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpMSSqlSchemaObjMembers" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCsMSSqlSchemaObjMembers( text );

...
/*
 *	CFBamXmlLoaderCPlusPgSqlSchemaObjMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusPgSqlSchemaObjMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusPgSqlSchemaObjMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusPgSqlSchemaObjMembers" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCppPgSqlSchemaObjMembers( text );

...
/*
 *	CFBamXmlLoaderNumberColParse XML SAX Element Handler implementation
 *	for NumberCol.
 */
public class CFBamXmlLoaderNumberColHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderNumberColHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamNumberColEditObj editNumberCol = editBuff;
			ICFBamNumberColObj origNumberCol = (ICFBamNumberColObj)editNumberCol.create();
			editNumberCol = null;

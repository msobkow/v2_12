...
/*
 *	CFBamXmlLoaderHPlusRamSchemaObjImplHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusRamSchemaObjImplHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusRamSchemaObjImplHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusRamSchemaObjImpl" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalHppRamSchemaObjImpl( text );

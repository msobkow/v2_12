...
/*
 *	CFBamXmlLoaderDateColParse XML SAX Element Handler implementation
 *	for DateCol.
 */
public class CFBamXmlLoaderDateColHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderDateColHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamDateColEditObj editDateCol = editBuff;
			ICFBamDateColObj origDateCol = (ICFBamDateColObj)editDateCol.create();
			editDateCol = null;

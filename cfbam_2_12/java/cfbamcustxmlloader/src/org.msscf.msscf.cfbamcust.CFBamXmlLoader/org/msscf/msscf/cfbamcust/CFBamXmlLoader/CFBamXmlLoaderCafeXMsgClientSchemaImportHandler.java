...
/*
 *	CFBamXmlLoaderCafeXMsgClientSchemaImportHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeXMsgClientSchemaImportHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeXMsgClientSchemaImportHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeXMsgClientSchemaImport" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalJXMsgClientSchemaImport( text );

...
/*
 *	CFBamXmlLoaderHPlusSchemaObjInterfaceHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusSchemaObjInterfaceHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusSchemaObjInterfaceHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusSchemaObjInterface" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalHppSchemaObjInterface( text );

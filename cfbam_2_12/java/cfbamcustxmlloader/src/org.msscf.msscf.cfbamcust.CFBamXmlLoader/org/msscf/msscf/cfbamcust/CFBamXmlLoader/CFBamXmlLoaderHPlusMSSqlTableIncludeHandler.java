...
/*
 *	CFBamXmlLoaderHPlusMSSqlTableIncludeHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusMSSqlTableIncludeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusMSSqlTableIncludeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusMSSqlTableInclude" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalHppMSSqlTableInclude( text );
		editTable.update();
		editTable = null;
	}
}

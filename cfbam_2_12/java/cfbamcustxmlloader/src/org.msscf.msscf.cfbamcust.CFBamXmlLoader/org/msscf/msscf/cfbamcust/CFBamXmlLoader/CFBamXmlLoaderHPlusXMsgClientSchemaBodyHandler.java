...
/*
 *	CFBamXmlLoaderHPlusXMsgClientSchemaBodyHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusXMsgClientSchemaBodyHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusXMsgClientSchemaBodyHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusXMsgClientSchemaBody" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalHppXMsgClientSchemaBody( text );

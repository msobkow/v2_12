...
/*
 *	CFBamXmlLoaderTZTimeColParse XML SAX Element Handler implementation
 *	for TZTimeCol.
 */
public class CFBamXmlLoaderTZTimeColHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderTZTimeColHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamTZTimeColEditObj editTZTimeCol = editBuff;
			ICFBamTZTimeColObj origTZTimeCol = (ICFBamTZTimeColObj)editTZTimeCol.create();
			editTZTimeCol = null;

...
/*
 *	CFBamXmlLoaderCafeXMsgRqstTableBodyHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeXMsgRqstTableBodyHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeXMsgRqstTableBodyHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeXMsgRqstTableBody" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalJXMsgRqstTableBody( text );
		editTable.update();
		editTable = null;
	}
}

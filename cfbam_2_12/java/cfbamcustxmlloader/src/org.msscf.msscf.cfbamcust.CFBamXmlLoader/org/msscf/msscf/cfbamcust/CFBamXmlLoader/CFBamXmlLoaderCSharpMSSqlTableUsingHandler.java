...
/*
 *	CFBamXmlLoaderCSharpMSSqlTableUsingHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpMSSqlTableUsingHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpMSSqlTableUsingHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpMSSqlTableUsing" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCsMSSqlTableUsing( text );
		editTable.update();
		editTable = null;
	}
}

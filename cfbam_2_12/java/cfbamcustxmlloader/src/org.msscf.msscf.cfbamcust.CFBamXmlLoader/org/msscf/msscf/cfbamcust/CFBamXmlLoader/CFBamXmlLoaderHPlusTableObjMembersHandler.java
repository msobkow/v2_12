...
/*
 *	CFBamXmlLoaderHPlusTableObjMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusTableObjMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusTableObjMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusTableObjMembers" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalHppTableObjMembers( text );
		editTable.update();
		editTable = null;
	}
}

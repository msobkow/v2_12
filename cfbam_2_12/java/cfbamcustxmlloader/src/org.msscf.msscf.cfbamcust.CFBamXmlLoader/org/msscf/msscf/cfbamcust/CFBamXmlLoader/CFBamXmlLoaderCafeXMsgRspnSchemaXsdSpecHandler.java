 ...
 */
public class CFBamXmlLoaderCafeXMsgRspnSchemaXsdSpecHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeXMsgRspnSchemaXsdSpecHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeXMsgRspnSchemaXsdSpec" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalJXMsgRspnSchemaXsdSpec( text );

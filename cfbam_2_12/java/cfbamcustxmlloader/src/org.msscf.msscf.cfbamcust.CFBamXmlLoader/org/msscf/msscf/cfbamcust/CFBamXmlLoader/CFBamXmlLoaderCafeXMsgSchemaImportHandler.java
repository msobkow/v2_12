...
/*
 *	CFBamXmlLoaderCafeXMsgSchemaImportHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeXMsgSchemaImportHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeXMsgSchemaImportHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeXMsgSchemaImport" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalJXMsgSchemaImport( text );

...
/*
 *	CFBamXmlLoaderCPlusSaxLoaderIncludeHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusSaxLoaderIncludeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusSaxLoaderIncludeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusSaxLoaderInclude" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCppSaxLoaderInclude( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderCSharpSchemaObjImplementationHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpSchemaObjImplementationHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpSchemaObjImplementationHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpSchemaObjImplementation" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCsSchemaObjImplementation( text );

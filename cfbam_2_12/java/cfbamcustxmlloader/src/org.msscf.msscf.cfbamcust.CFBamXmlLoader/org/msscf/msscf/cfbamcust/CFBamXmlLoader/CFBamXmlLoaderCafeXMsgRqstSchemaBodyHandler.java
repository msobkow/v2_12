...
/*
 *	CFBamXmlLoaderCafeXMsgRqstSchemaBodyHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeXMsgRqstSchemaBodyHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeXMsgRqstSchemaBodyHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeXMsgRqstSchemaBody" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalJXMsgRqstSchemaBody( text );

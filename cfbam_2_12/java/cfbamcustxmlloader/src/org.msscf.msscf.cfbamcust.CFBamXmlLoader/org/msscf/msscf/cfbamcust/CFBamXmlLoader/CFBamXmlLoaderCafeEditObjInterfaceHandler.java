...
/*
 *	CFBamXmlLoaderCafeEditObjInterfaceHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeEditObjInterfaceHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeEditObjInterfaceHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeEditObjInterface" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalJEditObjInterface( text );
		editTable.update();
		editTable = null;
	}
}

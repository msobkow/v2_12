...
/*
 *	CFBamXmlLoaderCPlusTableIncludeHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusTableIncludeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusTableIncludeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusTableInclude" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCppTableInclude( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderHPlusTableIncludeHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusTableIncludeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusTableIncludeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusTableInclude" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalHppTableInclude( text );
		editTable.update();
		editTable = null;
	}
}

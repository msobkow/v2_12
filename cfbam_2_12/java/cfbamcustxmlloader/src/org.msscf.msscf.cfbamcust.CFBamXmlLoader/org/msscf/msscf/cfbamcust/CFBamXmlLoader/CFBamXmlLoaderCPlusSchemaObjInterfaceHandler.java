...
/*
 *	CFBamXmlLoaderCPlusSchemaObjInterfaceHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusSchemaObjInterfaceHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusSchemaObjInterfaceHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusSchemaObjInterface" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCppSchemaObjInterface( text );

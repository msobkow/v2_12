...
/*
 *	CFBamXmlLoaderNmTokensColParse XML SAX Element Handler implementation
 *	for NmTokensCol.
 */
public class CFBamXmlLoaderNmTokensColHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderNmTokensColHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamNmTokensColEditObj editNmTokensCol = editBuff;
			ICFBamNmTokensColObj origNmTokensCol = (ICFBamNmTokensColObj)editNmTokensCol.create();

...
/*
 *	CFBamXmlLoaderCPlusEditObjInterfaceHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusEditObjInterfaceHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusEditObjInterfaceHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusEditObjInterface" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCppEditObjInterface( text );
		editTable.update();
		editTable = null;
	}
}

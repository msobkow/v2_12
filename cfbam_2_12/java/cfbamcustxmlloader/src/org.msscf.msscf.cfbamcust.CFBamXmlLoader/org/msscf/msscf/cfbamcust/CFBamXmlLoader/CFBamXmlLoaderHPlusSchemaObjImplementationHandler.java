...
/*
 *	CFBamXmlLoaderHPlusSchemaObjImplementationHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusSchemaObjImplementationHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusSchemaObjImplementationHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusSchemaObjImplementation" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalHppSchemaObjImplementation( text );

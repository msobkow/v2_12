...
/*
 *	CFBamXmlLoaderBlobColParse XML SAX Element Handler implementation
 *	for BlobCol.
 */
public class CFBamXmlLoaderBlobColHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderBlobColHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamBlobColEditObj editBlobCol = editBuff;
			ICFBamBlobColObj origBlobCol = (ICFBamBlobColObj)editBlobCol.create();
			editBlobCol = null;

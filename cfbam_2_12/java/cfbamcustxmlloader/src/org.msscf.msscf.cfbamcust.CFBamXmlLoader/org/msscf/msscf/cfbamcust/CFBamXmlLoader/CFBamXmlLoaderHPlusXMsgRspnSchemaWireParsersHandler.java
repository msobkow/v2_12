...
/*
 *	CFBamXmlLoaderHPlusXMsgRspnSchemaWireParsersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusXMsgRspnSchemaWireParsersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusXMsgRspnSchemaWireParsersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusXMsgRspnSchemaWireParsers" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalHppXMsgRspnSchemaWireParsers( text );

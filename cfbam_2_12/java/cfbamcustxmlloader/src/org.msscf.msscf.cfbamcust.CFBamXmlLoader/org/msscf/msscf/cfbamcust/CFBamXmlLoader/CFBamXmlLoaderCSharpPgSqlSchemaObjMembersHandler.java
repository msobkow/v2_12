...
/*
 *	CFBamXmlLoaderCSharpPgSqlSchemaObjMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpPgSqlSchemaObjMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpPgSqlSchemaObjMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpPgSqlSchemaObjMembers" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCsPgSqlSchemaObjMembers( text );

...
/*
 *	CFBamXmlLoaderCPlusTableObjIncludeHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusTableObjIncludeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusTableObjIncludeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusTableObjInclude" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCppTableObjInclude( text );
		editTable.update();
		editTable = null;
	}
}

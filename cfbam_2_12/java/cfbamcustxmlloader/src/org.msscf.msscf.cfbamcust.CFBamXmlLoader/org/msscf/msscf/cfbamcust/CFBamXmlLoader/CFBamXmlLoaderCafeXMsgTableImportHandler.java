...
/*
 *	CFBamXmlLoaderCafeXMsgTableImportHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeXMsgTableImportHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeXMsgTableImportHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeXMsgTableImport" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalJXMsgTableImport( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderIndexColParse XML SAX Element Handler implementation
 *	for IndexCol.
 */
public class CFBamXmlLoaderIndexColHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderIndexColHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			refColumn = (ICFBamValueObj)(editBuff.getRequiredContainerIndex().getRequiredContainerTable().getNamedObject( attrName ) );
			editBuff.setRequiredLookupColumn( refColumn );

			ICFBamIndexColEditObj editIndexCol = editBuff;
			ICFBamIndexColObj origIndexCol = (ICFBamIndexColObj)editIndexCol.create();
			editIndexCol = null;

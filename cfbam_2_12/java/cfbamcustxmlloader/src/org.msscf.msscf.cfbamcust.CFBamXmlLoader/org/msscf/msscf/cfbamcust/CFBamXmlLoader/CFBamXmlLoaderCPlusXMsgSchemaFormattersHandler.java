...
/*
 *	CFBamXmlLoaderCPlusXMsgSchemaFormattersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusXMsgSchemaFormattersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusXMsgSchemaFormattersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusXMsgSchemaFormatters" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCppXMsgSchemaFormatters( text );

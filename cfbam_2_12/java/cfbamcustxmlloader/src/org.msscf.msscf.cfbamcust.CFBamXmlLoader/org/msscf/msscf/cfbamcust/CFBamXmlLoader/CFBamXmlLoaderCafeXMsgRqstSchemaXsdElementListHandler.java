...
/*
 *	CFBamXmlLoaderCafeXMsgRqstSchemaXsdElementListHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeXMsgRqstSchemaXsdElementListHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeXMsgRqstSchemaXsdElementListHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeXMsgRqstSchemaXsdElementList" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalJXMsgRqstSchemaXsdElementList( text );

...
/*
 *	CFBamXmlLoaderCSharpXMsgClientTableUsingHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpXMsgClientTableUsingHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpXMsgClientTableUsingHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpXMsgClientTableUsing" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCsXMsgClientTableUsing( text );
		editTable.update();
		editTable = null;
	}
}

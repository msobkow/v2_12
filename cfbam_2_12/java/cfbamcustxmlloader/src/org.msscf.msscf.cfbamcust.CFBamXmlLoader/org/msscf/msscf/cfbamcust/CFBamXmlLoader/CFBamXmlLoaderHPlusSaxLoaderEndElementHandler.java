...
/*
 *	CFBamXmlLoaderHPlusSaxLoaderEndElementHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusSaxLoaderEndElementHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusSaxLoaderEndElementHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusSaxLoaderEndElement" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalHppSaxLoaderEndElement( text );
		editTable.update();
		editTable = null;
	}
}

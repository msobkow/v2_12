...
/*
 *	CFBamXmlLoaderHPlusTableInterfaceHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusTableInterfaceHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusTableInterfaceHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusTableInterface" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalHppTableInterface( text );
		editTable.update();
		editTable = null;
	}
}

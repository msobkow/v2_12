...
/*
 *	CFBamXmlLoaderCSharpObjUsingHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpObjUsingHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpObjUsingHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpObjUsing" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCsObjUsing( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderHPlusPgSqlSchemaObjMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusPgSqlSchemaObjMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusPgSqlSchemaObjMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusPgSqlSchemaObjMembers" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalHppPgSqlSchemaObjMembers( text );

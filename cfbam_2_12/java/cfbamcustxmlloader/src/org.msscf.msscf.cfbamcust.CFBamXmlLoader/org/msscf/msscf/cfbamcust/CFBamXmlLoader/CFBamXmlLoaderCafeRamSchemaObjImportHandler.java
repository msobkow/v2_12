...
/*
 *	CFBamXmlLoaderCafeRamSchemObjImplHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeRamSchemaObjImportHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeRamSchemaObjImportHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeRamSchemObjImport" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalJRamSchemaObjImport( text );

...
/*
 *	CFBamXmlLoaderTZTimestampTypeParse XML SAX Element Handler implementation
 *	for TZTimestampType.
 */
public class CFBamXmlLoaderTZTimestampTypeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderTZTimestampTypeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamTZTimestampTypeEditObj editTZTimestampType = editBuff;
			ICFBamTZTimestampTypeObj origTZTimestampType = (ICFBamTZTimestampTypeObj)editTZTimestampType.create();

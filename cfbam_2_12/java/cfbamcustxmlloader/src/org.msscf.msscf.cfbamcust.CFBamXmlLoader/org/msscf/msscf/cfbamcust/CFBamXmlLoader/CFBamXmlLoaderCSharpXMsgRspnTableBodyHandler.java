...
/*
 *	CFBamXmlLoaderCSharpXMsgRspnTableBodyHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpXMsgRspnTableBodyHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpXMsgRspnTableBodyHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpXMsgRspnTableBody" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCsXMsgRspnTableBody( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderCPlusMSSqlSchemaObjIncludeHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusMSSqlSchemaObjIncludeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusMSSqlSchemaObjIncludeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusMSSqlSchemObjInclude" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCppMSSqlSchemaObjInclude( text );

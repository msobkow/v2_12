...
/*
 *	CFBamXmlLoaderCafeTableImportHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeTableImportHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeTableImportHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeTableImport" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalJTableImport( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderCafeMSSqlTableMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeMSSqlTableMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeMSSqlTableMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeMSSqlTableMembers" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalJMSSqlTableMembers( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderCSharpTableObjImplementationHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpTableObjImplementationHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpTableObjImplementationHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpTableObjImplementation" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCsTableObjImplementation( text );
		editTable.update();
		editTable = null;
	}
}

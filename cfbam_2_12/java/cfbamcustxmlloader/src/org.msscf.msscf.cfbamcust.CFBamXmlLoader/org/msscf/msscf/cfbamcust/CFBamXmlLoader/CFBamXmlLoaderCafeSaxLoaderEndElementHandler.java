...
/*
 *	CFBamXmlLoaderCafeSaxLoaderEndElementHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeSaxLoaderEndElementHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeSaxLoaderEndElementHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeSaxLoaderEndElement" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalJSaxLoaderEndElement( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderHPlusXMsgSchemaFormattersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusXMsgSchemaFormattersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusXMsgSchemaFormattersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusXMsgSchemaFormatters" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalHppXMsgSchemaFormatters( text );

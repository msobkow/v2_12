...
/*
 *	CFBamXmlLoaderHPlusXMsgTableIncludeHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusXMsgTableIncludeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusXMsgTableIncludeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusXMsgTableInclude" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalHppXMsgTableInclude( text );
		editTable.update();
		editTable = null;
	}
}

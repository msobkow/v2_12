...
/*
 *	CFBamXmlLoaderCPlusXMsgRqstSchemaBodyHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusXMsgRqstSchemaBodyHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusXMsgRqstSchemaBodyHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusXMsgRqstSchemaBody" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCppXMsgRqstSchemaBody( text );

...
/*
 *	CFBamXmlLoaderUInt32TypeParse XML SAX Element Handler implementation
 *	for UInt32Type.
 */
public class CFBamXmlLoaderUInt32TypeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderUInt32TypeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamUInt32TypeEditObj editUInt32Type = editBuff;
			ICFBamUInt32TypeObj origUInt32Type = (ICFBamUInt32TypeObj)editUInt32Type.create();
			editUInt32Type = null;

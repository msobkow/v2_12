...
/*
 *	CFBamXmlLoaderCSharpTableImplementationHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpTableImplementationHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpTableImplementationHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpTableImplementation" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCsTableImplementation( text );
		editTable.update();
		editTable = null;
	}
}

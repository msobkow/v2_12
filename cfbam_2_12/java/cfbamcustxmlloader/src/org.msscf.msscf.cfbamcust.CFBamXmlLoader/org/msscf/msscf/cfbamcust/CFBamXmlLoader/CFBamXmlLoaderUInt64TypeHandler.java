...
/*
 *	CFBamXmlLoaderUInt64TypeParse XML SAX Element Handler implementation
 *	for UInt64Type.
 */
public class CFBamXmlLoaderUInt64TypeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderUInt64TypeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamUInt64TypeEditObj editUInt64Type = editBuff;
			ICFBamUInt64TypeObj origUInt64Type = (ICFBamUInt64TypeObj)editUInt64Type.create();
			editUInt64Type = null;

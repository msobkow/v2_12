...
/*
 *	CFBamXmlLoaderCSharpMSSqlTableMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpMSSqlTableMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpMSSqlTableMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpMSSqlTableMembers" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCsMSSqlTableMembers( text );
		editTable.update();
		editTable = null;
	}
}

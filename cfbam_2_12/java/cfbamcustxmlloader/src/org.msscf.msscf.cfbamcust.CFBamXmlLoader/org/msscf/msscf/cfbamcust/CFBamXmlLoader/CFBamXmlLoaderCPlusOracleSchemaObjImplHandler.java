...
/*
 *	CFBamXmlLoaderCPlusOracleSchemObjImplHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusOracleSchemaObjImplHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusOracleSchemaObjImplHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusOracleSchemObjImpl" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCppOracleSchemaObjImpl( text );

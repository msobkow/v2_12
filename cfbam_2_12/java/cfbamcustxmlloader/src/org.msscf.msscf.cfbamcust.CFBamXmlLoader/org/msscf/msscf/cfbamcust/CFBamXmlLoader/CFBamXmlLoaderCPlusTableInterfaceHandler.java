...
/*
 *	CFBamXmlLoaderCPlusTableInterfaceHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusTableInterfaceHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusTableInterfaceHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusTableInterface" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCppTableInterface( text );
		editTable.update();
		editTable = null;
	}
}

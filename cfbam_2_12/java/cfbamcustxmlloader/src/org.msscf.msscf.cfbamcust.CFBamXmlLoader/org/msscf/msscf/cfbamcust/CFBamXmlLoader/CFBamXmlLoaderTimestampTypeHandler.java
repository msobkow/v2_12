...
/*
 *	CFBamXmlLoaderTimestampTypeParse XML SAX Element Handler implementation
 *	for TimestampType.
 */
public class CFBamXmlLoaderTimestampTypeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderTimestampTypeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamTimestampTypeEditObj editTimestampType = editBuff;
			ICFBamTimestampTypeObj origTimestampType = (ICFBamTimestampTypeObj)editTimestampType.create();

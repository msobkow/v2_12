...
/*
 *	CFBamXmlLoaderCPlusObjIncludeHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCPlusObjIncludeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCPlusObjIncludeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CPlusObjInclude" );
	...
	throws SAXException
	{
		...
		editTable.setOptionalCppObjInclude( text );
		editTable.update();
		editTable = null;
	}
}

...
/*
 *	CFBamXmlLoaderCafeXMsgRqstSchemaXsdSpecHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCafeXMsgRqstSchemaXsdSpecHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCafeXMsgRqstSchemaXsdSpecHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CafeXMsgRqstSchemaXsdSpec" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalJXMsgRqstSchemaXsdSpec( text );

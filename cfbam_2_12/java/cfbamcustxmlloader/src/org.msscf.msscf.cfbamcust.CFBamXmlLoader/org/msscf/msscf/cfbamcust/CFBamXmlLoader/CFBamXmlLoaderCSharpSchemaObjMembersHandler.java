...
/*
 *	CFBamXmlLoaderCSharpSchemaObjMembersHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderCSharpSchemaObjMembersHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCSharpSchemaObjMembersHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CSharpSchemaObjMembers" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalCsSchemaObjMembers( text );

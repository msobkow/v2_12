...
/*
 *	CFBamXmlLoaderUuidTypeParse XML SAX Element Handler implementation
 *	for UuidType.
 */
public class CFBamXmlLoaderUuidTypeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderUuidTypeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamUuidTypeEditObj editUuidType = editBuff;
			ICFBamUuidTypeObj origUuidType = (ICFBamUuidTypeObj)editUuidType.create();
			editUuidType = null;

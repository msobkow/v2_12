...
/*
 *	CFBamXmlLoaderHPlusXMsgRspnSchemaXsdElementListHandler SAX Element Handler implementation
 */
public class CFBamXmlLoaderHPlusXMsgRspnSchemaXsdElementListHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderHPlusXMsgRspnSchemaXsdElementListHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "HPlusXMsgRspnSchemaXsdElementList" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalHppXMsgRspnSchemaXsdElementList( text );

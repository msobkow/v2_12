...
/*
 *	CFBamXmlLoaderTokenTypeParse XML SAX Element Handler implementation
 *	for TokenType.
 */
public class CFBamXmlLoaderTokenTypeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderTokenTypeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamTokenTypeEditObj editTokenType = editBuff;
			ICFBamTokenTypeObj origTokenType = (ICFBamTokenTypeObj)editTokenType.create();
			editTokenType = null;

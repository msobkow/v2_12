...
// Description: Java 11 XML SAX Element Handler for TZDateType
 ...
 *	for TZDateType.
 */
public class CFBamSaxLoaderTZDateType
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderTZDateType( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamTZDateTypeObj origTZDateType = (ICFBamTZDateTypeObj)schemaObj.getTZDateTypeTableObj().readTZDateTypeByUNameIdx( refTenant.getRequiredId(),
			...
			if( origTZDateType == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editTZDateType.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						...
						editTZDateType.setOptionalDummy( editBuff.getOptionalDummy() );
						editTZDateType.setOptionalLookupDefSchema( editBuff.getOptionalLookupDefSchema() );
						break;
					case Replace:
						editTZDateType = (ICFBamTZDateTypeEditObj)origTZDateType.beginEdit();
						editTZDateType.deleteInstance();
						editTZDateType = null;
						origTZDateType = null;
						editTZDateType = editBuff;
						break;

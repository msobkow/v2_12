...
// Description: Java 11 XML SAX Element Handler for FloatType
 ...
 *	for FloatType.
 */
public class CFBamSaxLoaderFloatType
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderFloatType( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamFloatTypeObj origFloatType = (ICFBamFloatTypeObj)schemaObj.getFloatTypeTableObj().readFloatTypeByUNameIdx( refTenant.getRequiredId(),
			...
			if( origFloatType == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editFloatType.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );

...
// Description: Java 11 XML SAX Element Handler for NmTokensType
 ...
 *	for NmTokensType.
 */
public class CFBamSaxLoaderNmTokensType
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderNmTokensType( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamNmTokensTypeObj origNmTokensType = (ICFBamNmTokensTypeObj)schemaObj.getNmTokensTypeTableObj().readNmTokensTypeByUNameIdx( refTenant.getRequiredId(),
			...
			if( origNmTokensType == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editNmTokensType.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
					...
					case Replace:
						editNmTokensType = (ICFBamNmTokensTypeEditObj)origNmTokensType.beginEdit();
						editNmTokensType.deleteInstance();
						editNmTokensType = null;

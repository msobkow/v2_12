...
// Description: Java 11 XML SAX Element Handler for BoolCol
 ...
 *	for BoolCol.
 */
public class CFBamSaxLoaderBoolCol
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderBoolCol( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamBoolColObj origBoolCol = (ICFBamBoolColObj)schemaObj.getBoolColTableObj().readBoolColByUNameIdx( refTenant.getRequiredId(),
			...
			if( origBoolCol == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editBoolCol.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );

...
// Description: Java 11 XML SAX Element Handler for BlobType
 ...
 *	for BlobType.
 */
public class CFBamSaxLoaderBlobType
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderBlobType( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamBlobTypeObj origBlobType = (ICFBamBlobTypeObj)schemaObj.getBlobTypeTableObj().readBlobTypeByUNameIdx( refTenant.getRequiredId(),
			...
			if( origBlobType == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editBlobType.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );

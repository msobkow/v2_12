...
// Description: Java 11 XML SAX Element Handler for Int16Col
 ...
 *	for Int16Col.
 */
public class CFBamSaxLoaderInt16Col
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderInt16Col( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamInt16ColObj origInt16Col = (ICFBamInt16ColObj)schemaObj.getInt16ColTableObj().readInt16ColByUNameIdx( refTenant.getRequiredId(),
			...
			if( origInt16Col == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editInt16Col.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );

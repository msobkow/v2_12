...
// Description: Java 11 XML SAX Element Handler for DateCol
 ...
 *	for DateCol.
 */
public class CFBamSaxLoaderDateCol
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderDateCol( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamDateColObj origDateCol = (ICFBamDateColObj)schemaObj.getDateColTableObj().readDateColByUNameIdx( refTenant.getRequiredId(),
			...
			if( origDateCol == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editDateCol.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						...
						editDateCol.setOptionalDummy( editBuff.getOptionalDummy() );
						editDateCol.setOptionalLookupDefSchema( editBuff.getOptionalLookupDefSchema() );
						break;
					case Replace:
						editDateCol = (ICFBamDateColEditObj)origDateCol.beginEdit();
						editDateCol.deleteInstance();
						editDateCol = null;
						origDateCol = null;
						editDateCol = editBuff;
						break;

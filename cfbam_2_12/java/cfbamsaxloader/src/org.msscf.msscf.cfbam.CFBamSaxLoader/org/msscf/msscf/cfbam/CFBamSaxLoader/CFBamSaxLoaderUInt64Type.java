...
// Description: Java 11 XML SAX Element Handler for UInt64Type
 ...
 *	for UInt64Type.
 */
public class CFBamSaxLoaderUInt64Type
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderUInt64Type( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			if( ( attrInitValue == null ) || ( attrInitValue.length() <= 0 ) ) {
				...
				natInitValue= CFLibBigDecimalUtil.parse( "CFBam.UInt64Def.InitValue", 19, 0, attrInitValue );
			}
			...
			if( ( attrMinValue == null ) || ( attrMinValue.length() <= 0 ) ) {
				...
				natMinValue= CFLibBigDecimalUtil.parse( "CFBam.UInt64Def.MinValue", 19, 0, attrMinValue );
			}
			...
			if( ( attrMaxValue == null ) || ( attrMaxValue.length() <= 0 ) ) {
				...
				natMaxValue= CFLibBigDecimalUtil.parse( "CFBam.UInt64Def.MaxValue", 19, 0, attrMaxValue );
			}
			...
			ICFBamUInt64TypeObj origUInt64Type = (ICFBamUInt64TypeObj)schemaObj.getUInt64TypeTableObj().readUInt64TypeByUNameIdx( refTenant.getRequiredId(),
			...
			if( origUInt64Type == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editUInt64Type.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );

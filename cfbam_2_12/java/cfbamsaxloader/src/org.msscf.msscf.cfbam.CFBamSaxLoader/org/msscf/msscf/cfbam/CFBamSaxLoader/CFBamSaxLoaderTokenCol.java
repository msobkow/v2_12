...
// Description: Java 11 XML SAX Element Handler for TokenCol
 ...
 *	for TokenCol.
 */
public class CFBamSaxLoaderTokenCol
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderTokenCol( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamTokenColObj origTokenCol = (ICFBamTokenColObj)schemaObj.getTokenColTableObj().readTokenColByUNameIdx( refTenant.getRequiredId(),
			...
			if( origTokenCol == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editTokenCol.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );

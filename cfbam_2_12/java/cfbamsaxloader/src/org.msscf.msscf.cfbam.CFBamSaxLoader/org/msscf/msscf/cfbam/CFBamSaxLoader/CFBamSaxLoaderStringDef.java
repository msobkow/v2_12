...
// Description: Java 11 XML SAX Element Handler for StringDef
 ...
 *	for StringDef.
 */
public class CFBamSaxLoaderStringDef
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderStringDef( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamStringDefObj origStringDef = (ICFBamStringDefObj)schemaObj.getStringDefTableObj().readStringDefByUNameIdx( refTenant.getRequiredId(),
			...
			if( origStringDef == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editStringDef.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );

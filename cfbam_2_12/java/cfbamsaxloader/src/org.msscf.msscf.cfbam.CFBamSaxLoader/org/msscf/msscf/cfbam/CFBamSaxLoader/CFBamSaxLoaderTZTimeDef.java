...
// Description: Java 11 XML SAX Element Handler for TZTimeDef
 ...
 *	for TZTimeDef.
 */
public class CFBamSaxLoaderTZTimeDef
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderTZTimeDef( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamTZTimeDefObj origTZTimeDef = (ICFBamTZTimeDefObj)schemaObj.getTZTimeDefTableObj().readTZTimeDefByUNameIdx( refTenant.getRequiredId(),
			...
			if( origTZTimeDef == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editTZTimeDef.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						...
						editTZTimeDef.setOptionalDummy( editBuff.getOptionalDummy() );

...
// Description: Java 11 XML SAX Element Handler for DoubleDef
 ...
 *	for DoubleDef.
 */
public class CFBamSaxLoaderDoubleDef
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderDoubleDef( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamDoubleDefObj origDoubleDef = (ICFBamDoubleDefObj)schemaObj.getDoubleDefTableObj().readDoubleDefByUNameIdx( refTenant.getRequiredId(),
			...
			if( origDoubleDef == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editDoubleDef.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );

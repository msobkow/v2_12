...
// Description: Java 11 XML SAX Element Handler for TimeDef
 ...
 *	for TimeDef.
 */
public class CFBamSaxLoaderTimeDef
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderTimeDef( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamTimeDefObj origTimeDef = (ICFBamTimeDefObj)schemaObj.getTimeDefTableObj().readTimeDefByUNameIdx( refTenant.getRequiredId(),
			...
			if( origTimeDef == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editTimeDef.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						...
						editTimeDef.setOptionalDummy( editBuff.getOptionalDummy() );
						editTimeDef.setOptionalLookupDefSchema( editBuff.getOptionalLookupDefSchema() );
						break;
					case Replace:
						editTimeDef = (ICFBamTimeDefEditObj)origTimeDef.beginEdit();
						editTimeDef.deleteInstance();
						editTimeDef = null;
						origTimeDef = null;
						editTimeDef = editBuff;
						break;

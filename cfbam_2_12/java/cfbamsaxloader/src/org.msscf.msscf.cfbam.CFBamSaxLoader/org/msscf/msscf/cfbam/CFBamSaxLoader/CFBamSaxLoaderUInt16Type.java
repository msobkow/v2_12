...
// Description: Java 11 XML SAX Element Handler for UInt16Type
 ...
 *	for UInt16Type.
 */
public class CFBamSaxLoaderUInt16Type
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderUInt16Type( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamUInt16TypeObj origUInt16Type = (ICFBamUInt16TypeObj)schemaObj.getUInt16TypeTableObj().readUInt16TypeByUNameIdx( refTenant.getRequiredId(),
			...
			if( origUInt16Type == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editUInt16Type.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );

...
// Description: Java 11 XML SAX Element Handler for DateDef
 ...
 *	for DateDef.
 */
public class CFBamSaxLoaderDateDef
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderDateDef( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamDateDefObj origDateDef = (ICFBamDateDefObj)schemaObj.getDateDefTableObj().readDateDefByUNameIdx( refTenant.getRequiredId(),
			...
			if( origDateDef == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editDateDef.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						...
						editDateDef.setOptionalDummy( editBuff.getOptionalDummy() );
						editDateDef.setOptionalLookupDefSchema( editBuff.getOptionalLookupDefSchema() );
						break;
					case Replace:
						editDateDef = (ICFBamDateDefEditObj)origDateDef.beginEdit();
						editDateDef.deleteInstance();
						editDateDef = null;
						origDateDef = null;
						editDateDef = editBuff;
						break;

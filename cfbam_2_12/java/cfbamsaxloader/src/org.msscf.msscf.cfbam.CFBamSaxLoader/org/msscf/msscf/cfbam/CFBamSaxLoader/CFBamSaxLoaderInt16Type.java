...
// Description: Java 11 XML SAX Element Handler for Int16Type
 ...
 *	for Int16Type.
 */
public class CFBamSaxLoaderInt16Type
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderInt16Type( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamInt16TypeObj origInt16Type = (ICFBamInt16TypeObj)schemaObj.getInt16TypeTableObj().readInt16TypeByUNameIdx( refTenant.getRequiredId(),
			...
			if( origInt16Type == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editInt16Type.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );

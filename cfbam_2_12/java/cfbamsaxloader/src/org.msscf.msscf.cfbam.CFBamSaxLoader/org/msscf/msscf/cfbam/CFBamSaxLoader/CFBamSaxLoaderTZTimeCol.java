...
// Description: Java 11 XML SAX Element Handler for TZTimeCol
 ...
 *	for TZTimeCol.
 */
public class CFBamSaxLoaderTZTimeCol
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderTZTimeCol( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamTZTimeColObj origTZTimeCol = (ICFBamTZTimeColObj)schemaObj.getTZTimeColTableObj().readTZTimeColByUNameIdx( refTenant.getRequiredId(),
			...
			if( origTZTimeCol == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editTZTimeCol.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						...
						editTZTimeCol.setOptionalDummy( editBuff.getOptionalDummy() );
						editTZTimeCol.setOptionalLookupDefSchema( editBuff.getOptionalLookupDefSchema() );
						break;
					case Replace:
						editTZTimeCol = (ICFBamTZTimeColEditObj)origTZTimeCol.beginEdit();
						editTZTimeCol.deleteInstance();
						editTZTimeCol = null;
						origTZTimeCol = null;
						editTZTimeCol = editBuff;
						break;

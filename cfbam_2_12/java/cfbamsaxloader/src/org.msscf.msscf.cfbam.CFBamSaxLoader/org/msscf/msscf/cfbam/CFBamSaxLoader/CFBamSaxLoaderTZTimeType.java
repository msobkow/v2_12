...
// Description: Java 11 XML SAX Element Handler for TZTimeType
 ...
 *	for TZTimeType.
 */
public class CFBamSaxLoaderTZTimeType
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderTZTimeType( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamTZTimeTypeObj origTZTimeType = (ICFBamTZTimeTypeObj)schemaObj.getTZTimeTypeTableObj().readTZTimeTypeByUNameIdx( refTenant.getRequiredId(),
			...
			if( origTZTimeType == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editTZTimeType.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						...
						editTZTimeType.setOptionalDummy( editBuff.getOptionalDummy() );
						editTZTimeType.setOptionalLookupDefSchema( editBuff.getOptionalLookupDefSchema() );
						break;
					case Replace:
						editTZTimeType = (ICFBamTZTimeTypeEditObj)origTZTimeType.beginEdit();
						editTZTimeType.deleteInstance();
						editTZTimeType = null;
						origTZTimeType = null;
						editTZTimeType = editBuff;
						break;

...
// Description: Java 11 XML SAX Element Handler for DoubleType
 ...
 *	for DoubleType.
 */
public class CFBamSaxLoaderDoubleType
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderDoubleType( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamDoubleTypeObj origDoubleType = (ICFBamDoubleTypeObj)schemaObj.getDoubleTypeTableObj().readDoubleTypeByUNameIdx( refTenant.getRequiredId(),
			...
			if( origDoubleType == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editDoubleType.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );

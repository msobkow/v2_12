...
// Description: Java 11 XML SAX Element Handler for DelSubDep2
 ...
 *	for DelSubDep2.
 */
public class CFBamSaxLoaderDelSubDep2
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderDelSubDep2( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamDelSubDep1Obj refDelSubDep1 = null;
			...
			if( scopeObj == null ) {
				...
				refDelSubDep1 = (ICFBamDelSubDep1Obj) scopeObj;
				editBuff.setRequiredContainerDelSubDep1( refDelSubDep1 );

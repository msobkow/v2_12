...
// Description: Java 11 XML SAX Element Handler for TimestampDef
 ...
 *	for TimestampDef.
 */
public class CFBamSaxLoaderTimestampDef
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderTimestampDef( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamTimestampDefObj origTimestampDef = (ICFBamTimestampDefObj)schemaObj.getTimestampDefTableObj().readTimestampDefByUNameIdx( refTenant.getRequiredId(),
			...
			if( origTimestampDef == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editTimestampDef.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						...
						editTimestampDef.setOptionalDummy( editBuff.getOptionalDummy() );
						editTimestampDef.setOptionalLookupDefSchema( editBuff.getOptionalLookupDefSchema() );
						break;
					case Replace:
						editTimestampDef = (ICFBamTimestampDefEditObj)origTimestampDef.beginEdit();
						editTimestampDef.deleteInstance();
						editTimestampDef = null;

...
// Description: Java 11 XML SAX Element Handler for TextType
 ...
 *	for TextType.
 */
public class CFBamSaxLoaderTextType
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderTextType( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamTextTypeObj origTextType = (ICFBamTextTypeObj)schemaObj.getTextTypeTableObj().readTextTypeByUNameIdx( refTenant.getRequiredId(),
			...
			if( origTextType == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editTextType.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						...
						editTextType.setOptionalXmlElementName( editBuff.getOptionalXmlElementName() );
						editTextType.setOptionalLookupDefSchema( editBuff.getOptionalLookupDefSchema() );
						break;
					case Replace:
						editTextType = (ICFBamTextTypeEditObj)origTextType.beginEdit();
						editTextType.deleteInstance();
						editTextType = null;
						origTextType = null;
						editTextType = editBuff;
						break;

...
// Description: Java 11 XML SAX Element Handler for EnumDef
 ...
 *	for EnumDef.
 */
public class CFBamSaxLoaderEnumDef
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderEnumDef( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamEnumDefObj origEnumDef = (ICFBamEnumDefObj)schemaObj.getEnumDefTableObj().readEnumDefByUNameIdx( refTenant.getRequiredId(),
			...
			if( origEnumDef == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editEnumDef.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );

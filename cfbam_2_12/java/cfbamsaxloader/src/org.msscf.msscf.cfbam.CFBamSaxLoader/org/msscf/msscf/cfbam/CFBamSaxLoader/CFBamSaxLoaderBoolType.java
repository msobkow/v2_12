...
// Description: Java 11 XML SAX Element Handler for BoolType
 ...
 *	for BoolType.
 */
public class CFBamSaxLoaderBoolType
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderBoolType( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamBoolTypeObj origBoolType = (ICFBamBoolTypeObj)schemaObj.getBoolTypeTableObj().readBoolTypeByUNameIdx( refTenant.getRequiredId(),
			...
			if( origBoolType == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editBoolType.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );

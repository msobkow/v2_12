...
// Description: Java 11 XML SAX Element Handler for TZTimestampCol
 ...
 *	for TZTimestampCol.
 */
public class CFBamSaxLoaderTZTimestampCol
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderTZTimestampCol( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamTZTimestampColObj origTZTimestampCol = (ICFBamTZTimestampColObj)schemaObj.getTZTimestampColTableObj().readTZTimestampColByUNameIdx( refTenant.getRequiredId(),
			...
			if( origTZTimestampCol == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editTZTimestampCol.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						...
						editTZTimestampCol.setOptionalDummy( editBuff.getOptionalDummy() );

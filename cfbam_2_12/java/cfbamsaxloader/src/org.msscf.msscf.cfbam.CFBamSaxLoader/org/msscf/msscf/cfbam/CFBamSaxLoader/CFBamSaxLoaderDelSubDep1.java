...
// Description: Java 11 XML SAX Element Handler for DelSubDep1
 ...
 *	for DelSubDep1.
 */
public class CFBamSaxLoaderDelSubDep1
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderDelSubDep1( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamDelTopDepObj refDelTopDep = null;
			...
			if( scopeObj == null ) {
				...
				refDelTopDep = (ICFBamDelTopDepObj) scopeObj;
				editBuff.setRequiredContainerDelTopDep( refDelTopDep );

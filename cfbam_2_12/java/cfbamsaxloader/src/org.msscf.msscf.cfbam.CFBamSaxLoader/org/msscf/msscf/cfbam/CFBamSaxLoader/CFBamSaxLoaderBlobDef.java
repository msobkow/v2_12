...
// Description: Java 11 XML SAX Element Handler for BlobDef
 ...
 *	for BlobDef.
 */
public class CFBamSaxLoaderBlobDef
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderBlobDef( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamBlobDefObj origBlobDef = (ICFBamBlobDefObj)schemaObj.getBlobDefTableObj().readBlobDefByUNameIdx( refTenant.getRequiredId(),
			...
			if( origBlobDef == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editBlobDef.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );

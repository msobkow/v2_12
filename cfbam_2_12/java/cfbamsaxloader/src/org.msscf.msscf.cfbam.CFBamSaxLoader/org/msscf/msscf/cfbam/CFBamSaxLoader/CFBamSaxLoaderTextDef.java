...
// Description: Java 11 XML SAX Element Handler for TextDef
 ...
 *	for TextDef.
 */
public class CFBamSaxLoaderTextDef
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderTextDef( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamTextDefObj origTextDef = (ICFBamTextDefObj)schemaObj.getTextDefTableObj().readTextDefByUNameIdx( refTenant.getRequiredId(),
			...
			if( origTextDef == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editTextDef.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						...
						editTextDef.setOptionalXmlElementName( editBuff.getOptionalXmlElementName() );
						editTextDef.setOptionalLookupDefSchema( editBuff.getOptionalLookupDefSchema() );
						break;
					case Replace:
						editTextDef = (ICFBamTextDefEditObj)origTextDef.beginEdit();
						editTextDef.deleteInstance();
						editTextDef = null;
						origTextDef = null;
						editTextDef = editBuff;
						break;

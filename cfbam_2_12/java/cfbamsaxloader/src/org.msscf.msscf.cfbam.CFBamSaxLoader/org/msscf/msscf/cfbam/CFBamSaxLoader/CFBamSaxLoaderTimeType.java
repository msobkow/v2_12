...
// Description: Java 11 XML SAX Element Handler for TimeType
 ...
 *	for TimeType.
 */
public class CFBamSaxLoaderTimeType
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderTimeType( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamTimeTypeObj origTimeType = (ICFBamTimeTypeObj)schemaObj.getTimeTypeTableObj().readTimeTypeByUNameIdx( refTenant.getRequiredId(),
			...
			if( origTimeType == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editTimeType.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						...
						editTimeType.setOptionalDummy( editBuff.getOptionalDummy() );
						editTimeType.setOptionalLookupDefSchema( editBuff.getOptionalLookupDefSchema() );
						break;
					case Replace:
						editTimeType = (ICFBamTimeTypeEditObj)origTimeType.beginEdit();
						editTimeType.deleteInstance();
						editTimeType = null;
						origTimeType = null;
						editTimeType = editBuff;
						break;

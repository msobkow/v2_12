...
// Description: Java 11 XML SAX Element Handler for TimestampCol
 ...
 *	for TimestampCol.
 */
public class CFBamSaxLoaderTimestampCol
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderTimestampCol( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamTimestampColObj origTimestampCol = (ICFBamTimestampColObj)schemaObj.getTimestampColTableObj().readTimestampColByUNameIdx( refTenant.getRequiredId(),
			...
			if( origTimestampCol == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editTimestampCol.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						...
						editTimestampCol.setOptionalDummy( editBuff.getOptionalDummy() );
						editTimestampCol.setOptionalLookupDefSchema( editBuff.getOptionalLookupDefSchema() );
						break;
					case Replace:
						editTimestampCol = (ICFBamTimestampColEditObj)origTimestampCol.beginEdit();
						editTimestampCol.deleteInstance();
						editTimestampCol = null;

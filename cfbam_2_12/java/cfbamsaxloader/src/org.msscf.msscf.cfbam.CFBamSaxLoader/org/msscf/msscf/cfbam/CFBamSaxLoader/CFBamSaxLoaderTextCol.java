...
// Description: Java 11 XML SAX Element Handler for TextCol
 ...
 *	for TextCol.
 */
public class CFBamSaxLoaderTextCol
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderTextCol( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamTextColObj origTextCol = (ICFBamTextColObj)schemaObj.getTextColTableObj().readTextColByUNameIdx( refTenant.getRequiredId(),
			...
			if( origTextCol == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editTextCol.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						...
						editTextCol.setOptionalXmlElementName( editBuff.getOptionalXmlElementName() );
						editTextCol.setOptionalLookupDefSchema( editBuff.getOptionalLookupDefSchema() );
						break;
					case Replace:
						editTextCol = (ICFBamTextColEditObj)origTextCol.beginEdit();
						editTextCol.deleteInstance();
						editTextCol = null;
						origTextCol = null;
						editTextCol = editBuff;
						break;

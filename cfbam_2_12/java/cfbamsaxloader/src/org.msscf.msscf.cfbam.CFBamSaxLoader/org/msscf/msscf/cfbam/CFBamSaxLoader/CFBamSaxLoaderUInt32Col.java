...
// Description: Java 11 XML SAX Element Handler for UInt32Col
 ...
 *	for UInt32Col.
 */
public class CFBamSaxLoaderUInt32Col
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderUInt32Col( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamUInt32ColObj origUInt32Col = (ICFBamUInt32ColObj)schemaObj.getUInt32ColTableObj().readUInt32ColByUNameIdx( refTenant.getRequiredId(),
			...
			if( origUInt32Col == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editUInt32Col.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );

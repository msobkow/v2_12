...
// Description: Java 11 XML SAX Element Handler for StringType
 ...
 *	for StringType.
 */
public class CFBamSaxLoaderStringType
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderStringType( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamStringTypeObj origStringType = (ICFBamStringTypeObj)schemaObj.getStringTypeTableObj().readStringTypeByUNameIdx( refTenant.getRequiredId(),
			...
			if( origStringType == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editStringType.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );

...
// Description: Java 11 XML SAX Element Handler for DoubleCol
 ...
 *	for DoubleCol.
 */
public class CFBamSaxLoaderDoubleCol
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderDoubleCol( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamDoubleColObj origDoubleCol = (ICFBamDoubleColObj)schemaObj.getDoubleColTableObj().readDoubleColByUNameIdx( refTenant.getRequiredId(),
			...
			if( origDoubleCol == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editDoubleCol.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );

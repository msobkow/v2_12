 ...
 *	for SubProject.
 */
public class CFBamSaxLoaderSubProject
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderSubProject( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamTopProjectObj refParentTPrj = null;
			...
			if( scopeObj == null ) {
				...
				refParentTPrj = (ICFBamTopProjectObj) scopeObj;
			...
			ICFBamSubProjectObj origSubProject = (ICFBamSubProjectObj)schemaObj.getSubProjectTableObj().readSubProjectByNameIdx( refTenant.getRequiredId(),

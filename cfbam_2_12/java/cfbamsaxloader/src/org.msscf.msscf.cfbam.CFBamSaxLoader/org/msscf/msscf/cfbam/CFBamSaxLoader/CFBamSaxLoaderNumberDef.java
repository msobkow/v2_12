...
// Description: Java 11 XML SAX Element Handler for NumberDef
 ...
 *	for NumberDef.
 */
public class CFBamSaxLoaderNumberDef
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderNumberDef( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamNumberDefObj origNumberDef = (ICFBamNumberDefObj)schemaObj.getNumberDefTableObj().readNumberDefByUNameIdx( refTenant.getRequiredId(),
			...
			if( origNumberDef == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editNumberDef.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );

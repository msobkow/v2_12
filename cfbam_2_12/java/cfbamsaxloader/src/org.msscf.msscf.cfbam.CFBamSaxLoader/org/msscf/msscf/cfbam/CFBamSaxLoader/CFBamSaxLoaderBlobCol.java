...
// Description: Java 11 XML SAX Element Handler for BlobCol
 ...
 *	for BlobCol.
 */
public class CFBamSaxLoaderBlobCol
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderBlobCol( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamBlobColObj origBlobCol = (ICFBamBlobColObj)schemaObj.getBlobColTableObj().readBlobColByUNameIdx( refTenant.getRequiredId(),
			...
			if( origBlobCol == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editBlobCol.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );

...
// Description: Java 11 XML SAX Element Handler for UuidDef
 ...
 *	for UuidDef.
 */
public class CFBamSaxLoaderUuidDef
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderUuidDef( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamUuidDefObj origUuidDef = (ICFBamUuidDefObj)schemaObj.getUuidDefTableObj().readUuidDefByUNameIdx( refTenant.getRequiredId(),
			...
			if( origUuidDef == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editUuidDef.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );

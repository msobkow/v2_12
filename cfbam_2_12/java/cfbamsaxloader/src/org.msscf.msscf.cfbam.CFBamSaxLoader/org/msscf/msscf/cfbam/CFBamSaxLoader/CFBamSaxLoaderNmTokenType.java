...
// Description: Java 11 XML SAX Element Handler for NmTokenType
 ...
 *	for NmTokenType.
 */
public class CFBamSaxLoaderNmTokenType
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderNmTokenType( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamNmTokenTypeObj origNmTokenType = (ICFBamNmTokenTypeObj)schemaObj.getNmTokenTypeTableObj().readNmTokenTypeByUNameIdx( refTenant.getRequiredId(),
			...
			if( origNmTokenType == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editNmTokenType.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
					...
					case Replace:
						editNmTokenType = (ICFBamNmTokenTypeEditObj)origNmTokenType.beginEdit();
						editNmTokenType.deleteInstance();
						editNmTokenType = null;

...
// Description: Java 11 XML SAX Element Handler for StringCol
 ...
 *	for StringCol.
 */
public class CFBamSaxLoaderStringCol
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderStringCol( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamStringColObj origStringCol = (ICFBamStringColObj)schemaObj.getStringColTableObj().readStringColByUNameIdx( refTenant.getRequiredId(),
			...
			if( origStringCol == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editStringCol.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );

...
// Description: Java 11 XML SAX Element Handler for NmTokensDef
 ...
 *	for NmTokensDef.
 */
public class CFBamSaxLoaderNmTokensDef
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderNmTokensDef( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamNmTokensDefObj origNmTokensDef = (ICFBamNmTokensDefObj)schemaObj.getNmTokensDefTableObj().readNmTokensDefByUNameIdx( refTenant.getRequiredId(),
			...
			if( origNmTokensDef == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editNmTokensDef.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
					...
					case Replace:
						editNmTokensDef = (ICFBamNmTokensDefEditObj)origNmTokensDef.beginEdit();
						editNmTokensDef.deleteInstance();
						editNmTokensDef = null;

...
// Description: Java 11 XML SAX Element Handler for TZDateDef
 ...
 *	for TZDateDef.
 */
public class CFBamSaxLoaderTZDateDef
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderTZDateDef( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamTZDateDefObj origTZDateDef = (ICFBamTZDateDefObj)schemaObj.getTZDateDefTableObj().readTZDateDefByUNameIdx( refTenant.getRequiredId(),
			...
			if( origTZDateDef == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editTZDateDef.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						...
						editTZDateDef.setOptionalDummy( editBuff.getOptionalDummy() );
						editTZDateDef.setOptionalLookupDefSchema( editBuff.getOptionalLookupDefSchema() );
						break;
					case Replace:
						editTZDateDef = (ICFBamTZDateDefEditObj)origTZDateDef.beginEdit();
						editTZDateDef.deleteInstance();
						editTZDateDef = null;
						origTZDateDef = null;
						editTZDateDef = editBuff;
						break;

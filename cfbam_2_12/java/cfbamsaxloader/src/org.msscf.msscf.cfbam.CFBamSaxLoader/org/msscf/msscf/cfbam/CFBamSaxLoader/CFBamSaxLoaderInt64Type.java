...
// Description: Java 11 XML SAX Element Handler for Int64Type
 ...
 *	for Int64Type.
 */
public class CFBamSaxLoaderInt64Type
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderInt64Type( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamInt64TypeObj origInt64Type = (ICFBamInt64TypeObj)schemaObj.getInt64TypeTableObj().readInt64TypeByUNameIdx( refTenant.getRequiredId(),
			...
			if( origInt64Type == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editInt64Type.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );

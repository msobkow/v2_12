...
// Description: Java 11 XML SAX Element Handler for UInt16Col
 ...
 *	for UInt16Col.
 */
public class CFBamSaxLoaderUInt16Col
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderUInt16Col( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamUInt16ColObj origUInt16Col = (ICFBamUInt16ColObj)schemaObj.getUInt16ColTableObj().readUInt16ColByUNameIdx( refTenant.getRequiredId(),
			...
			if( origUInt16Col == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editUInt16Col.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );

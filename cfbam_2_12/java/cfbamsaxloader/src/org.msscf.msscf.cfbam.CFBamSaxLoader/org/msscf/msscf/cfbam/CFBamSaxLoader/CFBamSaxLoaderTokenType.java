...
// Description: Java 11 XML SAX Element Handler for TokenType
 ...
 *	for TokenType.
 */
public class CFBamSaxLoaderTokenType
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderTokenType( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamTokenTypeObj origTokenType = (ICFBamTokenTypeObj)schemaObj.getTokenTypeTableObj().readTokenTypeByUNameIdx( refTenant.getRequiredId(),
			...
			if( origTokenType == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editTokenType.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );

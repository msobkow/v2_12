...
// Description: Java 11 XML SAX Element Handler for Int16Def
 ...
 *	for Int16Def.
 */
public class CFBamSaxLoaderInt16Def
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderInt16Def( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamInt16DefObj origInt16Def = (ICFBamInt16DefObj)schemaObj.getInt16DefTableObj().readInt16DefByUNameIdx( refTenant.getRequiredId(),
			...
			if( origInt16Def == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editInt16Def.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );

...
// Description: Java 11 XML SAX Element Handler for NumberCol
 ...
 *	for NumberCol.
 */
public class CFBamSaxLoaderNumberCol
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderNumberCol( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamNumberColObj origNumberCol = (ICFBamNumberColObj)schemaObj.getNumberColTableObj().readNumberColByUNameIdx( refTenant.getRequiredId(),
			...
			if( origNumberCol == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editNumberCol.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );

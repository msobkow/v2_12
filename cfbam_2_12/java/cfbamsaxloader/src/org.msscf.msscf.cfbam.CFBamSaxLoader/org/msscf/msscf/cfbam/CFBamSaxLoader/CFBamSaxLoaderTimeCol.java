...
// Description: Java 11 XML SAX Element Handler for TimeCol
 ...
 *	for TimeCol.
 */
public class CFBamSaxLoaderTimeCol
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderTimeCol( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamTimeColObj origTimeCol = (ICFBamTimeColObj)schemaObj.getTimeColTableObj().readTimeColByUNameIdx( refTenant.getRequiredId(),
			...
			if( origTimeCol == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editTimeCol.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						...
						editTimeCol.setOptionalDummy( editBuff.getOptionalDummy() );
						editTimeCol.setOptionalLookupDefSchema( editBuff.getOptionalLookupDefSchema() );
						break;
					case Replace:
						editTimeCol = (ICFBamTimeColEditObj)origTimeCol.beginEdit();
						editTimeCol.deleteInstance();
						editTimeCol = null;
						origTimeCol = null;
						editTimeCol = editBuff;
						break;

...
// Description: Java 11 XML SAX Element Handler for TokenDef
 ...
 *	for TokenDef.
 */
public class CFBamSaxLoaderTokenDef
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderTokenDef( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamTokenDefObj origTokenDef = (ICFBamTokenDefObj)schemaObj.getTokenDefTableObj().readTokenDefByUNameIdx( refTenant.getRequiredId(),
			...
			if( origTokenDef == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editTokenDef.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );

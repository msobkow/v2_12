...
// Description: Java 11 XML SAX Element Handler for ServerObjFunc
	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		try {
			...
			ICFBamServerObjFuncObj origServerObjFunc = (ICFBamServerObjFuncObj)schemaObj.getServerObjFuncTableObj().readServerObjFuncByUNameIdx( refForTable.getRequiredTenantId(),
			...
			if( origServerObjFunc == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editServerObjFunc.setRequiredIsClientMethod( editBuff.getRequiredIsClientMethod() );

...
// Description: Java 11 XML SAX Element Handler for UInt64Col
 ...
 *	for UInt64Col.
 */
public class CFBamSaxLoaderUInt64Col
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderUInt64Col( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamUInt64ColObj origUInt64Col = (ICFBamUInt64ColObj)schemaObj.getUInt64ColTableObj().readUInt64ColByUNameIdx( refTenant.getRequiredId(),
			...
			if( origUInt64Col == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editUInt64Col.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );

...
// Description: Java 11 XML SAX Element Handler for UuidGen
 ...
 *	for UuidGen.
 */
public class CFBamSaxLoaderUuidGen
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderUuidGen( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
			...
			if( origUuidGen == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editUuidGen.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );

...
// Description: Java 11 XML SAX Element Handler for TZTimestampType
 ...
 *	for TZTimestampType.
 */
public class CFBamSaxLoaderTZTimestampType
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderTZTimestampType( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamTZTimestampTypeObj origTZTimestampType = (ICFBamTZTimestampTypeObj)schemaObj.getTZTimestampTypeTableObj().readTZTimestampTypeByUNameIdx( refTenant.getRequiredId(),
			...
			if( origTZTimestampType == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editTZTimestampType.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						...
						editTZTimestampType.setOptionalDummy( editBuff.getOptionalDummy() );
						editTZTimestampType.setOptionalLookupDefSchema( editBuff.getOptionalLookupDefSchema() );
						break;
					case Replace:
						editTZTimestampType = (ICFBamTZTimestampTypeEditObj)origTZTimestampType.beginEdit();
						editTZTimestampType.deleteInstance();
						editTZTimestampType = null;

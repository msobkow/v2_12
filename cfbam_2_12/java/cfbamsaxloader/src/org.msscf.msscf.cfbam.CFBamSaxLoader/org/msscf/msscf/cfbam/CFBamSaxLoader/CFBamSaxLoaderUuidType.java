...
// Description: Java 11 XML SAX Element Handler for UuidType
 ...
 *	for UuidType.
 */
public class CFBamSaxLoaderUuidType
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderUuidType( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamUuidTypeObj origUuidType = (ICFBamUuidTypeObj)schemaObj.getUuidTypeTableObj().readUuidTypeByUNameIdx( refTenant.getRequiredId(),
			...
			if( origUuidType == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editUuidType.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );

...
// Description: Java 11 XML SAX Element Handler for PopSubDep3
 ...
 *	for PopSubDep3.
 */
public class CFBamSaxLoaderPopSubDep3
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderPopSubDep3( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamPopSubDep2Obj refPopSubDep2 = null;
			...
			if( scopeObj == null ) {
				...
				refPopSubDep2 = (ICFBamPopSubDep2Obj) scopeObj;
				editBuff.setRequiredContainerPopSubDep2( refPopSubDep2 );

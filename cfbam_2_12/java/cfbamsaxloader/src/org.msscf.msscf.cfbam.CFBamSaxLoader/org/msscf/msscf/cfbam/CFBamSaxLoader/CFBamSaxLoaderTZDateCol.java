...
// Description: Java 11 XML SAX Element Handler for TZDateCol
 ...
 *	for TZDateCol.
 */
public class CFBamSaxLoaderTZDateCol
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderTZDateCol( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamTZDateColObj origTZDateCol = (ICFBamTZDateColObj)schemaObj.getTZDateColTableObj().readTZDateColByUNameIdx( refTenant.getRequiredId(),
			...
			if( origTZDateCol == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editTZDateCol.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						...
						editTZDateCol.setOptionalDummy( editBuff.getOptionalDummy() );
						editTZDateCol.setOptionalLookupDefSchema( editBuff.getOptionalLookupDefSchema() );
						break;
					case Replace:
						editTZDateCol = (ICFBamTZDateColEditObj)origTZDateCol.beginEdit();
						editTZDateCol.deleteInstance();
						editTZDateCol = null;
						origTZDateCol = null;
						editTZDateCol = editBuff;
						break;

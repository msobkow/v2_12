...
// Description: Java 11 XML SAX Element Handler for DateType
 ...
 *	for DateType.
 */
public class CFBamSaxLoaderDateType
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderDateType( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamDateTypeObj origDateType = (ICFBamDateTypeObj)schemaObj.getDateTypeTableObj().readDateTypeByUNameIdx( refTenant.getRequiredId(),
			...
			if( origDateType == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editDateType.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						...
						editDateType.setOptionalDummy( editBuff.getOptionalDummy() );
						editDateType.setOptionalLookupDefSchema( editBuff.getOptionalLookupDefSchema() );
						break;
					case Replace:
						editDateType = (ICFBamDateTypeEditObj)origDateType.beginEdit();
						editDateType.deleteInstance();
						editDateType = null;
						origDateType = null;
						editDateType = editBuff;
						break;

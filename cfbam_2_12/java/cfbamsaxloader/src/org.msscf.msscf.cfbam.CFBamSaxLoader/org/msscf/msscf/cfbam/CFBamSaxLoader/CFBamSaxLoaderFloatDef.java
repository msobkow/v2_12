...
// Description: Java 11 XML SAX Element Handler for FloatDef
 ...
 *	for FloatDef.
 */
public class CFBamSaxLoaderFloatDef
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderFloatDef( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamFloatDefObj origFloatDef = (ICFBamFloatDefObj)schemaObj.getFloatDefTableObj().readFloatDefByUNameIdx( refTenant.getRequiredId(),
			...
			if( origFloatDef == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editFloatDef.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );

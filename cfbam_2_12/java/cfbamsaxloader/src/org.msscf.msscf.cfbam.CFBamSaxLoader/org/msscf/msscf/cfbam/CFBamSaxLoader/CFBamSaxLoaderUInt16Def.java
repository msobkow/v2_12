...
// Description: Java 11 XML SAX Element Handler for UInt16Def
 ...
 *	for UInt16Def.
 */
public class CFBamSaxLoaderUInt16Def
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderUInt16Def( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamUInt16DefObj origUInt16Def = (ICFBamUInt16DefObj)schemaObj.getUInt16DefTableObj().readUInt16DefByUNameIdx( refTenant.getRequiredId(),
			...
			if( origUInt16Def == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editUInt16Def.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );

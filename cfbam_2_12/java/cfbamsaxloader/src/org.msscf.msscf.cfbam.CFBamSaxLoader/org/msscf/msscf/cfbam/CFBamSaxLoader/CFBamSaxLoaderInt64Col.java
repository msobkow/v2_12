...
// Description: Java 11 XML SAX Element Handler for Int64Col
 ...
 *	for Int64Col.
 */
public class CFBamSaxLoaderInt64Col
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderInt64Col( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamInt64ColObj origInt64Col = (ICFBamInt64ColObj)schemaObj.getInt64ColTableObj().readInt64ColByUNameIdx( refTenant.getRequiredId(),
			...
			if( origInt64Col == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editInt64Col.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );

...
// Description: Java 11 XML SAX Element Handler for Atom
 ...
 *	for Atom.
 */
public class CFBamSaxLoaderAtom
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderAtom( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamAtomObj origAtom = (ICFBamAtomObj)schemaObj.getAtomTableObj().readAtomByUNameIdx( refTenant.getRequiredId(),
			...
			if( origAtom == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editAtom.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );

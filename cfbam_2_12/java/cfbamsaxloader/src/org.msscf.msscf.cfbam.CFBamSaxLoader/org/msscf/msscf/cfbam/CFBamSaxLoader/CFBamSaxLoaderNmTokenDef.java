...
// Description: Java 11 XML SAX Element Handler for NmTokenDef
 ...
 *	for NmTokenDef.
 */
public class CFBamSaxLoaderNmTokenDef
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderNmTokenDef( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamNmTokenDefObj origNmTokenDef = (ICFBamNmTokenDefObj)schemaObj.getNmTokenDefTableObj().readNmTokenDefByUNameIdx( refTenant.getRequiredId(),
			...
			if( origNmTokenDef == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editNmTokenDef.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );

...
// Description: Java 11 XML SAX Element Handler for FloatCol
 ...
 *	for FloatCol.
 */
public class CFBamSaxLoaderFloatCol
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderFloatCol( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamFloatColObj origFloatCol = (ICFBamFloatColObj)schemaObj.getFloatColTableObj().readFloatColByUNameIdx( refTenant.getRequiredId(),
			...
			if( origFloatCol == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editFloatCol.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );

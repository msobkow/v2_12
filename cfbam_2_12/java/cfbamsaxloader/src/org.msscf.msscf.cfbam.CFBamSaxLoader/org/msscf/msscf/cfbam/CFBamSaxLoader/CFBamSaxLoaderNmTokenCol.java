...
// Description: Java 11 XML SAX Element Handler for NmTokenCol
 ...
 *	for NmTokenCol.
 */
public class CFBamSaxLoaderNmTokenCol
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderNmTokenCol( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamNmTokenColObj origNmTokenCol = (ICFBamNmTokenColObj)schemaObj.getNmTokenColTableObj().readNmTokenColByUNameIdx( refTenant.getRequiredId(),
			...
			if( origNmTokenCol == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editNmTokenCol.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );

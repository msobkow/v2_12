...
// Description: Java 11 XML SAX Element Handler for DelSubDep3
 ...
 *	for DelSubDep3.
 */
public class CFBamSaxLoaderDelSubDep3
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderDelSubDep3( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamDelSubDep2Obj refDelSubDep2 = null;
			...
			if( scopeObj == null ) {
				...
				refDelSubDep2 = (ICFBamDelSubDep2Obj) scopeObj;
				editBuff.setRequiredContainerDelSubDep2( refDelSubDep2 );

...
// Description: Java 11 XML SAX Element Handler for UuidCol
 ...
 *	for UuidCol.
 */
public class CFBamSaxLoaderUuidCol
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderUuidCol( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamUuidColObj origUuidCol = (ICFBamUuidColObj)schemaObj.getUuidColTableObj().readUuidColByUNameIdx( refTenant.getRequiredId(),
			...
			if( origUuidCol == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editUuidCol.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );

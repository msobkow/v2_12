 ...
 *	for License.
 */
public class CFBamSaxLoaderLicense
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderLicense( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamLicenseObj origLicense = (ICFBamLicenseObj)schemaObj.getLicenseTableObj().readLicenseByUNameIdx( refTenant.getRequiredId(),

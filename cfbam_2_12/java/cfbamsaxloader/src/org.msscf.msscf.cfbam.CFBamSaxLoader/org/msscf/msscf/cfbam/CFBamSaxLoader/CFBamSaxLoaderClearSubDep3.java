...
// Description: Java 11 XML SAX Element Handler for ClearSubDep3
 ...
 *	for ClearSubDep3.
 */
public class CFBamSaxLoaderClearSubDep3
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderClearSubDep3( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamClearSubDep2Obj refClearSubDep2 = null;
			...
			if( scopeObj == null ) {
				...
				refClearSubDep2 = (ICFBamClearSubDep2Obj) scopeObj;
				editBuff.setRequiredContainerClearSubDep2( refClearSubDep2 );

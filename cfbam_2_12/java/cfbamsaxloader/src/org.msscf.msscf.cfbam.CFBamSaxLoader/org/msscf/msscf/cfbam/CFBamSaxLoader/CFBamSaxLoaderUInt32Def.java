...
// Description: Java 11 XML SAX Element Handler for UInt32Def
 ...
 *	for UInt32Def.
 */
public class CFBamSaxLoaderUInt32Def
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderUInt32Def( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamUInt32DefObj origUInt32Def = (ICFBamUInt32DefObj)schemaObj.getUInt32DefTableObj().readUInt32DefByUNameIdx( refTenant.getRequiredId(),
			...
			if( origUInt32Def == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editUInt32Def.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );

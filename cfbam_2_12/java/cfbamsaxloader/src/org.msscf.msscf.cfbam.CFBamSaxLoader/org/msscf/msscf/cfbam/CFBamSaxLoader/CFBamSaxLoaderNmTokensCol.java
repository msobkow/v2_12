...
// Description: Java 11 XML SAX Element Handler for NmTokensCol
 ...
 *	for NmTokensCol.
 */
public class CFBamSaxLoaderNmTokensCol
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderNmTokensCol( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamNmTokensColObj origNmTokensCol = (ICFBamNmTokensColObj)schemaObj.getNmTokensColTableObj().readNmTokensColByUNameIdx( refTenant.getRequiredId(),
			...
			if( origNmTokensCol == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editNmTokensCol.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
					...
					case Replace:
						editNmTokensCol = (ICFBamNmTokensColEditObj)origNmTokensCol.beginEdit();
						editNmTokensCol.deleteInstance();
						editNmTokensCol = null;

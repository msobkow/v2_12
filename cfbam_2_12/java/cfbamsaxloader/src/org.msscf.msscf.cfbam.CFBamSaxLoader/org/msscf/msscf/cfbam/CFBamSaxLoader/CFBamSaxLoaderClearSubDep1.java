...
// Description: Java 11 XML SAX Element Handler for ClearSubDep1
 ...
 *	for ClearSubDep1.
 */
public class CFBamSaxLoaderClearSubDep1
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderClearSubDep1( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamClearTopDepObj refClearTopDep = null;
			...
			if( scopeObj == null ) {
				...
				refClearTopDep = (ICFBamClearTopDepObj) scopeObj;

...
// Description: Java 11 XML SAX Element Handler for TZTimestampDef
 ...
 *	for TZTimestampDef.
 */
public class CFBamSaxLoaderTZTimestampDef
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderTZTimestampDef( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamTZTimestampDefObj origTZTimestampDef = (ICFBamTZTimestampDefObj)schemaObj.getTZTimestampDefTableObj().readTZTimestampDefByUNameIdx( refTenant.getRequiredId(),
			...
			if( origTZTimestampDef == null ) {
				...
				switch( loaderBehaviour ) {
					...
					case Update:
						...
						editTZTimestampDef.setOptionalDefaultXmlValue( editBuff.getOptionalDefaultXmlValue() );
						...
						editTZTimestampDef.setOptionalDummy( editBuff.getOptionalDummy() );
						editTZTimestampDef.setOptionalLookupDefSchema( editBuff.getOptionalLookupDefSchema() );
						break;
					case Replace:
						editTZTimestampDef = (ICFBamTZTimestampDefEditObj)origTZTimestampDef.beginEdit();
						editTZTimestampDef.deleteInstance();
						editTZTimestampDef = null;

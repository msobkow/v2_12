...
// Description: Java 11 XML SAX Element Handler for ClearSubDep2
 ...
 *	for ClearSubDep2.
 */
public class CFBamSaxLoaderClearSubDep2
	extends CFLibXmlCoreElementHandler
{
	public CFBamSaxLoaderClearSubDep2( CFBamSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamClearSubDep1Obj refClearSubDep1 = null;
			...
			if( scopeObj == null ) {
				...
				refClearSubDep1 = (ICFBamClearSubDep1Obj) scopeObj;
				editBuff.setRequiredContainerClearSubDep1( refClearSubDep1 );

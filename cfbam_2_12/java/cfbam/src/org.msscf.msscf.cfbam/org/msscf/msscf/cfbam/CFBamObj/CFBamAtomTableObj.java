	...
	implements ICFBamAtomTableObj
{
		...
		String Name )
	{
		...
		Iterator<ICFBamAtomObj> iter = toForget.iterator();
		while( iter.hasNext() ) {
			cur = iter.next();
			cur.forget( true );
		}
	...
	public void forgetAtomByValTentIdx( long TenantId )
	{
		...
		if( indexByValTentIdx.containsKey( key ) ) {
			...
			if( mapValTentIdx != null ) {
				Iterator<ICFBamAtomObj> iterDup = mapValTentIdx.values().iterator();
			...
			Iterator<ICFBamAtomObj> memberIter = members.values().iterator();
		...
		long ScopeId )
	{
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			...
			if( mapScopeIdx != null ) {
				Iterator<ICFBamAtomObj> iterDup = mapScopeIdx.values().iterator();
				while( iterDup.hasNext() ) {
					cur = iterDup.next();
					toForget.add( cur );
				}
		...
		Long DefSchemaId )
	{
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			...
			if( mapDefSchemaIdx != null ) {
				Iterator<ICFBamAtomObj> iterDup = mapDefSchemaIdx.values().iterator();
				while( iterDup.hasNext() ) {
					cur = iterDup.next();
					toForget.add( cur );
				}
		...
		Long PrevId )
	{
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			...
			if( mapPrevIdx != null ) {
				Iterator<ICFBamAtomObj> iterDup = mapPrevIdx.values().iterator();
				while( iterDup.hasNext() ) {
					cur = iterDup.next();
					toForget.add( cur );
				}
		...
		Long NextId )
	{
		...
		if( indexByNextIdx.containsKey( key ) ) {
			...
			if( mapNextIdx != null ) {
				Iterator<ICFBamAtomObj> iterDup = mapNextIdx.values().iterator();
				while( iterDup.hasNext() ) {
					cur = iterDup.next();
					toForget.add( cur );
				}
		...
		Long PrevId )
	{
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			...
			if( mapContPrevIdx != null ) {
				Iterator<ICFBamAtomObj> iterDup = mapContPrevIdx.values().iterator();
				while( iterDup.hasNext() ) {
					cur = iterDup.next();
					toForget.add( cur );
				}
		...
		Long NextId )
	{
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			...
			if( mapContNextIdx != null ) {
				Iterator<ICFBamAtomObj> iterDup = mapContNextIdx.values().iterator();
				while( iterDup.hasNext() ) {
					cur = iterDup.next();
					toForget.add( cur );
				}

	...
	implements ICFBamMinorVersionTableObj
{
	...
	public void forgetMinorVersion( ICFIntMinorVersionObj Obj, boolean forgetSubObjects ) {
		...
		if( members.containsKey( pkey ) ) {
			...
			members.remove( pkey );
			if( forgetSubObjects ) {
				((ICFBamSchemaObj)schema).getSchemaDefTableObj().forgetSchemaDefByMinorVersionIdx( keepObj.getRequiredTenantId(),
		...
		long Id )
	{
		...
		CFIntMinorVersionPKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryMinorVersion().newPKey();

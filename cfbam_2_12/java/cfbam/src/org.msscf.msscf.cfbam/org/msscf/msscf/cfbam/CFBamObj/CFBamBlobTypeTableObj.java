	...
	implements ICFBamBlobTypeTableObj
{
		...
		String Name )
	{
		...
		Iterator<ICFBamBlobTypeObj> iter = toForget.iterator();
		while( iter.hasNext() ) {
			cur = iter.next();
			cur.forget( true );
		}
	...
	public void forgetBlobTypeByValTentIdx( long TenantId )
	{
		...
		if( indexByValTentIdx.containsKey( key ) ) {
			...
			if( mapValTentIdx != null ) {
				Iterator<ICFBamBlobTypeObj> iterDup = mapValTentIdx.values().iterator();
			...
			Iterator<ICFBamBlobTypeObj> memberIter = members.values().iterator();
		...
		long ScopeId )
	{
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			...
			if( mapScopeIdx != null ) {
				Iterator<ICFBamBlobTypeObj> iterDup = mapScopeIdx.values().iterator();
				while( iterDup.hasNext() ) {
					cur = iterDup.next();
					toForget.add( cur );
				}
		...
		Long DefSchemaId )
	{
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			...
			if( mapDefSchemaIdx != null ) {
				Iterator<ICFBamBlobTypeObj> iterDup = mapDefSchemaIdx.values().iterator();
				while( iterDup.hasNext() ) {
					cur = iterDup.next();
					toForget.add( cur );
				}
		...
		Long PrevId )
	{
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			...
			if( mapPrevIdx != null ) {
				Iterator<ICFBamBlobTypeObj> iterDup = mapPrevIdx.values().iterator();
				while( iterDup.hasNext() ) {
					cur = iterDup.next();
					toForget.add( cur );
				}
		...
		Long NextId )
	{
		...
		if( indexByNextIdx.containsKey( key ) ) {
			...
			if( mapNextIdx != null ) {
				Iterator<ICFBamBlobTypeObj> iterDup = mapNextIdx.values().iterator();
				while( iterDup.hasNext() ) {
					cur = iterDup.next();
					toForget.add( cur );
				}
		...
		Long PrevId )
	{
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			...
			if( mapContPrevIdx != null ) {
				Iterator<ICFBamBlobTypeObj> iterDup = mapContPrevIdx.values().iterator();
				while( iterDup.hasNext() ) {
					cur = iterDup.next();
					toForget.add( cur );
				}
		...
		Long NextId )
	{
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			...
			if( mapContNextIdx != null ) {
				Iterator<ICFBamBlobTypeObj> iterDup = mapContNextIdx.values().iterator();
				while( iterDup.hasNext() ) {
					cur = iterDup.next();
					toForget.add( cur );
				}
		...
		long SchemaDefId )
	{
		...
		if( indexBySchemaIdx.containsKey( key ) ) {
			...
			if( mapSchemaIdx != null ) {
				Iterator<ICFBamBlobTypeObj> iterDup = mapSchemaIdx.values().iterator();
				while( iterDup.hasNext() ) {
					cur = iterDup.next();
					toForget.add( cur );
				}

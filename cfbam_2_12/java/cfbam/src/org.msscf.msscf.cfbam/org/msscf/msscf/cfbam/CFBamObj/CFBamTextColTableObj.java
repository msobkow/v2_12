	...
	implements ICFBamTextColTableObj
{
		...
		String Name )
	{
		...
		Iterator<ICFBamTextColObj> iter = toForget.iterator();
		while( iter.hasNext() ) {
			cur = iter.next();
			cur.forget( true );
		}
	...
	public void forgetTextColByValTentIdx( long TenantId )
	{
		...
		if( indexByValTentIdx.containsKey( key ) ) {
			...
			if( mapValTentIdx != null ) {
				Iterator<ICFBamTextColObj> iterDup = mapValTentIdx.values().iterator();
			...
			Iterator<ICFBamTextColObj> memberIter = members.values().iterator();
		...
		long ScopeId )
	{
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			...
			if( mapScopeIdx != null ) {
				Iterator<ICFBamTextColObj> iterDup = mapScopeIdx.values().iterator();
				while( iterDup.hasNext() ) {
					cur = iterDup.next();
					toForget.add( cur );
				}
		...
		Long DefSchemaId )
	{
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			...
			if( mapDefSchemaIdx != null ) {
				Iterator<ICFBamTextColObj> iterDup = mapDefSchemaIdx.values().iterator();
				while( iterDup.hasNext() ) {
					cur = iterDup.next();
					toForget.add( cur );
				}
		...
		Long PrevId )
	{
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			...
			if( mapPrevIdx != null ) {
				Iterator<ICFBamTextColObj> iterDup = mapPrevIdx.values().iterator();
				while( iterDup.hasNext() ) {
					cur = iterDup.next();
					toForget.add( cur );
				}
		...
		Long NextId )
	{
		...
		if( indexByNextIdx.containsKey( key ) ) {
			...
			if( mapNextIdx != null ) {
				Iterator<ICFBamTextColObj> iterDup = mapNextIdx.values().iterator();
				while( iterDup.hasNext() ) {
					cur = iterDup.next();
					toForget.add( cur );
				}
		...
		Long PrevId )
	{
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			...
			if( mapContPrevIdx != null ) {
				Iterator<ICFBamTextColObj> iterDup = mapContPrevIdx.values().iterator();
				while( iterDup.hasNext() ) {
					cur = iterDup.next();
					toForget.add( cur );
				}
		...
		Long NextId )
	{
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			...
			if( mapContNextIdx != null ) {
				Iterator<ICFBamTextColObj> iterDup = mapContNextIdx.values().iterator();
				while( iterDup.hasNext() ) {
					cur = iterDup.next();
					toForget.add( cur );
				}
		...
		long TableId )
	{
		...
		if( indexByTableIdx.containsKey( key ) ) {
			...
			if( mapTableIdx != null ) {
				Iterator<ICFBamTextColObj> iterDup = mapTableIdx.values().iterator();
				while( iterDup.hasNext() ) {
					cur = iterDup.next();
					toForget.add( cur );
				}

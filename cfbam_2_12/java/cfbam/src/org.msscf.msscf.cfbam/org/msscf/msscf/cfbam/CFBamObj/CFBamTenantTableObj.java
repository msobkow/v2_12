	...
	implements ICFBamTenantTableObj
{
	...
	public void forgetTenant( ICFSecTenantObj Obj, boolean forgetSubObjects ) {
		...
		if( members.containsKey( pkey ) ) {
			...
			if( forgetSubObjects ) {
				...
				((ICFBamSchemaObj)schema).getSchemaDefTableObj().forgetSchemaDefByCTenantIdx( keepObj.getRequiredId() );
			}
		}
	}
	...
	public void forgetTenantByIdIdx( long Id )
	{
		...
		CFSecTenantPKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryTenant().newPKey();

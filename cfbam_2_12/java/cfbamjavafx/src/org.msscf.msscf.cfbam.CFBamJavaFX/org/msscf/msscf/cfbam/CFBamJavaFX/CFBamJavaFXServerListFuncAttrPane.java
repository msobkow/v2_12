...
implements ICFBamJavaFXServerListFuncPaneCommon
{
	...
	protected class IsClientMethodCFLabel
		extends CFLabel
	{
		public IsClientMethodCFLabel() {
			super();
			setText( "Is Client Method" );
		}
	}

	protected class IsClientMethodEditor
		extends CFBoolEditor
	{
		public IsClientMethodEditor() {
			super();
			setIsNullable( false );
			setFieldName( "Is Client Method" );
		}
	}
	...
	protected IsClientMethodCFLabel javafxLabelIsClientMethod = null;
	protected IsClientMethodEditor javafxEditorIsClientMethod = null;
	...
	public CFBamJavaFXServerListFuncAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamServerListFuncObj argFocus ) {
		...
		label = getJavaFXLabelIsClientMethod();
		setHalignment( label, HPos.LEFT );
		add( label, 0, gridRow );

		ctrl = getJavaFXEditorIsClientMethod();
		setHalignment( ctrl, HPos.LEFT );
		add( ctrl, 1, gridRow );
	...
	public IsClientMethodCFLabel getJavaFXLabelIsClientMethod() {
		if( javafxLabelIsClientMethod == null ) {
			javafxLabelIsClientMethod = new IsClientMethodCFLabel();
		}
		return( javafxLabelIsClientMethod );
	}

	public void setJavaFXLabelIsClientMethod( IsClientMethodCFLabel value ) {
		javafxLabelIsClientMethod = value;
	}

	public IsClientMethodEditor getJavaFXEditorIsClientMethod() {
		if( javafxEditorIsClientMethod == null ) {
			javafxEditorIsClientMethod = new IsClientMethodEditor();
		}
		return( javafxEditorIsClientMethod );
	}

	public void setJavaFXEditorIsClientMethod( IsClientMethodEditor value ) {
		javafxEditorIsClientMethod = value;
	}
	...
	public void populateFields()
	{
		...
		if( popObj == null ) {
			getJavaFXEditorIsClientMethod().setBooleanValue( null );
		}
		else {
			getJavaFXEditorIsClientMethod().setBooleanValue( popObj.getRequiredIsClientMethod() );
		}
	...
	public void postFields()
	{
		...
		editObj.setRequiredIsClientMethod( getJavaFXEditorIsClientMethod().getBooleanValue() );
	...
	public void adjustComponentEnableStates() {
		...
		if( javafxEditorIsClientMethod != null ) {
			javafxEditorIsClientMethod.setDisable( ! isEditing );
		}
		if( javafxEditorJMethodBody != null ) {

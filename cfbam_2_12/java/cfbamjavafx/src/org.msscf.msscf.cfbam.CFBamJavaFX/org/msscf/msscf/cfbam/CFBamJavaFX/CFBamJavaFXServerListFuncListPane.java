...
implements ICFBamJavaFXServerListFuncPaneList
{
	...
	protected TableColumn<ICFBamServerListFuncObj, Boolean> tableColumnIsClientMethod = null;
		...
		boolean sortByChain )
	{
		...
		tableColumnIsClientMethod = new TableColumn<ICFBamServerListFuncObj,Boolean>( "Is Client Method" );
		tableColumnIsClientMethod.setCellValueFactory( new Callback<CellDataFeatures<ICFBamServerListFuncObj,Boolean>,ObservableValue<Boolean> >() {
			public ObservableValue<Boolean> call( CellDataFeatures<ICFBamServerListFuncObj, Boolean> p ) {
				ICFBamServerMethodObj obj = p.getValue();
				if( obj == null ) {
					return( null );
		...
		tableColumnIsClientMethod.setCellFactory( new Callback<TableColumn<ICFBamServerListFuncObj,Boolean>,TableCell<ICFBamServerListFuncObj,Boolean>>() {
			@Override public TableCell<ICFBamServerListFuncObj,Boolean> call(
				TableColumn<ICFBamServerListFuncObj,Boolean> arg)
			{
				return new CFBoolTableCell<ICFBamServerListFuncObj>();

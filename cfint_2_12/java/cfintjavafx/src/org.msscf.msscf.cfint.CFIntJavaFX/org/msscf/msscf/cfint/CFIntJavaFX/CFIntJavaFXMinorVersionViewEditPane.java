// Description: Java 11 JavaFX View/Edit Pane implementation for MinorVersion.
...
/**
 *	CFIntJavaFXMinorVersionViewEditPane JavaFX View/Edit Pane implementation
 *	for MinorVersion.
 */
public class CFIntJavaFXMinorVersionViewEditPane
extends CFSplitPane
implements ICFIntJavaFXMinorVersionPaneCommon
{
	...
	public CFIntJavaFXMinorVersionViewEditPane( ICFFormManager formManager, ICFIntJavaFXSchema argSchema, ICFIntMinorVersionObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFIntJavaFXMinorVersionPaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}

// Description: Java 11 JavaFX View/Edit Pane implementation for TopDomain.
...
/**
 *	CFIntJavaFXTopDomainViewEditPane JavaFX View/Edit Pane implementation
 *	for TopDomain.
 */
public class CFIntJavaFXTopDomainViewEditPane
extends CFSplitPane
implements ICFIntJavaFXTopDomainPaneCommon
{
	...
	public CFIntJavaFXTopDomainViewEditPane( ICFFormManager formManager, ICFIntJavaFXSchema argSchema, ICFIntTopDomainObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getTopDomainFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFIntJavaFXTopDomainPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFIntJavaFXTopDomainPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFIntJavaFXTopDomainPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}

// Description: Java 11 JavaFX Add Form implementation for SubProject.
...
/**
 *	CFIntJavaFXSubProjectAddForm JavaFX Add Form implementation
 *	for SubProject.
 */
public class CFIntJavaFXSubProjectAddForm
extends CFBorderPane
implements ICFIntJavaFXSubProjectPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add SubProject";
	...
	public CFIntJavaFXSubProjectAddForm( ICFFormManager formManager, ICFIntJavaFXSchema argSchema, ICFIntSubProjectObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getSubProjectFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFIntJavaFXSubProjectPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getSubProjectFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFIntJavaFXSubProjectPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFIntJavaFXSubProjectPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}

// Description: Java 11 JavaFX Add Form implementation for MinorVersion.
...
/**
 *	CFIntJavaFXMinorVersionAddForm JavaFX Add Form implementation
 *	for MinorVersion.
 */
public class CFIntJavaFXMinorVersionAddForm
extends CFBorderPane
implements ICFIntJavaFXMinorVersionPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add MinorVersion";
	...
	public CFIntJavaFXMinorVersionAddForm( ICFFormManager formManager, ICFIntJavaFXSchema argSchema, ICFIntMinorVersionObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getMinorVersionFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFIntJavaFXMinorVersionPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getMinorVersionFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFIntJavaFXMinorVersionPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFIntJavaFXMinorVersionPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}

// Description: Java 11 JavaFX View/Edit Pane implementation for MajorVersion.
...
/**
 *	CFIntJavaFXMajorVersionViewEditPane JavaFX View/Edit Pane implementation
 *	for MajorVersion.
 */
public class CFIntJavaFXMajorVersionViewEditPane
extends CFSplitPane
implements ICFIntJavaFXMajorVersionPaneCommon
{
	...
	public CFIntJavaFXMajorVersionViewEditPane( ICFFormManager formManager, ICFIntJavaFXSchema argSchema, ICFIntMajorVersionObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFIntJavaFXMajorVersionPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFIntJavaFXMajorVersionPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFIntJavaFXMajorVersionPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}

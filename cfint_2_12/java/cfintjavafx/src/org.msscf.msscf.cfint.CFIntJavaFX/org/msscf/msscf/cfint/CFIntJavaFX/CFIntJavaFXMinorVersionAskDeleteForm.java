// Description: Java 11 JavaFX Ask Delete Pane implementation for MinorVersion.
...
/**
 *	CFIntJavaFXMinorVersionAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for MinorVersion.
 */
public class CFIntJavaFXMinorVersionAskDeleteForm
extends CFBorderPane
implements ICFIntJavaFXMinorVersionPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete MinorVersion";
	...
	public CFIntJavaFXMinorVersionAskDeleteForm( ICFFormManager formManager, ICFIntJavaFXSchema argSchema, ICFIntMinorVersionObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this MinorVersion?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFIntMinorVersionObj obj = getJavaFXFocusAsMinorVersion();
					ICFIntMinorVersionEditObj editObj = (ICFIntMinorVersionEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getMinorVersionFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsMinorVersion( ICFIntMinorVersionObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFIntJavaFXMinorVersionPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFIntJavaFXMinorVersionPaneCommon)attrPane).setPaneMode( value );
		}
	}

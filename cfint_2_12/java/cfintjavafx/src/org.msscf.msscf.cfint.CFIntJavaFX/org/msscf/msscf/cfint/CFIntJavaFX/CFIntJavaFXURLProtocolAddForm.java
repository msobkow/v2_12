// Description: Java 11 JavaFX Add Form implementation for URLProtocol.
...
/**
 *	CFIntJavaFXURLProtocolAddForm JavaFX Add Form implementation
 *	for URLProtocol.
 */
public class CFIntJavaFXURLProtocolAddForm
extends CFBorderPane
implements ICFIntJavaFXURLProtocolPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add URL Protocol";
	...
	public CFIntJavaFXURLProtocolAddForm( ICFFormManager formManager, ICFIntJavaFXSchema argSchema, ICFIntURLProtocolObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getURLProtocolFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFIntJavaFXURLProtocolPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getURLProtocolFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFIntJavaFXURLProtocolPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFIntJavaFXURLProtocolPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}

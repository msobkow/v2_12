// Description: Java 11 JavaFX Add Pane implementation for TopDomain.
...
/**
 *	CFIntJavaFXTopDomainAddPane JavaFX Add Pane implementation
 *	for TopDomain.
 */
public class CFIntJavaFXTopDomainAddPane
extends CFSplitPane
implements ICFIntJavaFXTopDomainPaneCommon
{
	...
	public CFIntJavaFXTopDomainAddPane( ICFFormManager formManager, ICFIntJavaFXSchema argSchema, ICFIntTopDomainObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFIntJavaFXTopDomainPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}

// Description: Java 11 JavaFX Add Form implementation for MajorVersion.
...
/**
 *	CFIntJavaFXMajorVersionAddForm JavaFX Add Form implementation
 *	for MajorVersion.
 */
public class CFIntJavaFXMajorVersionAddForm
extends CFBorderPane
implements ICFIntJavaFXMajorVersionPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add MajorVersion";
	...
	public CFIntJavaFXMajorVersionAddForm( ICFFormManager formManager, ICFIntJavaFXSchema argSchema, ICFIntMajorVersionObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getMajorVersionFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFIntJavaFXMajorVersionPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getMajorVersionFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFIntJavaFXMajorVersionPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFIntJavaFXMajorVersionPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}

// Description: Java 11 JavaFX Add Pane implementation for License.
...
/**
 *	CFIntJavaFXLicenseAddPane JavaFX Add Pane implementation
 *	for License.
 */
public class CFIntJavaFXLicenseAddPane
extends CFSplitPane
implements ICFIntJavaFXLicensePaneCommon
{
	...
	public CFIntJavaFXLicenseAddPane( ICFFormManager formManager, ICFIntJavaFXSchema argSchema, ICFIntLicenseObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFIntJavaFXLicensePaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}

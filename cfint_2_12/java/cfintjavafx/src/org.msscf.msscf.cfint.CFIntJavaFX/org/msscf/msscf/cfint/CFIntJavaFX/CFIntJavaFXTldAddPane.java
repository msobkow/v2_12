// Description: Java 11 JavaFX Add Pane implementation for Tld.
...
/**
 *	CFIntJavaFXTldAddPane JavaFX Add Pane implementation
 *	for Tld.
 */
public class CFIntJavaFXTldAddPane
extends CFSplitPane
implements ICFIntJavaFXTldPaneCommon
{
	...
	public CFIntJavaFXTldAddPane( ICFFormManager formManager, ICFIntJavaFXSchema argSchema, ICFIntTldObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFIntJavaFXTldPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}

// Description: Java 11 JavaFX Add Form implementation for Tld.
...
/**
 *	CFIntJavaFXTldAddForm JavaFX Add Form implementation
 *	for Tld.
 */
public class CFIntJavaFXTldAddForm
extends CFBorderPane
implements ICFIntJavaFXTldPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Top Level Domain";
	...
	public CFIntJavaFXTldAddForm( ICFFormManager formManager, ICFIntJavaFXSchema argSchema, ICFIntTldObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getTldFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFIntJavaFXTldPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getTldFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFIntJavaFXTldPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFIntJavaFXTldPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}

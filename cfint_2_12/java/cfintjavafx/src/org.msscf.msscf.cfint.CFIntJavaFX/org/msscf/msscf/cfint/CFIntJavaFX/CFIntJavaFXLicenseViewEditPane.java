// Description: Java 11 JavaFX View/Edit Pane implementation for License.
...
/**
 *	CFIntJavaFXLicenseViewEditPane JavaFX View/Edit Pane implementation
 *	for License.
 */
public class CFIntJavaFXLicenseViewEditPane
extends CFSplitPane
implements ICFIntJavaFXLicensePaneCommon
{
	...
	public CFIntJavaFXLicenseViewEditPane( ICFFormManager formManager, ICFIntJavaFXSchema argSchema, ICFIntLicenseObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFIntJavaFXLicensePaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}

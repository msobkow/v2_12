// Description: Java 11 JavaFX View/Edit Form implementation for TopDomain.
...
/**
 *	CFIntJavaFXTopDomainViewEditForm JavaFX View/Edit Form implementation
 *	for TopDomain.
 */
public class CFIntJavaFXTopDomainViewEditForm
extends CFBorderPane
implements ICFIntJavaFXTopDomainPaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit TopDomain";
	...
	public CFIntJavaFXTopDomainViewEditForm( ICFFormManager formManager, ICFIntJavaFXSchema argSchema, ICFIntTopDomainObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		javafxViewEditPane = argSchema.getTopDomainFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFIntJavaFXTopDomainPaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsTopDomain() != null ) {
							if( null == getJavaFXFocusAsTopDomain().getEdit() ) {
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFIntJavaFXTopDomainPaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFIntJavaFXTopDomainPaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}

// Description: Java 11 JavaFX Ask Delete Pane implementation for URLProtocol.
...
/**
 *	CFIntJavaFXURLProtocolAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for URLProtocol.
 */
public class CFIntJavaFXURLProtocolAskDeleteForm
extends CFBorderPane
implements ICFIntJavaFXURLProtocolPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete URL Protocol";
	...
	public CFIntJavaFXURLProtocolAskDeleteForm( ICFFormManager formManager, ICFIntJavaFXSchema argSchema, ICFIntURLProtocolObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this URL Protocol?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFIntURLProtocolObj obj = getJavaFXFocusAsURLProtocol();
					ICFIntURLProtocolEditObj editObj = (ICFIntURLProtocolEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getURLProtocolFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsURLProtocol( ICFIntURLProtocolObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFIntJavaFXURLProtocolPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFIntJavaFXURLProtocolPaneCommon)attrPane).setPaneMode( value );
		}
	}

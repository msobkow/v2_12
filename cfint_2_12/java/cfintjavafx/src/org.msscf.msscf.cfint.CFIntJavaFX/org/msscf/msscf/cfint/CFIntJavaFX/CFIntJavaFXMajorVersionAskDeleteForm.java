// Description: Java 11 JavaFX Ask Delete Pane implementation for MajorVersion.
...
/**
 *	CFIntJavaFXMajorVersionAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for MajorVersion.
 */
public class CFIntJavaFXMajorVersionAskDeleteForm
extends CFBorderPane
implements ICFIntJavaFXMajorVersionPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete MajorVersion";
	...
	public CFIntJavaFXMajorVersionAskDeleteForm( ICFFormManager formManager, ICFIntJavaFXSchema argSchema, ICFIntMajorVersionObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this MajorVersion?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFIntMajorVersionObj obj = getJavaFXFocusAsMajorVersion();
					ICFIntMajorVersionEditObj editObj = (ICFIntMajorVersionEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsMajorVersion( ICFIntMajorVersionObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFIntJavaFXMajorVersionPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}

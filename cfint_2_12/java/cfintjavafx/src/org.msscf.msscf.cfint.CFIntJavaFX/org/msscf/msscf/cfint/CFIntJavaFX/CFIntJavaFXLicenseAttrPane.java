// Description: Java 11 JavaFX Attribute Pane implementation for License.
...
/**
 *	CFIntJavaFXLicenseAttrPane JavaFX Attribute Pane implementation
 *	for License.
 */
public class CFIntJavaFXLicenseAttrPane
extends CFGridPane
implements ICFIntJavaFXLicensePaneCommon
{
		...
		extends CFInt64Editor
	{
		public IdEditor() {
			super();
			setMinValue( CFIntLicenseBuff.ID_MIN_VALUE );
			setFieldName( "Id" );
		}
	}
	...
	protected class EmbeddedTextCFLabel
		extends CFLabel
	{
		public EmbeddedTextCFLabel() {
			super();
			setText( "EmbeddedText" );
		}
	}

	protected class EmbeddedTextEditor
		extends CFTextEditor
	{
		public EmbeddedTextEditor() {
			super();
			setMaxLen( 8000 );
			setFieldName( "EmbeddedText" );
			setPrefHeight( 5 * 20 );
			setMinHeight( 5 * 20 );
		}
	}

	protected class FullTextCFLabel
		extends CFLabel
	{
		public FullTextCFLabel() {
			super();
			setText( "FullText" );
		}
	}

	protected class FullTextEditor
		extends CFTextEditor
	{
		public FullTextEditor() {
			super();
			setMaxLen( 8000 );
			setFieldName( "FullText" );
			setPrefHeight( 5 * 20 );
			setMinHeight( 5 * 20 );
		}
	}
	...
	protected EmbeddedTextCFLabel javafxLabelEmbeddedText = null;
	protected EmbeddedTextEditor javafxEditorEmbeddedText = null;
	protected FullTextCFLabel javafxLabelFullText = null;
	protected FullTextEditor javafxEditorFullText = null;

	public CFIntJavaFXLicenseAttrPane( ICFFormManager formManager, ICFIntJavaFXSchema argSchema, ICFIntLicenseObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
		...
		setJavaFXFocusAsLicense( argFocus );
		...
		label = getJavaFXLabelEmbeddedText();
		setHalignment( label, HPos.LEFT );
		add( label, 0, gridRow );

		ctrl = getJavaFXEditorEmbeddedText();
		setHalignment( ctrl, HPos.LEFT );
		add( ctrl, 1, gridRow );

		gridRow ++;

		label = getJavaFXLabelFullText();
		setHalignment( label, HPos.LEFT );
		add( label, 0, gridRow );

		ctrl = getJavaFXEditorFullText();
		setHalignment( ctrl, HPos.LEFT );
		add( ctrl, 1, gridRow );
	...
	public ICFIntLicenseObj getEffJavaFXFocus() {
		ICFIntLicenseObj eff = (ICFIntLicenseObj)getJavaFXFocus();
		if( eff != null ) {
			if( null != eff.getEdit() ) {
				eff = (ICFIntLicenseObj)eff.getEdit();
			}
		}
		return( eff );
	}
	...
	public EmbeddedTextCFLabel getJavaFXLabelEmbeddedText() {
		if( javafxLabelEmbeddedText == null ) {
			javafxLabelEmbeddedText = new EmbeddedTextCFLabel();
		}
		return( javafxLabelEmbeddedText );
	}

	public void setJavaFXLabelEmbeddedText( EmbeddedTextCFLabel value ) {
		javafxLabelEmbeddedText = value;
	}

	public EmbeddedTextEditor getJavaFXEditorEmbeddedText() {
		if( javafxEditorEmbeddedText == null ) {
			javafxEditorEmbeddedText = new EmbeddedTextEditor();
		}
		return( javafxEditorEmbeddedText );
	}

	public void setJavaFXEditorEmbeddedText( EmbeddedTextEditor value ) {
		javafxEditorEmbeddedText = value;
	}

	public FullTextCFLabel getJavaFXLabelFullText() {
		if( javafxLabelFullText == null ) {
			javafxLabelFullText = new FullTextCFLabel();
		}
		return( javafxLabelFullText );
	}

	public void setJavaFXLabelFullText( FullTextCFLabel value ) {
		javafxLabelFullText = value;
	}

	public FullTextEditor getJavaFXEditorFullText() {
		if( javafxEditorFullText == null ) {
			javafxEditorFullText = new FullTextEditor();
		}
		return( javafxEditorFullText );
	}

	public void setJavaFXEditorFullText( FullTextEditor value ) {
		javafxEditorFullText = value;
	}

	public void populateFields()
	{
		ICFIntLicenseObj popObj = getEffJavaFXFocus();
		...
		if( popObj == null ) {
			getJavaFXEditorEmbeddedText().setTextValue( null );
		}
		else {
			getJavaFXEditorEmbeddedText().setTextValue( popObj.getOptionalEmbeddedText() );
		}

		if( popObj == null ) {
			getJavaFXEditorFullText().setTextValue( null );
		}
		else {
			getJavaFXEditorFullText().setTextValue( popObj.getOptionalFullText() );
		}
	}
	...
	public void postFields()
	{
		...
		ICFIntLicenseEditObj editObj;
		if( focus != null ) {
			editObj = (ICFIntLicenseEditObj)(focus.getEdit());
		}
		else {
			editObj = null;
		}
		...
		if( ( getJavaFXEditorEmbeddedText().getTextValue() != null ) && ( getJavaFXEditorEmbeddedText().getTextValue().length() <= 0 ) ) {
			editObj.setOptionalEmbeddedText( null );
		}
		else {
			editObj.setOptionalEmbeddedText( getJavaFXEditorEmbeddedText().getTextValue() );
		}

		if( ( getJavaFXEditorFullText().getTextValue() != null ) && ( getJavaFXEditorFullText().getTextValue().length() <= 0 ) ) {
			editObj.setOptionalFullText( null );
		}
		else {
			editObj.setOptionalFullText( getJavaFXEditorFullText().getTextValue() );
		}
	}
		...
		switch( value ) {
					...
					case View:
						if( editObj == null ) {
							if( focus != null ) {
								...
								editObj = (ICFIntLicenseEditObj)focus.beginEdit();
								if( editObj == null ) {
									throw new CFLibUsageException( getClass(),
										S_ProcName,
			...
			case Update:
				...
				if( editObj != null ) {
					postFields();
					if( editObj.getIsNew() ) {
						focus = (ICFIntLicenseObj)editObj.create();
	...
	public void adjustComponentEnableStates() {
		...
		if( javafxEditorEmbeddedText != null ) {
			javafxEditorEmbeddedText.setDisable( ! isEditing );
		}
		if( javafxEditorFullText != null ) {
			javafxEditorFullText.setDisable( ! isEditing );
		}
	}
}

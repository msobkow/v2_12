// Description: Java 11 JavaFX Add Pane implementation for MinorVersion.
...
/**
 *	CFIntJavaFXMinorVersionAddPane JavaFX Add Pane implementation
 *	for MinorVersion.
 */
public class CFIntJavaFXMinorVersionAddPane
extends CFSplitPane
implements ICFIntJavaFXMinorVersionPaneCommon
{
	...
	public CFIntJavaFXMinorVersionAddPane( ICFFormManager formManager, ICFIntJavaFXSchema argSchema, ICFIntMinorVersionObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFIntJavaFXMinorVersionPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}

// Description: Java 11 JavaFX Add Form implementation for TopProject.
...
/**
 *	CFIntJavaFXTopProjectAddForm JavaFX Add Form implementation
 *	for TopProject.
 */
public class CFIntJavaFXTopProjectAddForm
extends CFBorderPane
implements ICFIntJavaFXTopProjectPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add TopProject";
	...
	public CFIntJavaFXTopProjectAddForm( ICFFormManager formManager, ICFIntJavaFXSchema argSchema, ICFIntTopProjectObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getTopProjectFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFIntJavaFXTopProjectPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getTopProjectFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFIntJavaFXTopProjectPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFIntJavaFXTopProjectPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}

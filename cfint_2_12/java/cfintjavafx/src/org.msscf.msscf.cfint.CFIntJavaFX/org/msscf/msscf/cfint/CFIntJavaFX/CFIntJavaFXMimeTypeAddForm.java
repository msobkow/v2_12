// Description: Java 11 JavaFX Add Form implementation for MimeType.
...
/**
 *	CFIntJavaFXMimeTypeAddForm JavaFX Add Form implementation
 *	for MimeType.
 */
public class CFIntJavaFXMimeTypeAddForm
extends CFBorderPane
implements ICFIntJavaFXMimeTypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Add MIME Type";
	...
	public CFIntJavaFXMimeTypeAddForm( ICFFormManager formManager, ICFIntJavaFXSchema argSchema, ICFIntMimeTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getMimeTypeFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFIntJavaFXMimeTypePaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getMimeTypeFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFIntJavaFXMimeTypePaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFIntJavaFXMimeTypePaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}

// Description: Java 11 JavaFX View/Edit Pane implementation for MimeType.
...
/**
 *	CFIntJavaFXMimeTypeViewEditPane JavaFX View/Edit Pane implementation
 *	for MimeType.
 */
public class CFIntJavaFXMimeTypeViewEditPane
extends CFSplitPane
implements ICFIntJavaFXMimeTypePaneCommon
{
	...
	public CFIntJavaFXMimeTypeViewEditPane( ICFFormManager formManager, ICFIntJavaFXSchema argSchema, ICFIntMimeTypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFIntJavaFXMimeTypePaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}

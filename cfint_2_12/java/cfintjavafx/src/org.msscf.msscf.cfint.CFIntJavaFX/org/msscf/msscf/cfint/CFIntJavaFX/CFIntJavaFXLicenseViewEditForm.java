// Description: Java 11 JavaFX View/Edit Form implementation for License.
...
/**
 *	CFIntJavaFXLicenseViewEditForm JavaFX View/Edit Form implementation
 *	for License.
 */
public class CFIntJavaFXLicenseViewEditForm
extends CFBorderPane
implements ICFIntJavaFXLicensePaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit License";
	...
	public CFIntJavaFXLicenseViewEditForm( ICFFormManager formManager, ICFIntJavaFXSchema argSchema, ICFIntLicenseObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		javafxViewEditPane = argSchema.getLicenseFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFIntJavaFXLicensePaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsLicense() != null ) {
							if( null == getJavaFXFocusAsLicense().getEdit() ) {
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFIntJavaFXLicensePaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFIntJavaFXLicensePaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}

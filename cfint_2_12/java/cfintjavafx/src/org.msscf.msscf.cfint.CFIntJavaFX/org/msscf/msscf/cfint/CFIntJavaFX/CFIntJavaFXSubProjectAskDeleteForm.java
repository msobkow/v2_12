// Description: Java 11 JavaFX Ask Delete Pane implementation for SubProject.
...
/**
 *	CFIntJavaFXSubProjectAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for SubProject.
 */
public class CFIntJavaFXSubProjectAskDeleteForm
extends CFBorderPane
implements ICFIntJavaFXSubProjectPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete SubProject";
	...
	public CFIntJavaFXSubProjectAskDeleteForm( ICFFormManager formManager, ICFIntJavaFXSchema argSchema, ICFIntSubProjectObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this SubProject?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFIntSubProjectObj obj = getJavaFXFocusAsSubProject();
					ICFIntSubProjectEditObj editObj = (ICFIntSubProjectEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsSubProject( ICFIntSubProjectObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFIntJavaFXSubProjectPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}

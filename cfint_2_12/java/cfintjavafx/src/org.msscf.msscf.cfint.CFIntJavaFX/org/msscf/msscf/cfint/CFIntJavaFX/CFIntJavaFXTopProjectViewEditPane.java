// Description: Java 11 JavaFX View/Edit Pane implementation for TopProject.
...
/**
 *	CFIntJavaFXTopProjectViewEditPane JavaFX View/Edit Pane implementation
 *	for TopProject.
 */
public class CFIntJavaFXTopProjectViewEditPane
extends CFSplitPane
implements ICFIntJavaFXTopProjectPaneCommon
{
	...
	public CFIntJavaFXTopProjectViewEditPane( ICFFormManager formManager, ICFIntJavaFXSchema argSchema, ICFIntTopProjectObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getTopProjectFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFIntJavaFXTopProjectPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFIntJavaFXTopProjectPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFIntJavaFXTopProjectPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}

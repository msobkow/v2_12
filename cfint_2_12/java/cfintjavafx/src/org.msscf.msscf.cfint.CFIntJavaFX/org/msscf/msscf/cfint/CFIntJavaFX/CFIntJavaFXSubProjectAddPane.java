// Description: Java 11 JavaFX Add Pane implementation for SubProject.
...
/**
 *	CFIntJavaFXSubProjectAddPane JavaFX Add Pane implementation
 *	for SubProject.
 */
public class CFIntJavaFXSubProjectAddPane
extends CFSplitPane
implements ICFIntJavaFXSubProjectPaneCommon
{
	...
	public CFIntJavaFXSubProjectAddPane( ICFFormManager formManager, ICFIntJavaFXSchema argSchema, ICFIntSubProjectObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFIntJavaFXSubProjectPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}

// Description: Java 11 JavaFX View/Edit Pane implementation for URLProtocol.
...
/**
 *	CFIntJavaFXURLProtocolViewEditPane JavaFX View/Edit Pane implementation
 *	for URLProtocol.
 */
public class CFIntJavaFXURLProtocolViewEditPane
extends CFSplitPane
implements ICFIntJavaFXURLProtocolPaneCommon
{
	...
	public CFIntJavaFXURLProtocolViewEditPane( ICFFormManager formManager, ICFIntJavaFXSchema argSchema, ICFIntURLProtocolObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFIntJavaFXURLProtocolPaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}

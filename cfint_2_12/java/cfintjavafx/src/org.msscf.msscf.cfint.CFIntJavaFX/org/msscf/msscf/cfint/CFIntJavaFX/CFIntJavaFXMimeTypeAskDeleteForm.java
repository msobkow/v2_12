// Description: Java 11 JavaFX Ask Delete Pane implementation for MimeType.
...
/**
 *	CFIntJavaFXMimeTypeAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for MimeType.
 */
public class CFIntJavaFXMimeTypeAskDeleteForm
extends CFBorderPane
implements ICFIntJavaFXMimeTypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete MIME Type";
	...
	public CFIntJavaFXMimeTypeAskDeleteForm( ICFFormManager formManager, ICFIntJavaFXSchema argSchema, ICFIntMimeTypeObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this MIME Type?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFIntMimeTypeObj obj = getJavaFXFocusAsMimeType();
					ICFIntMimeTypeEditObj editObj = (ICFIntMimeTypeEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsMimeType( ICFIntMimeTypeObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFIntJavaFXMimeTypePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}

// Description: Java 11 JavaFX Add Pane implementation for URLProtocol.
...
/**
 *	CFIntJavaFXURLProtocolAddPane JavaFX Add Pane implementation
 *	for URLProtocol.
 */
public class CFIntJavaFXURLProtocolAddPane
extends CFSplitPane
implements ICFIntJavaFXURLProtocolPaneCommon
{
	...
	public CFIntJavaFXURLProtocolAddPane( ICFFormManager formManager, ICFIntJavaFXSchema argSchema, ICFIntURLProtocolObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFIntJavaFXURLProtocolPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}

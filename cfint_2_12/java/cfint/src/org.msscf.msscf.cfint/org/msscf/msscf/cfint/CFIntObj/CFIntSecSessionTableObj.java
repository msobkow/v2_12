	...
	implements ICFIntSecSessionTableObj
{
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexBySecUserIdx != null ) {
				CFSecSecSessionBySecUserIdxKey keySecUserIdx =
					((ICFIntSchema)schema.getBackingStore()).getFactorySecSession().newSecUserIdxKey();
			...
			if( indexBySecDevIdx != null ) {
				CFSecSecSessionBySecDevIdxKey keySecDevIdx =
					((ICFIntSchema)schema.getBackingStore()).getFactorySecSession().newSecDevIdxKey();
			...
			if( indexByStartIdx != null ) {
				CFSecSecSessionByStartIdxKey keyStartIdx =
					((ICFIntSchema)schema.getBackingStore()).getFactorySecSession().newStartIdxKey();
			...
			if( indexByFinishIdx != null ) {
				CFSecSecSessionByFinishIdxKey keyFinishIdx =
					((ICFIntSchema)schema.getBackingStore()).getFactorySecSession().newFinishIdxKey();
			...
			if( indexBySecProxyIdx != null ) {
				CFSecSecSessionBySecProxyIdxKey keySecProxyIdx =
					((ICFIntSchema)schema.getBackingStore()).getFactorySecSession().newSecProxyIdxKey();
	...
	public void forgetSecSessionByIdIdx( UUID SecSessionId )
	{
		...
		CFSecSecSessionPKey key = ((ICFIntSchema)schema.getBackingStore()).getFactorySecSession().newPKey();
	...
	public void forgetSecSessionBySecUserIdx( UUID SecUserId )
	{
		...
		List<ICFSecSecSessionObj> toForget = new LinkedList<ICFSecSecSessionObj>();
		ICFSecSecSessionObj cur = null;
		CFSecSecSessionBySecUserIdxKey key = ((ICFIntSchema)schema.getBackingStore()).getFactorySecSession().newSecUserIdxKey();
		...
		String SecDevName )
	{
		...
		List<ICFSecSecSessionObj> toForget = new LinkedList<ICFSecSecSessionObj>();
		ICFSecSecSessionObj cur = null;
		CFSecSecSessionBySecDevIdxKey key = ((ICFIntSchema)schema.getBackingStore()).getFactorySecSession().newSecDevIdxKey();
		key.setRequiredSecUserId( SecUserId );
		...
		Calendar Start )
	{
		...
		List<ICFSecSecSessionObj> toForget = new LinkedList<ICFSecSecSessionObj>();
		ICFSecSecSessionObj cur = null;
		CFSecSecSessionByStartIdxKey key = ((ICFIntSchema)schema.getBackingStore()).getFactorySecSession().newStartIdxKey();
		key.setRequiredSecUserId( SecUserId );
		...
		Calendar Finish )
	{
		...
		List<ICFSecSecSessionObj> toForget = new LinkedList<ICFSecSecSessionObj>();
		ICFSecSecSessionObj cur = null;
		CFSecSecSessionByFinishIdxKey key = ((ICFIntSchema)schema.getBackingStore()).getFactorySecSession().newFinishIdxKey();
		key.setRequiredSecUserId( SecUserId );
	...
	public void forgetSecSessionBySecProxyIdx( UUID SecProxyId )
	{
		...
		List<ICFSecSecSessionObj> toForget = new LinkedList<ICFSecSecSessionObj>();
		ICFSecSecSessionObj cur = null;
		CFSecSecSessionBySecProxyIdxKey key = ((ICFIntSchema)schema.getBackingStore()).getFactorySecSession().newSecProxyIdxKey();
	...
	public ICFSecSecSessionObj createSecSession( ICFSecSecSessionObj Obj ) {
		...
		((ICFIntSchema)schema.getBackingStore()).getTableSecSession().createSecSession(
	...
	public ICFSecSecSessionObj readSecSession( CFSecSecSessionPKey pkey, boolean forceRead ) {
		...
		if( ( ! forceRead ) && members.containsKey( pkey ) ) {
			...
			CFSecSecSessionBuff readBuff = ((ICFIntSchema)schema.getBackingStore()).getTableSecSession().readDerivedByIdIdx( schema.getAuthorization(),
				pkey.getRequiredSecSessionId() );
			if( readBuff != null ) {
				obj = schema.getSecSessionTableObj().newInstance();
				obj.setPKey( ((ICFIntSchema)schema.getBackingStore()).getFactorySecSession().newPKey() );
	...
	public ICFSecSecSessionObj lockSecSession( CFSecSecSessionPKey pkey ) {
		...
		CFSecSecSessionBuff lockBuff = ((ICFIntSchema)schema.getBackingStore()).getTableSecSession().lockDerived( schema.getAuthorization(), pkey );
		if( lockBuff != null ) {
				locked = schema.getSecSessionTableObj().newInstance();
			locked.setPKey( ((ICFIntSchema)schema.getBackingStore()).getFactorySecSession().newPKey() );
	...
	public List<ICFSecSecSessionObj> readAllSecSession( boolean forceRead ) {
		...
		if( ( allSecSession == null ) || forceRead ) {
			...
			allSecSession = map;
			CFSecSecSessionBuff[] buffList = ((ICFIntSchema)schema.getBackingStore()).getTableSecSession().readAllDerived( schema.getAuthorization() );
	...
	public List<ICFSecSecSessionObj> pageAllSecSession(UUID priorSecSessionId )
	{
		...
		Map<CFSecSecSessionPKey, ICFSecSecSessionObj> map = new HashMap<CFSecSecSessionPKey,ICFSecSecSessionObj>();
		CFSecSecSessionBuff[] buffList = ((ICFIntSchema)schema.getBackingStore()).getTableSecSession().pageAllBuff( schema.getAuthorization(),
			priorSecSessionId );
		CFSecSecSessionBuff buff;
		ICFSecSecSessionObj obj;
	...
	{
		CFSecSecSessionPKey pkey = ((ICFIntSchema)schema.getBackingStore()).getFactorySecSession().newPKey();
		...
		boolean forceRead )
	{
		...
		if( ( ! forceRead ) && indexBySecUserIdx.containsKey( key ) ) {
			...
			ICFSecSecSessionObj obj;
			CFSecSecSessionBuff[] buffList = ((ICFIntSchema)schema.getBackingStore()).getTableSecSession().readDerivedBySecUserIdx( schema.getAuthorization(),
				SecUserId );
			CFSecSecSessionBuff buff;
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[ idx ];
		...
		boolean forceRead )
	{
		...
		if( ( ! forceRead ) && indexBySecDevIdx.containsKey( key ) ) {
			...
			dict = new HashMap<CFSecSecSessionPKey, ICFSecSecSessionObj>();
			ICFSecSecSessionObj obj;
			CFSecSecSessionBuff[] buffList = ((ICFIntSchema)schema.getBackingStore()).getTableSecSession().readDerivedBySecDevIdx( schema.getAuthorization(),
				SecUserId,
				SecDevName );
			CFSecSecSessionBuff buff;
			for( int idx = 0; idx < buffList.length; idx ++ ) {
		...
		Calendar Start, boolean forceRead )
	{
		...
		if( ( ! forceRead ) && indexByStartIdx.containsKey( key ) ) {
			...
			CFSecSecSessionBuff buff = ((ICFIntSchema)schema.getBackingStore()).getTableSecSession().readDerivedByStartIdx( schema.getAuthorization(),
				SecUserId,
				Start );
			if( buff != null ) {
				obj = schema.getSecSessionTableObj().newInstance();
		...
		boolean forceRead )
	{
		...
		if( ( ! forceRead ) && indexByFinishIdx.containsKey( key ) ) {
			...
			dict = new HashMap<CFSecSecSessionPKey, ICFSecSecSessionObj>();
			ICFSecSecSessionObj obj;
			CFSecSecSessionBuff[] buffList = ((ICFIntSchema)schema.getBackingStore()).getTableSecSession().readDerivedByFinishIdx( schema.getAuthorization(),
				SecUserId,
				Finish );
			CFSecSecSessionBuff buff;
			for( int idx = 0; idx < buffList.length; idx ++ ) {
		...
		boolean forceRead )
	{
		...
		if( ( ! forceRead ) && indexBySecProxyIdx.containsKey( key ) ) {
			...
			dict = new HashMap<CFSecSecSessionPKey, ICFSecSecSessionObj>();
			ICFSecSecSessionObj obj;
			CFSecSecSessionBuff[] buffList = ((ICFIntSchema)schema.getBackingStore()).getTableSecSession().readDerivedBySecProxyIdx( schema.getAuthorization(),
				SecProxyId );
			CFSecSecSessionBuff buff;
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[ idx ];
		...
		UUID priorSecSessionId )
	{
		...
		ICFSecSecSessionObj obj;
		CFSecSecSessionBuff[] buffList = ((ICFIntSchema)schema.getBackingStore()).getTableSecSession().pageBuffBySecUserIdx( schema.getAuthorization(),
				SecUserId,
			priorSecSessionId );
		CFSecSecSessionBuff buff;
		for( int idx = 0; idx < buffList.length; idx ++ ) {
		...
		UUID priorSecSessionId )
	{
		...
		List<ICFSecSecSessionObj> retList = new LinkedList<ICFSecSecSessionObj>();
		ICFSecSecSessionObj obj;
		CFSecSecSessionBuff[] buffList = ((ICFIntSchema)schema.getBackingStore()).getTableSecSession().pageBuffBySecDevIdx( schema.getAuthorization(),
				SecUserId,
				SecDevName,
			priorSecSessionId );
		CFSecSecSessionBuff buff;
		...
		UUID priorSecSessionId )
	{
		...
		List<ICFSecSecSessionObj> retList = new LinkedList<ICFSecSecSessionObj>();
		ICFSecSecSessionObj obj;
		CFSecSecSessionBuff[] buffList = ((ICFIntSchema)schema.getBackingStore()).getTableSecSession().pageBuffByFinishIdx( schema.getAuthorization(),
				SecUserId,
				Finish,
			priorSecSessionId );
		CFSecSecSessionBuff buff;
		...
		UUID priorSecSessionId )
	{
		...
		List<ICFSecSecSessionObj> retList = new LinkedList<ICFSecSecSessionObj>();
		ICFSecSecSessionObj obj;
		CFSecSecSessionBuff[] buffList = ((ICFIntSchema)schema.getBackingStore()).getTableSecSession().pageBuffBySecProxyIdx( schema.getAuthorization(),
				SecProxyId,
			priorSecSessionId );
		CFSecSecSessionBuff buff;
		for( int idx = 0; idx < buffList.length; idx ++ ) {
	...
	public ICFSecSecSessionObj updateSecSession( ICFSecSecSessionObj Obj ) {
		ICFSecSecSessionObj obj = Obj;
		((ICFIntSchema)schema.getBackingStore()).getTableSecSession().updateSecSession( schema.getAuthorization(),
	...
	public void deleteSecSession( ICFSecSecSessionObj Obj ) {
		ICFSecSecSessionObj obj = Obj;
		((ICFIntSchema)schema.getBackingStore()).getTableSecSession().deleteSecSession( schema.getAuthorization(),
			obj.getSecSessionBuff() );
		obj.forget( true );
	}
	...
	public void deleteSecSessionBySecUserIdx( UUID SecUserId )
	{
		...
		if( indexBySecUserIdx.containsKey( key ) ) {
			...
			((ICFIntSchema)schema.getBackingStore()).getTableSecSession().deleteSecSessionBySecUserIdx( schema.getAuthorization(),
				SecUserId );
		...
		String SecDevName )
	{
		...
		if( indexBySecDevIdx.containsKey( key ) ) {
			...
			((ICFIntSchema)schema.getBackingStore()).getTableSecSession().deleteSecSessionBySecDevIdx( schema.getAuthorization(),
				SecUserId,
				SecDevName );
			Iterator<ICFSecSecSessionObj> iter = dict.values().iterator();
			ICFSecSecSessionObj obj;
		...
		Calendar Start )
	{
		...
		if( indexByStartIdx.containsKey( key ) ) {
			obj = indexByStartIdx.get( key );
			((ICFIntSchema)schema.getBackingStore()).getTableSecSession().deleteSecSessionByStartIdx( schema.getAuthorization(),
				SecUserId,
				Start );
			obj.forget( true );
		}
		...
		Calendar Finish )
	{
		...
		if( indexByFinishIdx.containsKey( key ) ) {
			...
			((ICFIntSchema)schema.getBackingStore()).getTableSecSession().deleteSecSessionByFinishIdx( schema.getAuthorization(),
				SecUserId,
				Finish );
			Iterator<ICFSecSecSessionObj> iter = dict.values().iterator();
			ICFSecSecSessionObj obj;
	...
	public void deleteSecSessionBySecProxyIdx( UUID SecProxyId )
	{
		...
		if( indexBySecProxyIdx.containsKey( key ) ) {
			...
			((ICFIntSchema)schema.getBackingStore()).getTableSecSession().deleteSecSessionBySecProxyIdx( schema.getAuthorization(),
				SecProxyId );
			Iterator<ICFSecSecSessionObj> iter = dict.values().iterator();
			ICFSecSecSessionObj obj;
			List<ICFSecSecSessionObj> toForget = new LinkedList<ICFSecSecSessionObj>();

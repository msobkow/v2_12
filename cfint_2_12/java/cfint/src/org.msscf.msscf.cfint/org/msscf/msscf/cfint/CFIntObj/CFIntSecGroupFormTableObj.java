...
public class CFIntSecGroupFormTableObj
	implements ICFIntSecGroupFormTableObj
{
	...
	public CFIntSecGroupFormTableObj() {
		schema = null;
	...
	public CFIntSecGroupFormTableObj( ICFSecSchemaObj argSchema ) {
		schema = argSchema;
		members = new HashMap<CFSecSecGroupFormPKey, ICFSecSecGroupFormObj>();
		allSecGroupForm = null;
		indexByClusterIdx = null;
	 ...
	 *	CFIntSecGroupFormObj.
	 */
	public ICFSecSecGroupFormObj newInstance() {
		ICFSecSecGroupFormObj inst = new CFIntSecGroupFormObj( schema );
		return( inst );
	}
	...
	public ICFSecSecGroupFormEditObj newEditInstance( ICFSecSecGroupFormObj orig ) {
		ICFSecSecGroupFormEditObj edit = new CFIntSecGroupFormEditObj( orig );
		return( edit );
	}
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByClusterIdx != null ) {
				CFSecSecGroupFormByClusterIdxKey keyClusterIdx =
					((ICFIntSchema)schema.getBackingStore()).getFactorySecGroupForm().newClusterIdxKey();
			...
			if( indexByGroupIdx != null ) {
				CFSecSecGroupFormByGroupIdxKey keyGroupIdx =
					((ICFIntSchema)schema.getBackingStore()).getFactorySecGroupForm().newGroupIdxKey();
			...
			if( indexByAppIdx != null ) {
				CFSecSecGroupFormByAppIdxKey keyAppIdx =
					((ICFIntSchema)schema.getBackingStore()).getFactorySecGroupForm().newAppIdxKey();
			...
			if( indexByFormIdx != null ) {
				CFSecSecGroupFormByFormIdxKey keyFormIdx =
					((ICFIntSchema)schema.getBackingStore()).getFactorySecGroupForm().newFormIdxKey();
			...
			if( indexByUFormIdx != null ) {
				CFSecSecGroupFormByUFormIdxKey keyUFormIdx =
					((ICFIntSchema)schema.getBackingStore()).getFactorySecGroupForm().newUFormIdxKey();
		...
		long SecGroupFormId )
	{
		...
		CFSecSecGroupFormPKey key = ((ICFIntSchema)schema.getBackingStore()).getFactorySecGroupForm().newPKey();
	...
	public void forgetSecGroupFormByClusterIdx( long ClusterId )
	{
		...
		List<ICFSecSecGroupFormObj> toForget = new LinkedList<ICFSecSecGroupFormObj>();
		ICFSecSecGroupFormObj cur = null;
		CFSecSecGroupFormByClusterIdxKey key = ((ICFIntSchema)schema.getBackingStore()).getFactorySecGroupForm().newClusterIdxKey();
		key.setRequiredClusterId( ClusterId );
		...
		int SecGroupId )
	{
		...
		List<ICFSecSecGroupFormObj> toForget = new LinkedList<ICFSecSecGroupFormObj>();
		ICFSecSecGroupFormObj cur = null;
		CFSecSecGroupFormByGroupIdxKey key = ((ICFIntSchema)schema.getBackingStore()).getFactorySecGroupForm().newGroupIdxKey();
		key.setRequiredClusterId( ClusterId );
		...
		int SecAppId )
	{
		...
		List<ICFSecSecGroupFormObj> toForget = new LinkedList<ICFSecSecGroupFormObj>();
		ICFSecSecGroupFormObj cur = null;
		CFSecSecGroupFormByAppIdxKey key = ((ICFIntSchema)schema.getBackingStore()).getFactorySecGroupForm().newAppIdxKey();
		key.setRequiredClusterId( ClusterId );
		...
		int SecFormId )
	{
		...
		List<ICFSecSecGroupFormObj> toForget = new LinkedList<ICFSecSecGroupFormObj>();
		ICFSecSecGroupFormObj cur = null;
		CFSecSecGroupFormByFormIdxKey key = ((ICFIntSchema)schema.getBackingStore()).getFactorySecGroupForm().newFormIdxKey();
		key.setRequiredClusterId( ClusterId );
		...
		int SecFormId )
	{
		...
		List<ICFSecSecGroupFormObj> toForget = new LinkedList<ICFSecSecGroupFormObj>();
		ICFSecSecGroupFormObj cur = null;
		CFSecSecGroupFormByUFormIdxKey key = ((ICFIntSchema)schema.getBackingStore()).getFactorySecGroupForm().newUFormIdxKey();
		key.setRequiredClusterId( ClusterId );
		key.setRequiredSecGroupId( SecGroupId );
		key.setRequiredSecFormId( SecFormId );
	...
	public ICFSecSecGroupFormObj createSecGroupForm( ICFSecSecGroupFormObj Obj ) {
		...
		((ICFIntSchema)schema.getBackingStore()).getTableSecGroupForm().createSecGroupForm(
	...
	public ICFSecSecGroupFormObj readSecGroupForm( CFSecSecGroupFormPKey pkey, boolean forceRead ) {
		...
		if( ( ! forceRead ) && members.containsKey( pkey ) ) {
			...
			CFSecSecGroupFormBuff readBuff = ((ICFIntSchema)schema.getBackingStore()).getTableSecGroupForm().readDerivedByIdIdx( schema.getAuthorization(),
				pkey.getRequiredClusterId(),
				pkey.getRequiredSecGroupFormId() );
			if( readBuff != null ) {
				obj = schema.getSecGroupFormTableObj().newInstance();
				obj.setPKey( ((ICFIntSchema)schema.getBackingStore()).getFactorySecGroupForm().newPKey() );
	...
	public ICFSecSecGroupFormObj lockSecGroupForm( CFSecSecGroupFormPKey pkey ) {
		...
		CFSecSecGroupFormBuff lockBuff = ((ICFIntSchema)schema.getBackingStore()).getTableSecGroupForm().lockDerived( schema.getAuthorization(), pkey );
		if( lockBuff != null ) {
				locked = schema.getSecGroupFormTableObj().newInstance();
			locked.setPKey( ((ICFIntSchema)schema.getBackingStore()).getFactorySecGroupForm().newPKey() );
	...
	public List<ICFSecSecGroupFormObj> readAllSecGroupForm( boolean forceRead ) {
		...
		if( ( allSecGroupForm == null ) || forceRead ) {
			...
			allSecGroupForm = map;
			CFSecSecGroupFormBuff[] buffList = ((ICFIntSchema)schema.getBackingStore()).getTableSecGroupForm().readAllDerived( schema.getAuthorization() );
		...
		Long priorSecGroupFormId )
	{
		...
		Map<CFSecSecGroupFormPKey, ICFSecSecGroupFormObj> map = new HashMap<CFSecSecGroupFormPKey,ICFSecSecGroupFormObj>();
		CFSecSecGroupFormBuff[] buffList = ((ICFIntSchema)schema.getBackingStore()).getTableSecGroupForm().pageAllBuff( schema.getAuthorization(),
			priorClusterId,
			priorSecGroupFormId );
		CFSecSecGroupFormBuff buff;
		ICFSecSecGroupFormObj obj;
	...
	{
		CFSecSecGroupFormPKey pkey = ((ICFIntSchema)schema.getBackingStore()).getFactorySecGroupForm().newPKey();
		...
		boolean forceRead )
	{
		...
		if( ( ! forceRead ) && indexByClusterIdx.containsKey( key ) ) {
			...
			ICFSecSecGroupFormObj obj;
			CFSecSecGroupFormBuff[] buffList = ((ICFIntSchema)schema.getBackingStore()).getTableSecGroupForm().readDerivedByClusterIdx( schema.getAuthorization(),
				ClusterId );
			CFSecSecGroupFormBuff buff;
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[ idx ];
		...
		boolean forceRead )
	{
		...
		if( ( ! forceRead ) && indexByGroupIdx.containsKey( key ) ) {
			...
			dict = new HashMap<CFSecSecGroupFormPKey, ICFSecSecGroupFormObj>();
			ICFSecSecGroupFormObj obj;
			CFSecSecGroupFormBuff[] buffList = ((ICFIntSchema)schema.getBackingStore()).getTableSecGroupForm().readDerivedByGroupIdx( schema.getAuthorization(),
				ClusterId,
				SecGroupId );
			CFSecSecGroupFormBuff buff;
			for( int idx = 0; idx < buffList.length; idx ++ ) {
		...
		boolean forceRead )
	{
		...
		if( ( ! forceRead ) && indexByAppIdx.containsKey( key ) ) {
			...
			dict = new HashMap<CFSecSecGroupFormPKey, ICFSecSecGroupFormObj>();
			ICFSecSecGroupFormObj obj;
			CFSecSecGroupFormBuff[] buffList = ((ICFIntSchema)schema.getBackingStore()).getTableSecGroupForm().readDerivedByAppIdx( schema.getAuthorization(),
				ClusterId,
				SecAppId );
			CFSecSecGroupFormBuff buff;
			for( int idx = 0; idx < buffList.length; idx ++ ) {
		...
		boolean forceRead )
	{
		...
		if( ( ! forceRead ) && indexByFormIdx.containsKey( key ) ) {
			...
			dict = new HashMap<CFSecSecGroupFormPKey, ICFSecSecGroupFormObj>();
			ICFSecSecGroupFormObj obj;
			CFSecSecGroupFormBuff[] buffList = ((ICFIntSchema)schema.getBackingStore()).getTableSecGroupForm().readDerivedByFormIdx( schema.getAuthorization(),
				ClusterId,
				SecFormId );
			CFSecSecGroupFormBuff buff;
			for( int idx = 0; idx < buffList.length; idx ++ ) {
		...
		int SecFormId, boolean forceRead )
	{
		...
		if( ( ! forceRead ) && indexByUFormIdx.containsKey( key ) ) {
			...
			CFSecSecGroupFormBuff buff = ((ICFIntSchema)schema.getBackingStore()).getTableSecGroupForm().readDerivedByUFormIdx( schema.getAuthorization(),
				ClusterId,
				SecGroupId,
				SecFormId );
			if( buff != null ) {
		...
		Long priorSecGroupFormId )
	{
		...
		ICFSecSecGroupFormObj obj;
		CFSecSecGroupFormBuff[] buffList = ((ICFIntSchema)schema.getBackingStore()).getTableSecGroupForm().pageBuffByClusterIdx( schema.getAuthorization(),
				ClusterId,
			priorClusterId,
			priorSecGroupFormId );
		CFSecSecGroupFormBuff buff;
		...
		Long priorSecGroupFormId )
	{
		...
		List<ICFSecSecGroupFormObj> retList = new LinkedList<ICFSecSecGroupFormObj>();
		ICFSecSecGroupFormObj obj;
		CFSecSecGroupFormBuff[] buffList = ((ICFIntSchema)schema.getBackingStore()).getTableSecGroupForm().pageBuffByGroupIdx( schema.getAuthorization(),
				ClusterId,
				SecGroupId,
			priorClusterId,
			priorSecGroupFormId );
		...
		Long priorSecGroupFormId )
	{
		...
		List<ICFSecSecGroupFormObj> retList = new LinkedList<ICFSecSecGroupFormObj>();
		ICFSecSecGroupFormObj obj;
		CFSecSecGroupFormBuff[] buffList = ((ICFIntSchema)schema.getBackingStore()).getTableSecGroupForm().pageBuffByAppIdx( schema.getAuthorization(),
				ClusterId,
				SecAppId,
			priorClusterId,
			priorSecGroupFormId );
		...
		Long priorSecGroupFormId )
	{
		...
		List<ICFSecSecGroupFormObj> retList = new LinkedList<ICFSecSecGroupFormObj>();
		ICFSecSecGroupFormObj obj;
		CFSecSecGroupFormBuff[] buffList = ((ICFIntSchema)schema.getBackingStore()).getTableSecGroupForm().pageBuffByFormIdx( schema.getAuthorization(),
				ClusterId,
				SecFormId,
			priorClusterId,
			priorSecGroupFormId );
	...
	public ICFSecSecGroupFormObj updateSecGroupForm( ICFSecSecGroupFormObj Obj ) {
		ICFSecSecGroupFormObj obj = Obj;
		((ICFIntSchema)schema.getBackingStore()).getTableSecGroupForm().updateSecGroupForm( schema.getAuthorization(),
	...
	public void deleteSecGroupForm( ICFSecSecGroupFormObj Obj ) {
		ICFSecSecGroupFormObj obj = Obj;
		((ICFIntSchema)schema.getBackingStore()).getTableSecGroupForm().deleteSecGroupForm( schema.getAuthorization(),
			obj.getSecGroupFormBuff() );
		obj.forget( true );
	}
	...
	public void deleteSecGroupFormByClusterIdx( long ClusterId )
	{
		...
		if( indexByClusterIdx.containsKey( key ) ) {
			...
			((ICFIntSchema)schema.getBackingStore()).getTableSecGroupForm().deleteSecGroupFormByClusterIdx( schema.getAuthorization(),
				ClusterId );
		...
		int SecGroupId )
	{
		...
		if( indexByGroupIdx.containsKey( key ) ) {
			...
			((ICFIntSchema)schema.getBackingStore()).getTableSecGroupForm().deleteSecGroupFormByGroupIdx( schema.getAuthorization(),
				ClusterId,
				SecGroupId );
			Iterator<ICFSecSecGroupFormObj> iter = dict.values().iterator();
			ICFSecSecGroupFormObj obj;
		...
		int SecAppId )
	{
		...
		if( indexByAppIdx.containsKey( key ) ) {
			...
			((ICFIntSchema)schema.getBackingStore()).getTableSecGroupForm().deleteSecGroupFormByAppIdx( schema.getAuthorization(),
				ClusterId,
				SecAppId );
			Iterator<ICFSecSecGroupFormObj> iter = dict.values().iterator();
			ICFSecSecGroupFormObj obj;
		...
		int SecFormId )
	{
		...
		if( indexByFormIdx.containsKey( key ) ) {
			...
			((ICFIntSchema)schema.getBackingStore()).getTableSecGroupForm().deleteSecGroupFormByFormIdx( schema.getAuthorization(),
				ClusterId,
				SecFormId );
			Iterator<ICFSecSecGroupFormObj> iter = dict.values().iterator();
			ICFSecSecGroupFormObj obj;
		...
		int SecFormId )
	{
		...
		if( indexByUFormIdx.containsKey( key ) ) {
			obj = indexByUFormIdx.get( key );
			((ICFIntSchema)schema.getBackingStore()).getTableSecGroupForm().deleteSecGroupFormByUFormIdx( schema.getAuthorization(),
				ClusterId,
				SecGroupId,
				SecFormId );
			obj.forget( true );

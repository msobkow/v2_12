	...
	implements ICFIntClusterTableObj
{
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByUDomNameIdx != null ) {
				CFSecClusterByUDomNameIdxKey keyUDomNameIdx =
					((ICFIntSchema)schema.getBackingStore()).getFactoryCluster().newUDomNameIdxKey();
			...
			if( indexByUDescrIdx != null ) {
				CFSecClusterByUDescrIdxKey keyUDescrIdx =
					((ICFIntSchema)schema.getBackingStore()).getFactoryCluster().newUDescrIdxKey();
	...
	public void forgetClusterByIdIdx( long Id )
	{
		...
		CFSecClusterPKey key = ((ICFIntSchema)schema.getBackingStore()).getFactoryCluster().newPKey();
	...
	public void forgetClusterByUDomNameIdx( String FullDomName )
	{
		...
		List<ICFSecClusterObj> toForget = new LinkedList<ICFSecClusterObj>();
		ICFSecClusterObj cur = null;
		CFSecClusterByUDomNameIdxKey key = ((ICFIntSchema)schema.getBackingStore()).getFactoryCluster().newUDomNameIdxKey();
	...
	public void forgetClusterByUDescrIdx( String Description )
	{
		...
		List<ICFSecClusterObj> toForget = new LinkedList<ICFSecClusterObj>();
		ICFSecClusterObj cur = null;
		CFSecClusterByUDescrIdxKey key = ((ICFIntSchema)schema.getBackingStore()).getFactoryCluster().newUDescrIdxKey();
	...
	public ICFSecClusterObj createCluster( ICFSecClusterObj Obj ) {
		...
		((ICFIntSchema)schema.getBackingStore()).getTableCluster().createCluster(
	...
	public ICFSecClusterObj readCluster( CFSecClusterPKey pkey, boolean forceRead ) {
		...
		if( ( ! forceRead ) && members.containsKey( pkey ) ) {
			...
			CFSecClusterBuff readBuff = ((ICFIntSchema)schema.getBackingStore()).getTableCluster().readDerivedByIdIdx( schema.getAuthorization(),
				pkey.getRequiredId() );
			if( readBuff != null ) {
				obj = schema.getClusterTableObj().newInstance();
				obj.setPKey( ((ICFIntSchema)schema.getBackingStore()).getFactoryCluster().newPKey() );
	...
	public ICFSecClusterObj lockCluster( CFSecClusterPKey pkey ) {
		...
		CFSecClusterBuff lockBuff = ((ICFIntSchema)schema.getBackingStore()).getTableCluster().lockDerived( schema.getAuthorization(), pkey );
		if( lockBuff != null ) {
				locked = schema.getClusterTableObj().newInstance();
			locked.setPKey( ((ICFIntSchema)schema.getBackingStore()).getFactoryCluster().newPKey() );
	...
	public List<ICFSecClusterObj> readAllCluster( boolean forceRead ) {
		...
		if( ( allCluster == null ) || forceRead ) {
			...
			allCluster = map;
			CFSecClusterBuff[] buffList = ((ICFIntSchema)schema.getBackingStore()).getTableCluster().readAllDerived( schema.getAuthorization() );
	...
	public List<ICFSecClusterObj> pageAllCluster(Long priorId )
	{
		...
		Map<CFSecClusterPKey, ICFSecClusterObj> map = new HashMap<CFSecClusterPKey,ICFSecClusterObj>();
		CFSecClusterBuff[] buffList = ((ICFIntSchema)schema.getBackingStore()).getTableCluster().pageAllBuff( schema.getAuthorization(),
			priorId );
		CFSecClusterBuff buff;
		ICFSecClusterObj obj;
	...
	{
		CFSecClusterPKey pkey = ((ICFIntSchema)schema.getBackingStore()).getFactoryCluster().newPKey();
	...
	public ICFSecClusterObj readClusterByUDomNameIdx( String FullDomName, boolean forceRead )
	{
		...
		if( ( ! forceRead ) && indexByUDomNameIdx.containsKey( key ) ) {
			...
			CFSecClusterBuff buff = ((ICFIntSchema)schema.getBackingStore()).getTableCluster().readDerivedByUDomNameIdx( schema.getAuthorization(),
				FullDomName );
			if( buff != null ) {
				obj = schema.getClusterTableObj().newInstance();
				obj.setPKey( ((ICFIntSchema)schema.getBackingStore()).getFactoryCluster().newPKey() );
	...
	public ICFSecClusterObj readClusterByUDescrIdx( String Description, boolean forceRead )
	{
		...
		if( ( ! forceRead ) && indexByUDescrIdx.containsKey( key ) ) {
			...
			CFSecClusterBuff buff = ((ICFIntSchema)schema.getBackingStore()).getTableCluster().readDerivedByUDescrIdx( schema.getAuthorization(),
				Description );
			if( buff != null ) {
				obj = schema.getClusterTableObj().newInstance();
				obj.setPKey( ((ICFIntSchema)schema.getBackingStore()).getFactoryCluster().newPKey() );
	...
	public ICFSecClusterObj updateCluster( ICFSecClusterObj Obj ) {
		ICFSecClusterObj obj = Obj;
		((ICFIntSchema)schema.getBackingStore()).getTableCluster().updateCluster( schema.getAuthorization(),
			Obj.getClusterBuff() );
		obj = (ICFSecClusterObj)Obj.realise();
		obj.endEdit();
		return( obj );
	...
	public void deleteCluster( ICFSecClusterObj Obj ) {
		ICFSecClusterObj obj = Obj;
		((ICFIntSchema)schema.getBackingStore()).getTableCluster().deleteCluster( schema.getAuthorization(),
			obj.getClusterBuff() );
		obj.forget( true );
	}
	...
	public void deleteClusterByUDomNameIdx( String FullDomName )
	{
		...
		if( indexByUDomNameIdx.containsKey( key ) ) {
			obj = indexByUDomNameIdx.get( key );
			((ICFIntSchema)schema.getBackingStore()).getTableCluster().deleteClusterByUDomNameIdx( schema.getAuthorization(),
				FullDomName );
			obj.forget( true );
		}
		else {
	...
	public void deleteClusterByUDescrIdx( String Description )
	{
		...
		if( indexByUDescrIdx.containsKey( key ) ) {
			obj = indexByUDescrIdx.get( key );
			((ICFIntSchema)schema.getBackingStore()).getTableCluster().deleteClusterByUDescrIdx( schema.getAuthorization(),
				Description );
			obj.forget( true );
		}
		else {

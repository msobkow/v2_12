	...
	implements ICFIntHostNodeTableObj
{
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByClusterIdx != null ) {
				CFSecHostNodeByClusterIdxKey keyClusterIdx =
					((ICFIntSchema)schema.getBackingStore()).getFactoryHostNode().newClusterIdxKey();
			...
			if( indexByUDescrIdx != null ) {
				CFSecHostNodeByUDescrIdxKey keyUDescrIdx =
					((ICFIntSchema)schema.getBackingStore()).getFactoryHostNode().newUDescrIdxKey();
			...
			if( indexByHostNameIdx != null ) {
				CFSecHostNodeByHostNameIdxKey keyHostNameIdx =
					((ICFIntSchema)schema.getBackingStore()).getFactoryHostNode().newHostNameIdxKey();
		...
		long HostNodeId )
	{
		...
		CFSecHostNodePKey key = ((ICFIntSchema)schema.getBackingStore()).getFactoryHostNode().newPKey();
	...
	public void forgetHostNodeByClusterIdx( long ClusterId )
	{
		...
		List<ICFSecHostNodeObj> toForget = new LinkedList<ICFSecHostNodeObj>();
		ICFSecHostNodeObj cur = null;
		CFSecHostNodeByClusterIdxKey key = ((ICFIntSchema)schema.getBackingStore()).getFactoryHostNode().newClusterIdxKey();
		key.setRequiredClusterId( ClusterId );
		...
		String Description )
	{
		...
		List<ICFSecHostNodeObj> toForget = new LinkedList<ICFSecHostNodeObj>();
		ICFSecHostNodeObj cur = null;
		CFSecHostNodeByUDescrIdxKey key = ((ICFIntSchema)schema.getBackingStore()).getFactoryHostNode().newUDescrIdxKey();
		key.setRequiredClusterId( ClusterId );
		...
		String HostName )
	{
		...
		List<ICFSecHostNodeObj> toForget = new LinkedList<ICFSecHostNodeObj>();
		ICFSecHostNodeObj cur = null;
		CFSecHostNodeByHostNameIdxKey key = ((ICFIntSchema)schema.getBackingStore()).getFactoryHostNode().newHostNameIdxKey();
		key.setRequiredClusterId( ClusterId );
	...
	public ICFSecHostNodeObj createHostNode( ICFSecHostNodeObj Obj ) {
		...
		((ICFIntSchema)schema.getBackingStore()).getTableHostNode().createHostNode(
	...
	public ICFSecHostNodeObj readHostNode( CFSecHostNodePKey pkey, boolean forceRead ) {
		...
		if( ( ! forceRead ) && members.containsKey( pkey ) ) {
			...
			CFSecHostNodeBuff readBuff = ((ICFIntSchema)schema.getBackingStore()).getTableHostNode().readDerivedByIdIdx( schema.getAuthorization(),
				pkey.getRequiredClusterId(),
				pkey.getRequiredHostNodeId() );
			if( readBuff != null ) {
				obj = schema.getHostNodeTableObj().newInstance();
				obj.setPKey( ((ICFIntSchema)schema.getBackingStore()).getFactoryHostNode().newPKey() );
	...
	public ICFSecHostNodeObj lockHostNode( CFSecHostNodePKey pkey ) {
		...
		CFSecHostNodeBuff lockBuff = ((ICFIntSchema)schema.getBackingStore()).getTableHostNode().lockDerived( schema.getAuthorization(), pkey );
		if( lockBuff != null ) {
				locked = schema.getHostNodeTableObj().newInstance();
			locked.setPKey( ((ICFIntSchema)schema.getBackingStore()).getFactoryHostNode().newPKey() );
	...
	public List<ICFSecHostNodeObj> readAllHostNode( boolean forceRead ) {
		...
		if( ( allHostNode == null ) || forceRead ) {
			...
			allHostNode = map;
			CFSecHostNodeBuff[] buffList = ((ICFIntSchema)schema.getBackingStore()).getTableHostNode().readAllDerived( schema.getAuthorization() );
		...
		Long priorHostNodeId )
	{
		...
		Map<CFSecHostNodePKey, ICFSecHostNodeObj> map = new HashMap<CFSecHostNodePKey,ICFSecHostNodeObj>();
		CFSecHostNodeBuff[] buffList = ((ICFIntSchema)schema.getBackingStore()).getTableHostNode().pageAllBuff( schema.getAuthorization(),
			priorClusterId,
			priorHostNodeId );
		CFSecHostNodeBuff buff;
		ICFSecHostNodeObj obj;
	...
	{
		CFSecHostNodePKey pkey = ((ICFIntSchema)schema.getBackingStore()).getFactoryHostNode().newPKey();
		...
		boolean forceRead )
	{
		...
		if( ( ! forceRead ) && indexByClusterIdx.containsKey( key ) ) {
			...
			ICFSecHostNodeObj obj;
			CFSecHostNodeBuff[] buffList = ((ICFIntSchema)schema.getBackingStore()).getTableHostNode().readDerivedByClusterIdx( schema.getAuthorization(),
				ClusterId );
			CFSecHostNodeBuff buff;
			for( int idx = 0; idx < buffList.length; idx ++ ) {
				buff = buffList[ idx ];
		...
		String Description, boolean forceRead )
	{
		...
		if( ( ! forceRead ) && indexByUDescrIdx.containsKey( key ) ) {
			...
			CFSecHostNodeBuff buff = ((ICFIntSchema)schema.getBackingStore()).getTableHostNode().readDerivedByUDescrIdx( schema.getAuthorization(),
				ClusterId,
				Description );
			if( buff != null ) {
				obj = schema.getHostNodeTableObj().newInstance();
		...
		String HostName, boolean forceRead )
	{
		...
		if( ( ! forceRead ) && indexByHostNameIdx.containsKey( key ) ) {
			...
			CFSecHostNodeBuff buff = ((ICFIntSchema)schema.getBackingStore()).getTableHostNode().readDerivedByHostNameIdx( schema.getAuthorization(),
				ClusterId,
				HostName );
			if( buff != null ) {
				obj = schema.getHostNodeTableObj().newInstance();
		...
		Long priorHostNodeId )
	{
		...
		ICFSecHostNodeObj obj;
		CFSecHostNodeBuff[] buffList = ((ICFIntSchema)schema.getBackingStore()).getTableHostNode().pageBuffByClusterIdx( schema.getAuthorization(),
				ClusterId,
			priorClusterId,
			priorHostNodeId );
		CFSecHostNodeBuff buff;
	...
	public ICFSecHostNodeObj updateHostNode( ICFSecHostNodeObj Obj ) {
		ICFSecHostNodeObj obj = Obj;
		((ICFIntSchema)schema.getBackingStore()).getTableHostNode().updateHostNode( schema.getAuthorization(),
			Obj.getHostNodeBuff() );
		obj = (ICFSecHostNodeObj)Obj.realise();
		obj.endEdit();
		return( obj );
	...
	public void deleteHostNode( ICFSecHostNodeObj Obj ) {
		ICFSecHostNodeObj obj = Obj;
		((ICFIntSchema)schema.getBackingStore()).getTableHostNode().deleteHostNode( schema.getAuthorization(),
			obj.getHostNodeBuff() );
		obj.forget( true );
	}
	...
	public void deleteHostNodeByClusterIdx( long ClusterId )
	{
		...
		if( indexByClusterIdx.containsKey( key ) ) {
			...
			((ICFIntSchema)schema.getBackingStore()).getTableHostNode().deleteHostNodeByClusterIdx( schema.getAuthorization(),
				ClusterId );
		...
		String Description )
	{
		...
		if( indexByUDescrIdx.containsKey( key ) ) {
			obj = indexByUDescrIdx.get( key );
			((ICFIntSchema)schema.getBackingStore()).getTableHostNode().deleteHostNodeByUDescrIdx( schema.getAuthorization(),
				ClusterId,
				Description );
			obj.forget( true );
		}
		...
		String HostName )
	{
		...
		if( indexByHostNameIdx.containsKey( key ) ) {
			obj = indexByHostNameIdx.get( key );
			((ICFIntSchema)schema.getBackingStore()).getTableHostNode().deleteHostNodeByHostNameIdx( schema.getAuthorization(),
				ClusterId,
				HostName );
			obj.forget( true );
		}
